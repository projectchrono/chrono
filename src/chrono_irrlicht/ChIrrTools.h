...
/// For them, the Y axis ranges from zero to the maximum variation observed among all the iterations of the last step (linear scale).
ChApiIrr void DrawSolverViolation(const ChVisualSystemIrrlicht* vis, int pos_x = 10, int pos_y = 290, int width = 300, int height = 100);
