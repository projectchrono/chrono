...
ChApiIrr ISceneNode* addChBodySceneNode(chrono::ChSystem* asystem,
...
ChApiIrr ISceneNode* addChBodySceneNode_offsetCOG(
...
ChApiIrr ISceneNode* addChBodySceneNode_easySphere(chrono::ChSystem* asystem,
                                                   ISceneManager* amanager,
                                                   double mmass = 1.0,
                                                   const chrono::ChVector<>& position = chrono::ChVector<>(0, 0, 0),
                                                   double mradius = 1.0,
...
/// and add collision geometry by hand, but the following is easier).
/// The returned object has collision detection turned ON by default.
ChApiIrr ISceneNode* addChBodySceneNode_easyBox(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
    double mmass = 1.0,
    const chrono::ChVector<>& position = chrono::ChVector<>(0, 0, 0),
...
/// is easier).
/// The returned object has collision detection turned ON by default.
ChApiIrr ISceneNode* addChBodySceneNode_easyCylinder(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
    double mmass = 1.0,
    const chrono::ChVector<>& position = chrono::ChVector<>(0, 0, 0),
...
/// and add collision geometry by hand, but the following is easier).
/// The returned object has collision detection turned ON by default.
ChApiIrr ISceneNode* addChBodySceneNode_easyBarrel(chrono::ChSystem* asystem,
                                                   ISceneManager* amanager,
                                                   double mmass = 1.0,
                                                   const chrono::ChVector<>& position = chrono::ChVector<>(0, 0, 0),
                                                   double mradiusH = 1.0,
...
ChApiIrr ISceneNode* addChBodySceneNode_easyClone(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
...
ChApiIrr ISceneNode* addChBodySceneNode_easyGenericMesh(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
    double mmass = 1.0,
    const chrono::ChVector<>& position = chrono::ChVector<>(0, 0, 0),
...
/// SetBodyFixed(true) ).
ChApiIrr ISceneNode* addChBodySceneNode_easyStaticMesh(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
...
ChApiIrr ISceneNode* addChBodySceneNode_easyConvexMesh(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
    const char* mesh_filename,
    double mmass,
...
ChApiIrr ISceneNode* addChBodySceneNode_easyConcaveMesh(
    chrono::ChSystem* asystem,
    ISceneManager* amanager,
    const char* mesh_filename,
    double mmass,
