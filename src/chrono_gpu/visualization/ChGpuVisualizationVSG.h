...
class CH_GPU_API ChGpuVisualizationVSG : public vsg3d::ChVisualSystemVSGPlugin {
  public:
    ChGpuVisualizationVSG(ChSystemGpu* sysGPU);

    ~ChGpuVisualizationVSG();
    ...
    class CH_GPU_API ParticleColorCallback : public ChParticleCloud::ColorCallback {
      public:
    ...
    class CH_GPU_API ParticleVisibilityCallback : public ChParticleCloud::VisibilityCallback {
      public:
  ...
  private:
    ChSystemGpu* m_sysGPU;  ///< associated GPU system
    ...
    friend class GPUStatsVSG;
};

// -----------------------------------------------------------------------------

/// Predefined particle coloring based on particle height.
class CH_GPU_API ParticleHeightColorCallback : public ChGpuVisualizationVSG::ParticleColorCallback {
  public:
...
class CH_GPU_API ParticleVelocityColorCallback : public ChGpuVisualizationVSG::ParticleColorCallback {
  public:
