...
void test_sphere_sphere() {
...

  {
    ...
    ConvexShape sphereA, sphereB;
    sphereA.A = real3(2, 2, 0);
    sphereA.B = real3(1, 0, 0);
    sphereB.A = real3(2, 0, 0);
    sphereB.B = real3(1, 0, 0);
...

  {
    ...
    ConvexShape sphereA, sphereB;
    sphereA.A = real3(1, 1, 0);
    sphereA.B = real3(1, 0, 0);
    sphereB.A = real3(0, 0, 0);
    sphereB.B = real3(1, 0, 0);
...

  {
    ...
    shapeA.type = ShapeType::SPHERE;
    shapeA.A = real3(2, 2, 0);
    shapeA.B = real3(1, 0, 0);
    shapeA.C = real3(0);
    shapeA.R = quaternion(1, 0, 0, 0);

    shapeB.type = ShapeType::SPHERE;
    shapeB.A = real3(2, 0, 0);
    shapeB.B = real3(1, 0, 0);
    shapeB.C = real3(0);
...
void test_ellipsoid_ellipsoid() {
...

  {
    ...
    real d = 0;
    ConvexShape shapeA, shapeB;
    shapeA.type = ShapeType::ELLIPSOID;
    shapeA.A = real3(2, 2, 0);
