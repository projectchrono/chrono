...
int main(int argc, char* argv[]) {
    ...
    int ic = 0;
    timer.start();
    for (std::list<ChContactContainerParallel::ChContact_6_6*>::iterator it = m_list.begin(); it != m_list.end();
         ++it) {
        ...
        real3 A_V = real3(body_A->Variables().Get_qb().GetElementN(0), body_A->Variables().Get_qb().GetElementN(1),
                          body_A->Variables().Get_qb().GetElementN(2));
        real3 B_V = real3(body_B->Variables().Get_qb().GetElementN(0), body_B->Variables().Get_qb().GetElementN(1),
                          body_B->Variables().Get_qb().GetElementN(2));

        real3 A_O = real3(body_A->Variables().Get_qb().GetElementN(3), body_A->Variables().Get_qb().GetElementN(4),
                          body_A->Variables().Get_qb().GetElementN(5));
        real3 B_O = real3(body_B->Variables().Get_qb().GetElementN(3), body_B->Variables().Get_qb().GetElementN(4),
