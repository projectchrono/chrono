...
bool ChIrrAppEventReceiver::OnEvent(const SEvent& event)
{
  ...
  if (event.EventType == EET_GUI_EVENT)
  {
    ...
    case gui::EGET_SCROLL_BAR_CHANGED:
      switch (id) {
      case 9904:  app->GetSystem()->SetIterLCPmaxItersSpeed(( (gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      case 9905:  app->GetSystem()->SetIterLCPmaxItersStab(( (gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      case 9909:  app->GetSystem()->SetIterLCPomega( (1.0/50.0)* ((gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      case 9910:  app->GetSystem()->SetIterLCPsharpnessLambda( (1.0/50.0)* ((gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      case 9911:  app->GetSystem()->SetMaxPenetrationRecoverySpeed( (3.0/50.0)* ((gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      case 9912:  app->GetSystem()->SetMinBounceSpeed( (1.0/200.0)* ((gui::IGUIScrollBar*)event.GUIEvent.Caller)->getPos() );  break;
      }
      break;
    ...
    case gui::EGET_COMBO_BOX_CHANGED:
      if (id == 9907)
      {
        ...
        switch(sel)
        {
        case 0: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_SOR); break;
        case 1: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_SYMMSOR); break;
        case 2: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_JACOBI); break;
        case 3: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_SOR_MULTITHREAD); break;
        case 4: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_BARZILAIBORWEIN); break;
        case 5: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_PCG); break;
        case 6: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_PMINRES); break;
        case 7: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_APGD); break;
        case 8: app->GetSystem()->SetLcpSolverType(chrono::ChSystem::LCP_ITERATIVE_MINRES); break;
        }
        break;
      }
      ...
      if (id == 9908)
      {
		...
		case 5: app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_TRAPEZOIDAL_LINEARIZED); break;
		case 6: app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_HHT); break;
		case 7: app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_HEUN); break;
		case 8: app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_RUNGEKUTTA45); break;
		case 9: app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_EULER_EXPLICIT); break;
		case 10:app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_LEAPFROG); break;
		case 11:app->GetSystem()->SetIntegrationType(chrono::ChSystem::INT_NEWMARK); break;
        }
        break;
      }
    ...
    case gui::EGET_CHECKBOX_CHANGED:
      switch (id) {
      case 9906:  app->GetSystem()->SetIterLCPwarmStarting( ((gui::IGUICheckBox*)event.GUIEvent.Caller)->isChecked() );  break;
      case 9913:  app->GetSystem()->SetUseSleeping( ((gui::IGUICheckBox*)event.GUIEvent.Caller)->isChecked() );  break;
      case 9916:  app->SetTryRealtime( ((gui::IGUICheckBox*)event.GUIEvent.Caller)->isChecked() );  break;
      case 9917:  app->pause_step =  ((gui::IGUICheckBox*)event.GUIEvent.Caller)->isChecked();  break;
      }
      break;
...
void ChIrrAppInterface::BeginScene(
            bool          backBuffer,
            bool          zBuffer,
            video::SColor color)
{
...
void ChIrrAppInterface::DrawAll()
{
  ...
  if (gad_speed_iternumber_info->isVisible())
  {
	...
	case chrono::ChSystem::INT_TRAPEZOIDAL_LINEARIZED: gad_stepper->setSelected(5); break;
	case chrono::ChSystem::INT_HHT:			gad_stepper->setSelected(6); break;
	case chrono::ChSystem::INT_HEUN:		gad_stepper->setSelected(7); break;
	case chrono::ChSystem::INT_RUNGEKUTTA45:gad_stepper->setSelected(8); break;
	case chrono::ChSystem::INT_EULER_EXPLICIT:gad_stepper->setSelected(9); break;
	case chrono::ChSystem::INT_LEAPFROG:	gad_stepper->setSelected(10); break;
	case chrono::ChSystem::INT_NEWMARK:		gad_stepper->setSelected(11); break;
    }
