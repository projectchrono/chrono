...
void ChIrrParticlesSceneNode::setMaterialTexture(s32              textureLayer,
...
ChIrrParticlesSceneNode::addShadowVolumeSceneNode(const IMesh*  shadowMesh,
                                                  s32           id,
                                                  bool          zfailmethod,
                                                  f32           infinity)
{
                                    ...
                                    s32               mid)
{
  ...
  ChIrrParticlesSceneNode* particleObj = new ChIrrParticlesSceneNode(asystem, 
    amesh, 
    amesh_scale,
    aparent,
    amanager,
                                                ...
                                                s32               mid)
{
  ...
  // create a ChronoENGINE rigid body
  ChIrrParticlesSceneNode* particleObj = (ChIrrParticlesSceneNode*)addChParticlesSceneNode(asystem, amanager, sphereMesh, mmeshscale, mmass, aparent, mid);
