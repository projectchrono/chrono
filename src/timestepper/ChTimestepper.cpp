...
void ChTimestepperEulerExpl::Advance(
...
void ChTimestepperEulerExplIIorder::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
...
void ChTimestepperEulerSemiImplicit::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
...
void ChTimestepperRungeKuttaExpl::Advance(
			const double dt				///< timestep to advance
			) 
	{
		// setup main vectors
...
void ChTimestepperHeun::Advance(
		const double dt				///< timestep to advance
		)
	{
		// setup main vectors
...
void ChTimestepperLeapfrog::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
...
void ChTimestepperEulerImplicit::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
		...
		mintegrable->StateScatterAcceleration((Vnew-V)*(1/dt));	// -> system auxiliary data (i.e acceleration as measure, fits DVI/MDI)
...
void ChTimestepperEulerImplicitLinearized::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
		...
		mintegrable->StateScatterAcceleration((V-Vold)*(1/dt));	// -> system auxiliary data (i.e acceleration as measure, fits DVI/MDI)
...
void ChTimestepperTrapezoidalLinearized::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
		...
		mintegrable->StateScatter(X, V, T);	// state -> system
		mintegrable->StateScatterAcceleration((Dv*=(1/dt)));	// -> system auxiliary data (i.e acceleration as measure, fits DVI/MDI)
...
void ChTimestepperTrapezoidalLinearized2::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
...
void ChTimestepperNewmark::Advance(
		const double dt				///< timestep to advance
		)
	{
		// downcast
