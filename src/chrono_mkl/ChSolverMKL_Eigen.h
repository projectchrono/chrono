...
#ifndef CHSOLVERMKL_EIGEN_H
#define CHSOLVERMKL_EIGEN_H
...
#include "core/ChCSMatrix_Eigen.h"
...
\code{.cpp}
auto mkl_solver = chrono_types::make_shared<ChSolverMKL_Eigen<>>();
...
*/
template <typename Matrix = ChCSMatrix_Eigen>
class ChSolverMKL_Eigen : public ChSolver {
  public:
    ChSolverMKL_Eigen() { SetSparsityPatternLock(true); }

    ~ChSolverMKL_Eigen() override {}

    /// Get a handle to the underlying MKL engine.
    ChMklEngine_Eigen& GetMklEngine() { return m_engine; }
    ...
    virtual void ArchiveOUT(ChArchiveOut& marchive) override {
        // version number
        marchive.VersionWrite<ChSolverMKL_Eigen>();
    ...
    virtual void ArchiveIN(ChArchiveIn& marchive) override {
        // version number
        int version = marchive.VersionRead<ChSolverMKL_Eigen>();
