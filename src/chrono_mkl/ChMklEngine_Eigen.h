...
#ifndef CHMKLENGINE_EIGEN_H
#define CHMKLENGINE_EIGEN_H
...
class ChApiMkl ChMklEngine_Eigen {
  public:
    ChMklEngine_Eigen(int pb_size = 0, ChSparseMatrix::SymmetryType matrix_type = ChSparseMatrix::GENERAL);
    ~ChMklEngine_Eigen();
    ...
    void SetMatrix(ChCSMatrix_Eigen& Z);
    ...
    void SetProblem(ChCSMatrix_Eigen& Z, ChVectorRef b, ChVectorRef x);
  ...
  private:
    ...
    // Note that ChMklEngine_Eigen does NOT own this data.
