...
#ifndef CHELEMENTSHELLEANS4NEW_H
#define CHELEMENTSHELLEANS4NEW_H
...
class ChApiFea ChMaterialShellEANSnew {
  public:
    /// Construct an isotropic material.
    ChMaterialShellEANSnew(double thickness, ///< thickness
...
/// A o-----+-----o B
///
class ChApiFea ChElementShellEANS4new : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    class Layer {
      public:
        ...
        std::shared_ptr<ChMaterialShellEANSnew> GetMaterial() const { return m_material; }

      private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellEANS4new* element,                  ///< containing element
              double thickness,                              ///< layer thickness
              double theta,                                  ///< fiber angle
              std::shared_ptr<ChMaterialShellEANSnew> material  ///< layer material
              );

        /// Initial setup for this layer
        void SetupInitial();

        ChElementShellEANS4new* m_element;                   ///< containing shell element
        std::shared_ptr<ChMaterialShellEANSnew> m_material;  ///< layer material
        double m_thickness;                               ///< layer thickness
        double m_theta;                                   ///< fiber angle

        friend class ChElementShellEANS4new;
