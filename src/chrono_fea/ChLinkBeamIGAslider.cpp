...
//GetLog() << "Update tau=" << this->tau << " eta=" << eta << " dist=" << mdist << " elem n." << this->active_element << " on " << m_beams.size() << " pos=" << goodpoint << " outlet=" << absoutlet << "\n";
...
void ChLinkBeamIGAslider::ConstraintsLoadJacobians() {
	...
	ChVectorDynamic<> N(this->m_nodes.size());
