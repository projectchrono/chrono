...
void ChPardisoProjectEngine::SetMatrix(const ChSparseMatrix& Z, bool isZeroIndexed) {
    this->SetMatrix(Z.rows(), const_cast<int*>(Z.outerIndexPtr()), const_cast<int*>(Z.innerIndexPtr()),
                    const_cast<double*>(Z.valuePtr()), false);
...
int ChPardisoProjectEngine::PardisoProjectCall(parproj_PHASE phase) {
    ...
    pardiso(pt, &maxfct, &mnum, &mtype_int, &phase_int, &n, a, ia, ja, &idum, &nrhs, iparm, &msglvl, b, x, &error,
            dparm);
...
int ChPardisoProjectEngine::CheckMatrix(bool print) {
    ...
    if (!matOneIndexedFormat_bkp)
        SetZeroIndexedFormat();
...
void ChPardisoProjectEngine::shiftMatrixIndices(int* ext_ia,
                                                int* ext_ja,
                                                double* ext_a,
                                                int ext_n,
                                                int val,
...
bool ChPardisoProjectEngine::getMatrixInternalArrays(ChSparseMatrix& sparseMat,
                                                     int** ext_ia,
                                                     int** ext_ja,
                                                     double** ext_a) {
