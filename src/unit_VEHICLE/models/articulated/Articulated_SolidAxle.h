...
#ifndef ARTICULATED_SOLIDAXLE_H
#define ARTICULATED_SOLIDAXLE_H


#include "subsys/suspension/ChSolidAxle.h"


class Articulated_SolidAxleFront : public chrono::ChSolidAxle
{
public:

  Articulated_SolidAxleFront(const std::string& name);
  ~Articulated_SolidAxleFront() {}
...
class Articulated_SolidAxleRear : public chrono::ChSolidAxle
{
public:

  Articulated_SolidAxleRear(const std::string& name);
  ~Articulated_SolidAxleRear() {}
