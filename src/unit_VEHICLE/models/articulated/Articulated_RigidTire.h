...
// =============================================================================
//
// Articulated rigid tire subsystem
//
// =============================================================================

#ifndef ARTICULATED_RIGID_TIRE_H
#define ARTICULATED_RIGID_TIRE_H

#include "subsys/tire/ChRigidTire.h"

class Articulated_RigidTire : public chrono::ChRigidTire
{
public:

  Articulated_RigidTire(const std::string&       name,
                    const chrono::ChTerrain& terrain)
  : ChRigidTire(name, terrain) {}

  ~Articulated_RigidTire() {}
