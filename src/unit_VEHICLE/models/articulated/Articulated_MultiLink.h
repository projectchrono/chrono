...
#ifndef ARTICULATED_MULTILINK_H
#define ARTICULATED_MULTILINK_H


#include "subsys/suspension/ChMultiLink.h"


class Articulated_MultiLinkFront : public chrono::ChMultiLink
{
public:

  Articulated_MultiLinkFront(const std::string& name);
  ~Articulated_MultiLinkFront() {}
...
class Articulated_MultiLinkRear : public chrono::ChMultiLink
{
public:

  Articulated_MultiLinkRear(const std::string& name);
  ~Articulated_MultiLinkRear() {}
