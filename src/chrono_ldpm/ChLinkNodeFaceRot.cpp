...
int  ChLinkNodeFaceRot::Initialize(std::shared_ptr<ChNodeFEAxyzrot> anodeA,
...
void  ChLinkNodeFaceRot::ArchiveOut(ChArchiveOut& marchive) {
    //// TODO
}

void  ChLinkNodeFaceRot::ArchiveIn(ChArchiveIn& marchive) {
    //// TODO
}
