...
#ifndef PUSH_CONSTANT_SHADERS_H
#define PUSH_CONSTANT_SHADERS_H

#include <vsg/io/VSG.h>
static auto vert_PushConstants = []() {std::istringstream str(
        R"(#vsga 0.2.11
...
#include <vsg/io/VSG.h>
static auto frag_PushConstants = []() {std::istringstream str(
        R"(#vsga 0.2.11
Root id=1 vsg::ShaderStage
{
  NumUserObjects 0
