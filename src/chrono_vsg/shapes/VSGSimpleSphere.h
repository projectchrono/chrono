...
#ifndef VSG_SIMPLE_SPHERE_H
#define VSG_SIMPLE_SPHERE_H
...
class CH_VSG_API VSGSimpleSphere : public ChVSGSimplePhongIdxMesh {
  public:
    VSGSimpleSphere(std::shared_ptr<ChBody> body,
