...
#ifndef VSG_INDEX_CYLINDER_H
#define VSG_INDEX_CYLINDER_H
...
class CH_VSG_API VSGIndexCylinder : public ChVSGIndexMesh {
  public:
    VSGIndexCylinder(std::shared_ptr<ChBody> body,
