...
VSGPbrCylinder::VSGPbrCylinder(std::shared_ptr<ChBody> body,
                               std::shared_ptr<ChAsset> asset,
                               vsg::ref_ptr<vsg::MatrixTransform> transform)
    : ChVSGPbrIdxMesh(body, asset, transform) {}

void VSGPbrCylinder::Initialize(vsg::vec3& lightPosition, ChVSGPbrMaterial& mat, std::string& texFilePath) {
