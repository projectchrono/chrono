...
#ifndef VSG_SIMPLE_CYLINDER_H
#define VSG_SIMPLE_CYLINDER_H
...
class CH_VSG_API VSGSimpleCylinder : public ChVSGSimplePhongIdxMesh {
  public:
    VSGSimpleCylinder(std::shared_ptr<ChBody> body,
