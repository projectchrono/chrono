...
protected:
  ChFsiDataManager *fsiData; ///< pointer to the fsi data. The values are
                             /// maintained externally

  ChFsiForceParallel *forceSystem; ///< force system object. It calculates the
                                   ///force between markers.

  SimParams
      *paramsH; ///< pointer to parameters. The values are mainained externally.

  NumberOfObjects *numObjectsH; ///< pointer to number of objects (fluid
                                ///markers, number of rigids, boundaries, ....)
                                /// the values are maintained externally.

  /// Update SPH markers data.
  ///
  /// In an explicit formulation, the update Fluid function relies on explicit
  /// Euler
