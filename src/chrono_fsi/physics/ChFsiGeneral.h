...
struct NumberOfObjects {
    ...
    size_t numBoundaryMarkers;  ///< Number of boundary SPH particles
    ...
    size_t numRigid_SphMarkers; ///< Number of SPH particles attached to rigid bodies
    size_t numFlex_SphMarkers;  ///< Number of SPH particles attached to flexible bodies
    size_t numAllMarkers;       ///< Total number of SPH particles in the simulation
};
...
class ChFsiGeneral {
  public:
    ...
    ChFsiGeneral(std::shared_ptr<SimParams> hostParams,             ///< Simulation parameters on host (CPU)
                 std::shared_ptr<NumberOfObjects> hostNumObjects    ///< Number of rigid and flexible solid bodies, SPH particles (see NumberOfObjects)
    );
