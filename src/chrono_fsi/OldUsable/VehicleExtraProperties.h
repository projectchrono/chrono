...
class MyDriverInputs: public chrono::vehicle::ChDriverInputsCallback {
public:
...
class MyCylindricalTire: public chrono::vehicle::ChTireContactCallback {
public:
	virtual void onCallback(chrono::ChSharedPtr<chrono::ChBody> wheelBody,
			double radius, double width);
};

// Callback class for specifying rigid tire contact model.
// This version uses a collection of convex contact shapes (meshes).
class MyLuggedTire: public chrono::vehicle::ChTireContactCallback {
public:
	MyLuggedTire();
	virtual void onCallback(chrono::ChSharedPtr<chrono::ChBody> wheelBody,
			double radius, double width);
...
class MyChassisBoxModel_vis: public chrono::vehicle::ChChassisContactCallback {
public:
	virtual void onCallback(
			chrono::ChSharedPtr<chrono::ChBodyAuxRef> chassisBody);
	virtual void SetAttributes(const chrono::ChVector<>& otherSize,
			const chrono::ChQuaternion<>& otherRot = chrono::ChQuaternion<>(1,
					0, 0, 0), const chrono::ChVector<>& otherLoc =
...
// In addition, this version overrides the visualization assets of the provided
// chassis body with the collision meshes.
class MyChassisSphereModel_vis: public chrono::vehicle::ChChassisContactCallback {
public:
	virtual void onCallback(
			chrono::ChSharedPtr<chrono::ChBodyAuxRef> chassisBody);
...
// In addition, this version overrides the visualization assets of the provided
// chassis body with the collision meshes.
class MyChassisSimpleConvexMesh: public chrono::vehicle::ChChassisContactCallback {
public:
...
// In addition, this version overrides the visualization assets of the provided
// chassis body with the collision meshes.
class MyChassisSimpleTriMesh_vis: public chrono::vehicle::ChChassisContactCallback {
public:
