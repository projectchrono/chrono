...
#ifndef FSI_PARTICLE_RELOCATOR_CUH
#define FSI_PARTICLE_RELOCATOR_CUH
...
class FsiParticleRelocator {
  public:
    ...
    FsiParticleRelocator(FsiDataManager& data_mgr, const DefaultProperties& props);
    ~FsiParticleRelocator() {}
