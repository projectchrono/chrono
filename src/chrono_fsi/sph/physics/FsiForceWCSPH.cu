...
FsiForceWCSPH::FsiForceWCSPH(FsiDataManager& data_mgr, BceManager& bce_mgr, bool verbose, bool check_errors)
    : FsiForce(data_mgr, bce_mgr, verbose), m_check_errors(check_errors) {
