...
#ifndef CH_SPH_UTILS_PRINT_H
#define CH_SPH_UTILS_PRINT_H
...
void writeParticleFileJSON(const std::string& filename, thrust::device_vector<Real4>& posRadD, thrust::host_vector<int4>& referenceArray);
