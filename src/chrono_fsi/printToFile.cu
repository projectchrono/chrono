...
void PrintCartesianData_MidLine(
	...
	int3 gridCenter = mI3(cartesianGridDims.x / 2, cartesianGridDims.y / 2,
			cartesianGridDims.z / 2);
	...
	for (int k = 0; k < cartesianGridDims.z; k++) {
		...
		int index = (cartesianGridDims.x * cartesianGridDims.y) * k
				+ cartesianGridDims.x * gridCenter.y + gridCenter.x;
...
void PrintToFile_SPH(const thrust::device_vector<Real3>& posRadD,
	...
	if (tStep % tStepsPovFiles == 0) {
		...
		//*****************************************************
		const string nameFluid = out_dir + string("/fluid")
				+ string(fileCounter) + string(".csv");
		...
		//*****************************************************
		const string nameBoundary = out_dir + string("/boundary")
				+ string(fileCounter) + string(".csv");
		...
		//*****************************************************
		const string nameFluidBoundaries = out_dir + string("/fluid_boundary")
				+ string(fileCounter) + string(".csv");
		...
		//*****************************************************
		const string nameBCE = out_dir + string("/BCE") + string(fileCounter)
				+ string(".csv");
