...
class CH_FSI_API ChSystemFsi {
  public:
    ...
    /// No output is generated by default (for better performance). 
    /// If an output directory is specified, output files with information on each FSI body and node are generated.
