...
class CH_FSI_API ChSystemFsi : public ChFsiGeneral {
 public:
  ...
  /// function to return the pointer to the fsi bodies. The pointer to all fsi bodies, i.e. the bodies
  /// with two representation in fluid and multibody systems, are stored in a vector.
  ...
  /// Finzalize data by calling FinalizeData function and finalize fluid and bce objects if the
  /// system have fluid.
