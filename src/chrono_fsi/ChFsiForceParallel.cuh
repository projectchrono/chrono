...
/// proximity computation of the markers. It also holds a pointer to external data
...
class CH_FSI_API ChFsiForceParallel : public ChFsiGeneral {
 public:
	...
	///
	/// The constructor instantiates the collision system (ChCollisionSystemFsi) and
 ...
 private:
  ...
  ChBce* bceWorker;							///< pointer to Boundary Condition Enforcing markers class. The class
