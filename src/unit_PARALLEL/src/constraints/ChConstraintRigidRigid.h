		...
		public:
			...
			void Setup(
				...
				if (number_of_rigid_rigid > 0) {
					...
					number_of_updates = (thrust::reduce_by_key(body_num.begin(),
							body_num.end(),
							thrust::constant_iterator<uint>(1),
							update_number.begin(),
							offset_counter.begin()).second) - offset_counter.begin();
			...
			void Project_NoPar(
				...
				void host_shurB_normal(int2 *ids,
				bool *active,
				real3 *norm,
				real3 *ptA,
				real3 *ptB,
				...
				void host_shurB_sliding(int2 *ids,
				bool *active,
				real3 *norm,
				real3 *ptA,
				real3 *ptB,
				...
				void host_shurB_spinning(int2 *ids,
				bool *active,
				real3 *norm,
				real3 *ptA,
				real3 *ptB,
