...
class CH_OPENGL_API ChOpenGLVertexAttributesPADSNT {
 public:
   ...
   ChOpenGLVertexAttributesPADSNT(
         ...
         const glm::vec2 & t);
   ChOpenGLVertexAttributesPADSNT(
         const ChOpenGLVertexAttributesPADSNT & other);
   glm::vec3 position;
   glm::vec3 normal;
...
class CH_OPENGL_API ChOpenGLVertexAttributesPCNT {
 public:
   ...
   ChOpenGLVertexAttributesPCNT(
         ...
         const glm::vec2 & t);
   ChOpenGLVertexAttributesPCNT(
         const ChOpenGLVertexAttributesPCNT & other);
   glm::vec3 position;
   glm::vec3 normal;
   glm::vec3 color;
   glm::vec2 texture_coordinate;
...
class CH_OPENGL_API ChOpenGLVertexAttributesPCN {
 public:
   ...
   ChOpenGLVertexAttributesPCN(
         ...
         const glm::vec3 & n);
   ChOpenGLVertexAttributesPCN(
         const ChOpenGLVertexAttributesPCN & other);
   glm::vec3 position;
   glm::vec3 normal;
   glm::vec3 color;
...
class CH_OPENGL_API ChOpenGLVertexAttributesPN {
 public:
   ...
   ChOpenGLVertexAttributesPN(
         ...
         const glm::vec3 & n);
   ChOpenGLVertexAttributesPN(
         const ChOpenGLVertexAttributesPN & other);
   glm::vec3 position;
   glm::vec3 normal;
};
...
class CH_OPENGL_API ChOpenGLVertexAttributesP {
 public:
   ...
   ChOpenGLVertexAttributesP(
         const glm::vec3 & p);
   ChOpenGLVertexAttributesP(
         const ChOpenGLVertexAttributesP & other);
   glm::vec3 position;
};
}
}
