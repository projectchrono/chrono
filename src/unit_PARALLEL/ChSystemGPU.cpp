...
#pragma omp parallel for
	...
	double ChSystemGPU::ComputeCollisions() {
		...
		((ChCollisionSystemGPU*) (collision_system))->ComputeAABB(0);
		((ChCollisionSystemGPU*) (collision_system))->ComputeBounds(0);
		gpu_data_manager->max_bounding_point = gpu_data_manager->gpu_data[0].max_bounding_point;
		gpu_data_manager->min_bounding_point = gpu_data_manager->gpu_data[0].min_bounding_point;
		((ChCollisionSystemGPU*) (collision_system))->ComputeUpdateAABB(0);
		((ChCollisionSystemGPU*) (collision_system))->ComputeBroadPhase(0);
		((ChCollisionSystemGPU*) (collision_system))->ComputeNarrowPhase(0);
