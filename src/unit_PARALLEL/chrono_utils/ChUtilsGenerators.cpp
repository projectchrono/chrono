...
// ingredient.
void MixtureIngredient::setDefaultMaterialDVI(const ChSharedPtr<ChMaterialSurface>& mat) {
  m_defMaterialDVI = mat;
  freeMaterialDist();
}

void MixtureIngredient::setDefaultMaterialDEM(const ChSharedPtr<ChMaterialSurfaceDEM>& mat) {
