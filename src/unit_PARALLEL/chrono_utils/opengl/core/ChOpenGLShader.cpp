...
*/
	...
	void ChOpenGLShader::CommonSetup(const GLfloat * projection, const GLfloat * modelview, const GLfloat * mvp, const GLfloat * nm)
	{
	...
	void ChOpenGLShader::SetCamera(vec3 campos)
	{
		camera_pos = campos;
	}
...
*/
	...
	string ChOpenGLShader::GetShaderLog(GLuint shader_id)
	{
		stringstream s;
		GLint log_length;
