...
void ChOpenGLCamera::SetPosition(
      glm::vec3 pos) {
   camera_position = pos;
}

void ChOpenGLCamera::SetLookAt(
      glm::vec3 pos) {
   camera_look_at = pos;
}
void ChOpenGLCamera::SetFOV(
      double fov) {
   field_of_view = fov;
}
void ChOpenGLCamera::SetViewport(
      int loc_x,
      int loc_y,
      int width,
      int height) {
...
void ChOpenGLCamera::SetClipping(
...
void ChOpenGLCamera::ChangePitch(
      float degrees) {
...
void ChOpenGLCamera::ChangeHeading(
      float degrees) {
...
void ChOpenGLCamera::GetViewport(
      int &loc_x,
      int &loc_y,
      int &width,
      int &height) {
...
void ChOpenGLCamera::GetMatricies(
      glm::mat4 &P,
      glm::mat4 &V,
      glm::mat4 &M) {
   P = projection;
