	...
	if (number_of_rigid_rigid + number_of_bilaterals != 0) {
		for (current_iteration = 0; current_iteration < max_iteration; current_iteration++) {
			...
			device_process_contacts CUDA_KERNEL_DIM(BLOCKS(number_of_rigid_rigid), THREADS)(
					CASTR3(data_container->host_data.device_JXYZA_data),
					CASTR3(data_container->host_data.device_JXYZB_data),
					CASTR3(data_container->host_data.device_JUVWA_data),
					CASTR3(data_container->host_data.device_JUVWB_data),
					CASTR1(data_container->device_rhs_data),
					CASTR1(data_container->host_data.device_dpth_data),
					CASTB1(data_container->host_data.device_active_data),
					CASTI2(data_container->host_data.device_bids_data),
					CASTR1(data_container->host_data.device_gam_data),
					CASTR1(data_container->host_data.device_dgm_data),
					CASTR1(data_container->host_data.device_mass_data),
					CASTR1(data_container->host_data.device_fric_data),
					CASTR3(data_container->host_data.device_inr_data),
					CASTR4(data_container->host_data.device_rot_data),
					CASTR3(data_container->host_data.device_vel_data),
					CASTR3(data_container->host_data.device_omg_data),
					CASTR3(data_container->host_data.device_pos_data),
					CASTR3(data_container->host_data.vel_update),
					CASTR3(data_container->host_data.omg_update),
					CASTU1(data_container->host_data.update_offset));
#else
			host_process_contacts(
					data_container->host_data.device_JXYZA_data.data(),
					data_container->host_data.device_JXYZB_data.data(),
					data_container->host_data.device_JUVWA_data.data(),
					data_container->host_data.device_JUVWB_data.data(),
					data_container->host_data.device_rhs_data.data(),
					data_container->host_data.device_dpth_data.data(),
					data_container->host_data.device_active_data.data(),
					data_container->host_data.device_bids_data.data(),
					data_container->host_data.device_gam_data.data(),
					data_container->host_data.device_dgm_data.data(),
					data_container->host_data.device_mass_data.data(),
					data_container->host_data.device_fric_data.data(),
					data_container->host_data.device_inr_data.data(),
					data_container->host_data.device_rot_data.data(),
					data_container->host_data.device_vel_data.data(),
					data_container->host_data.device_omg_data.data(),
					data_container->host_data.device_pos_data.data(),
			...
			device_Bilaterals CUDA_KERNEL_DIM(BLOCKS(number_of_bilaterals), THREADS)(
					CASTR4(data_container->host_data.device_bilateral_data),
					CASTR1(data_container->host_data.device_mass_data),
					CASTR3(data_container->host_data.device_inr_data),
					CASTR4(data_container->host_data.device_rot_data),
					CASTR3(data_container->host_data.device_vel_data),
...
#else
			host_Bilaterals(
					data_container->host_data.device_JXYZA_bilateral.data(),
					data_container->host_data.device_JXYZB_bilateral.data(),
					data_container->host_data.device_JUVWA_bilateral.data(),
					data_container->host_data.device_JUVWB_bilateral.data(),
					data_container->host_data.device_bids_bilateral.data(),
					data_container->host_data.device_gamma_bilateral.data(),
					data_container->host_data.device_correction_bilateral.data(),
					data_container->host_data.device_residual_bilateral.data(),
					data_container->host_data.device_mass_data.data(),
					data_container->host_data.device_inr_data.data(),
					data_container->host_data.device_rot_data.data(),
					data_container->host_data.device_vel_data.data(),
			...
			device_Reduce_Speeds CUDA_KERNEL_DIM(BLOCKS(number_of_updates), THREADS)(
					...
					CASTR3(data_container->host_data.vel_update),
					CASTR3(data_container->host_data.omg_update),
					CASTU1(data_container->host_data.body_number),
					CASTU1(data_container->host_data.offset_counter));
#else
			host_Reduce_Speeds(
					data_container->host_data.device_active_data.data(),
					data_container->host_data.device_mass_data.data(),
			...
			residual = data_container->host_data.device_dgm_data[thrust::max_element(
					data_container->host_data.device_dgm_data.begin(),
					data_container->host_data.device_dgm_data.begin() + number_of_rigid_rigid) - data_container->host_data.device_dgm_data.begin()];
