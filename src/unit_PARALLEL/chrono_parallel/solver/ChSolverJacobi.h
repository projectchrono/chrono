...
class CH_PARALLEL_API ChSolverJacobi : public ChSolverParallel {
 public:
   ...
   void Solve() {
      ...
      total_iteration += SolveJacobi(max_iteration, num_constraints, data_container->host_data.rhs_data, data_container->host_data.gamma_data);
   ...
   blaze::DynamicVector<real> diagonal, ml, mb, ml_old;
};
}
#endif
