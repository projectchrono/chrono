...
public:
  ...
  inline real3 cross(const real3 &b) const {
    ...
    inline real rlength() const  {return real(1.0)/sqrt(x * x + y * y + z * z);}
...
inline real dot(const real3& a, const real3& b) { return a.dot(b); }
inline real3 cross(const real3& a, const real3& b) { return a.cross(b); }
inline real length(const real3& a) { return a.length(); }
inline real rlength(const real3& a) { return a.rlength(); }
