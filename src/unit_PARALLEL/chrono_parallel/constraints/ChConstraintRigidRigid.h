 ...
 public:
   ...
   void Setup(ChParallelDataManager *data_container_) {
      ...
      if (num_contacts > 0) {
         ...
         thrust::sort_by_key(thrust_parallel, body_num.begin(), body_num.end(), update_number.begin());
         thrust::sort_by_key(thrust_parallel, update_number.begin(), update_number.end(), update_offset.begin());
...
#pragma omp parallel for
   ...
   void host_ComputeS(int2 *ids,
                      ...
                      const real *rhs,
                      real*b);
   void host_RHS_spinning(int2 *ids,
                          bool2 * active,
                          real3 *omega,
                          real3 *norm,
                          real4 * rot,
   ...
   void host_Jacobians_Rolling(real3 *norm,
                               int2 *ids,
                               real4 *rot,
                               real3 *JTA,
                               real3 *JTB,
   ...
   void host_shurA_normal(real *gamma,
                          real3 *norm,
                          real3 *JUA,
                          real3 *JUB,
                          real3 *updateV,
   ...
   void host_shurA_sliding(bool2* contact_active,
                           real3* norm,
                           real3 * ptA,
                           real3 * ptB,
                           real4 * rot,
   ...
   void host_shurA_spinning(bool2* contact_active,
                            real3* norm,
                            real3 * ptA,
                            real3 * ptB,
                            real4 * rot,
   ...
   void host_shurB_normal(const real & alpha,
                          int2 * ids,
   ...
   void host_shurB_sliding(const real & alpha,
                           int2 * ids,
                           bool2* contact_active,
                           real3* norm,
                           real4 * compliance,
   ...
   void host_shurB_spinning(const real & alpha,
                            int2 * ids,
                            bool2* contact_active,
                            real3* norm,
                            real4 * compliance,
   ...
   void host_Offsets(int2 *ids_contacts,
                     int *Body);

   void host_Reduce_Shur(bool *active,
                         real3 *QXYZ,
                         real3 *QUVW,
                         real *inv_mass,
                         real3 *inv_inertia,
