...
//add a vertex
void ChCNarrowphaseVoronoiSimplex::addVertex(const real3& w,
                                             const real3& p,
                                             const real3& q) {
   m_lastW = w;
   m_needsUpdate = true;
   ...
   if (m_needsUpdate) {
      ...
      switch (numVertices()) {
         ...
         case 3: {
            ...
            m_cachedP1 = m_simplexPointsP[0] * m_cachedBC.m_barycentricCoords[0] + m_simplexPointsP[1] * m_cachedBC.m_barycentricCoords[1]
                  + m_simplexPointsP[2] * m_cachedBC.m_barycentricCoords[2];

            m_cachedP2 = m_simplexPointsQ[0] * m_cachedBC.m_barycentricCoords[0] + m_simplexPointsQ[1] * m_cachedBC.m_barycentricCoords[1]
         ...
         case 4: {
            ...
            if (hasSeperation) {
               ...
               m_cachedP1 = m_simplexPointsP[0] * m_cachedBC.m_barycentricCoords[0] + m_simplexPointsP[1] * m_cachedBC.m_barycentricCoords[1]
                     + m_simplexPointsP[2] * m_cachedBC.m_barycentricCoords[2] + m_simplexPointsP[3] * m_cachedBC.m_barycentricCoords[3];

               m_cachedP2 = m_simplexPointsQ[0] * m_cachedBC.m_barycentricCoords[0] + m_simplexPointsQ[1] * m_cachedBC.m_barycentricCoords[1]
                     + m_simplexPointsQ[2] * m_cachedBC.m_barycentricCoords[2] + m_simplexPointsQ[3] * m_cachedBC.m_barycentricCoords[3];
...
int ChCNarrowphaseVoronoiSimplex::getSimplex(real3 *pBuf,
                                             real3 *qBuf,
                                             real3 *yBuf) const {
   int i;
...
void ChCNarrowphaseVoronoiSimplex::compute_points(real3& p1,
                                                  real3& p2) {
