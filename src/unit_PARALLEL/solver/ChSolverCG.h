...
namespace chrono {
	class ChApiGPU ChSolverCG: public ChSolverGPU {
		public:
			...
			uint SolveCG(custom_vector<real> &x, const custom_vector<real> &b, const custom_vector<real> &A, const uint max_iter);
			...
			custom_vector<real> ShurProduct(const custom_vector<real> &x_t, const custom_vector<real> &A);
