...
class CH_MODELS_API Viper_Part {
  public:
    ...
    std::shared_ptr<chrono::ChBodyAuxRef> GetChassis() const { return m_chassis;}
  ...
  protected:
    ...
    chrono::ChSystem* m_system;     ///< system which Viper Part belongs to
    std::shared_ptr<chrono::ChBodyAuxRef> m_chassis;  ///< the chassis body for the rover
