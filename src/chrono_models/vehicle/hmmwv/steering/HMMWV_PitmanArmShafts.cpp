...
const double HMMWV_PitmanArmShafts::m_maxAngle = 780.0 * (CH_PI / 180);
const double HMMWV_PitmanArmShafts::m_gearRatio = 780.0 / 30.0;
//// NOTE: steering compliance 2000 N.mm/deg (too low?)
const double HMMWV_PitmanArmShafts::m_steeringCompliance = 2 * CH_RAD_TO_DEG;
//// NOTE: shaft inertia approximated (likely too high)
const double HMMWV_PitmanArmShafts::m_columnInertia = 5e-2;

const ChVector3d HMMWV_PitmanArmShafts::m_steeringLinkInertiaMoments(0.252, 0.00233, 0.254);
const ChVector3d HMMWV_PitmanArmShafts::m_steeringLinkInertiaProducts(0.0, 0.0, 0.0);
const ChVector3d HMMWV_PitmanArmShafts::m_pitmanArmInertiaMoments(0.00638, 0.00756, 0.00150);
const ChVector3d HMMWV_PitmanArmShafts::m_pitmanArmInertiaProducts(0.0, 0.0, 0.0);
...
// -----------------------------------------------------------------------------
const ChVector3d HMMWV_PitmanArmShafts::getLocation(PointId which) {
    switch (which) {
        case STEERINGLINK:
...
const ChVector3d HMMWV_PitmanArmShafts::getDirection(DirectionId which) {
    switch (which) {
        case REV_AXIS:
