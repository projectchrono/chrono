...
const std::string HMMWV_TMeasyTire::m_meshName_left = "tire_left_geom";
const std::string HMMWV_TMeasyTire::m_meshFile_left = "hmmwv/left_tire.obj";

const std::string HMMWV_TMeasyTire::m_meshName_right = "tire_right_geom";
const std::string HMMWV_TMeasyTire::m_meshFile_right = "hmmwv/right_tire.obj";
