...
// Static variables
const double HMMWV_AutomaticTransmissionShafts::m_transmissionblock_inertia = 10.5;
const double HMMWV_AutomaticTransmissionShafts::m_motorshaft_inertia = 0.5;
const double HMMWV_AutomaticTransmissionShafts::m_driveshaft_inertia = 0.5;
const double HMMWV_AutomaticTransmissionShafts::m_ingear_shaft_inertia = 0.3;
const double HMMWV_AutomaticTransmissionShafts::m_upshift_RPM = 2500;
const double HMMWV_AutomaticTransmissionShafts::m_downshift_RPM = 1200;

HMMWV_AutomaticTransmissionShafts::HMMWV_AutomaticTransmissionShafts(const std::string& name)
    : ChAutomaticTransmissionShafts(name) {
    SetGearShiftLatency(1.0);
}

void HMMWV_AutomaticTransmissionShafts::SetGearRatios(std::vector<double>& fwd, double& rev) {
...
void HMMWV_AutomaticTransmissionShafts::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunctionRecorder>& map) {
    map->AddPoint(0.0, 15);
...
void HMMWV_AutomaticTransmissionShafts::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunctionRecorder>& map) {
