...
void HMMWV_EngineShafts::SetEngineTorqueMap(std::shared_ptr<ChFunctionRecorder>& map) {
...
void HMMWV_EngineShafts::SetEngineLossesMap(std::shared_ptr<ChFunctionRecorder>& map) {
    double rpm_to_radsec = CH_C_2PI / 60.;
