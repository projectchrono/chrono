...
void HMMWV_VehicleReduced::Create(bool fixed, ChassisCollisionType chassis_collision_type) {
    ...
    m_suspensions[0] = chrono_types::make_shared<HMMWV_DoubleWishboneReducedFront>("FrontSusp");
    m_suspensions[1] = chrono_types::make_shared<HMMWV_DoubleWishboneReducedRear>("RearSusp");
