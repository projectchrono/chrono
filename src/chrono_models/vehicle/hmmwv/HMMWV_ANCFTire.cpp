...
const unsigned int HMMWV_ANCFTire::m_num_elements_bead = 2;
const unsigned int HMMWV_ANCFTire::m_num_layers_bead = 3;
...
const unsigned int HMMWV_ANCFTire::m_num_elements_sidewall = 4;
const unsigned int HMMWV_ANCFTire::m_num_layers_sidewall = 3;
...
const unsigned int HMMWV_ANCFTire::m_num_elements_tread = 6;
const unsigned int HMMWV_ANCFTire::m_num_layers_tread = 4;
