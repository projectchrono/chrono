...
double Tractor_SpringForceRear::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
    double force = 0;
...
double Tractor_ShockForceRear::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
