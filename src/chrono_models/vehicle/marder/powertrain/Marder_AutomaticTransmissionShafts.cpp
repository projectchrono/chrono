...
void Marder_AutomaticTransmissionShafts::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunctionRecorder>& map) {
...
void Marder_AutomaticTransmissionShafts::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunctionRecorder>& map) {
    // calculated from SAE TC example curve
