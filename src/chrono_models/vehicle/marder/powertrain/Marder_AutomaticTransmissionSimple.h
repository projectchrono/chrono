...
// =============================================================================
//
// Automatic transmission model for the Marder vehicle.
...
#ifndef MARDER_AUTOMATIC_TRANSMISSION_SIMPLE_H
#define MARDER_AUTOMATIC_TRANSMISSION_SIMPLE_H
...
class CH_MODELS_API Marder_AutomaticTransmissionSimple : public ChAutomaticTransmissionSimpleMap {
  public:
    Marder_AutomaticTransmissionSimple(const std::string& name);
    ~Marder_AutomaticTransmissionSimple() {}
