...
#ifndef UAZBUS_DRIVELINE_4WD_H
#define UAZBUS_DRIVELINE_4WD_H
...
class CH_MODELS_API UAZBUS_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    UAZBUS_Driveline4WD(const std::string& name);
    ~UAZBUS_Driveline4WD() {}
