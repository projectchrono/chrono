...
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_axleTubeInertia(22.21, 0.0775, 22.21);
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_spindleInertia(0.04117, 0.07352, 0.04117);
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_knuckleInertia(0.1, 0.1, 0.1);
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_tierodInertia(1.0, 0.1, 1.0);
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_draglinkInertia(0.1, 1.0, 0.1);
...
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_frontleafInertia = {0.00191239, 0.0733034, 0.0751423};
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_rearleafInertia = {0.00191239, 0.0733034, 0.0751423};
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_clampInertia = {0.000382478, 0.000593486, 0.000961259};
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::m_shackleInertia = {0.000382478, 0.000593486, 0.000961259};
...
const ChVector3d UAZBUS_SAEToeBarLeafspringAxle::getLocation(PointId which) {
    switch (which) {
        case SPRING_A:
            return ChVector3d(0.0, 0.3824, m_axleTubeRadius);
        case SPRING_C:
            return ChVector3d(0.0, 0.3824, m_axleTubeRadius + m_auxSpringDesignLength);
        case SHOCK_A:
        ...
        case CLAMP_A:
            return ChVector3d(0.044697881113434, 0.3824, 0.102479751287605);
            break;
        case CLAMP_B:
            return ChVector3d(-0.055165072362023, 0.3824, 0.097246155663310);
            break;
        case FRONT_HANGER:
            return ChVector3d(0.494081171752993, 0.3824, 0.1260);
            break;
        case REAR_HANGER:
            return ChVector3d(-0.445529598035440, 0.3824, 0.189525823498473);
            break;
        case SHACKLE:
            return ChVector3d(-0.504548363001581, 0.3824, 0.073694975353985);
            break;
        default:
