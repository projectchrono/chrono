...
#ifndef GENERIC_AUTOMATIC_TRANSMISSION_SHAFTS_H
#define GENERIC_AUTOMATIC_TRANSMISSION_SHAFTS_H
...
/// Shafts-based powertrain model for the generic vehicle.
class CH_MODELS_API Generic_AutomaticTransmissionShafts : public ChAutomaticTransmissionShafts {
  public:
    Generic_AutomaticTransmissionShafts(const std::string& name);
    ~Generic_AutomaticTransmissionShafts() {}
    ...
    virtual void SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunctionRecorder>& map) override;
    virtual void SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunctionRecorder>& map) override;
