...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Generic_Pac89Tire::Generic_Pac89Tire(const std::string& name) : ChPac89Tire(name) {}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Generic_Pac89Tire::SetPac89Params() {
...
double Generic_Pac89Tire::GetNormalStiffnessForce(double depth) const {
    /* original method
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Generic_Pac89Tire::AddVisualizationAssets(VisualizationType vis) {
...
void Generic_Pac89Tire::RemoveVisualizationAssets() {
