...
const std::string Generic_TMsimpleTire::m_meshFile_left = "generic/tire/generic_tire_coarse.obj";
const std::string Generic_TMsimpleTire::m_meshFile_right = "generic/tire/generic_tire_coarse.obj";

const double Generic_TMsimpleTire::m_mass = 37.6;
const ChVector3d Generic_TMsimpleTire::m_inertia(3.84, 6.69, 3.84);

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Generic_TMsimpleTire::Generic_TMsimpleTire(const std::string& name) : ChTMsimpleTire(name) {
    SetTMsimpleParams();
}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Generic_TMsimpleTire::SetTMsimpleParams() {
...
void Generic_TMsimpleTire::GenerateCharacteristicPlots(const std::string& dirname) {
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Generic_TMsimpleTire::AddVisualizationAssets(VisualizationType vis) {
...
void Generic_TMsimpleTire::RemoveVisualizationAssets() {
