...
#ifndef GENERIC_TMSIMPLE_TIRE_H
#define GENERIC_TMSIMPLE_TIRE_H
...
class CH_MODELS_API Generic_TMsimpleTire : public ChTMsimpleTire {
  public:
    Generic_TMsimpleTire(const std::string& name);
    ~Generic_TMsimpleTire() {}
