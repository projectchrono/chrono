...
// =============================================================================
//
// BMW E90 (330i 2006) front wheel subsystem 9x18
// Data from https://www.rsu.de (Tire Dealer)
//
// =============================================================================

#ifndef BMW_E90_FRONT_WHEEL_H
#define BMW_E90_FRONT_WHEEL_H
...
class CH_MODELS_API BMW_E90_FrontWheel : public ChWheel {
  public:
    BMW_E90_FrontWheel(const std::string& name);
    ~BMW_E90_FrontWheel() {}
