...
BMW_E90_Chassis::BMW_E90_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    ChVehicleGeometry::BoxShape box1(ChVector3d(-1, 0.0, 0.1), ChQuaternion<>(1, 0, 0, 0), ChVector3d(1, 1.0, 0.2));

    m_geometry.m_has_primitives = true;
    m_geometry.m_vis_boxes.push_back(box1);

    m_geometry.m_has_mesh = true;
    m_geometry.m_vis_mesh_file = "bmw/chassis/bmw_e90_chassis.obj";
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            ChVehicleGeometry::ConvexHullsShape hull("bmw/chassis/bmw_e90_chassis_col.obj", 0);
            m_geometry.m_coll_hulls.push_back(hull);
            break;
        }
        case CollisionType::MESH: {
            ChVehicleGeometry::TrimeshShape trimesh(ChVector3d(), "bmw/chassis/bmw_e90_chassis_col.obj", 0.005, 0);
