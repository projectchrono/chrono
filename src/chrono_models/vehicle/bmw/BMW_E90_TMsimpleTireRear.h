...
#ifndef BMW_E90_TMSIMPLE_TIRE_REAR_H
#define BMW_E90_TMSIMPLE_TIRE_REAR_H
...
/// TMsimple tire model for the BMW 330i.
class CH_MODELS_API BMW_E90_TMsimpleTireRear : public ChTMsimpleTire {
  public:
    BMW_E90_TMsimpleTireRear(const std::string& name);
    ~BMW_E90_TMsimpleTireRear() {}
