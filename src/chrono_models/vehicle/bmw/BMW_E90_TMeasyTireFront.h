...
#ifndef CHRONO_BMW_E90_TMEASYTIREFRONT_H
#define CHRONO_BMW_E90_TMEASYTIREFRONT_H
...
class CH_MODELS_API BMW_E90_TMeasyTireFront : public ChTMeasyTire {
  public:
    BMW_E90_TMeasyTireFront(const std::string& name);
    ~BMW_E90_TMeasyTireFront() {}
