...
// =============================================================================
//
// BMW E90 antirollbar RSD rear model.
// Vehicle Parameters taken from SAE Paper 2007-01-0818
//
// =============================================================================

#ifndef BMW_E90_ANTIROLLBAR_REAR_H
#define BMW_E90_ANTIROLLBAR_REAR_H
...
class CH_MODELS_API BMW_E90_AntiRollBarRear : public ChAntirollBarRSD {
  public:
    BMW_E90_AntiRollBarRear(const std::string& name);
    ~BMW_E90_AntiRollBarRear() {}
