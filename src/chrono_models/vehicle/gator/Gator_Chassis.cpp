...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Gator_Chassis::Gator_Chassis(const std::string& name, bool fixed, ChassisCollisionType chassis_collision_type)
    ...
    m_has_mesh = true;
    m_vis_mesh_file = "gator/gator_chassis.obj";
    ...
    switch (chassis_collision_type) {
        ...
        case ChassisCollisionType::MESH: {
            ConvexHullsShape hull("gator/gator_chassis_col.obj", 0);
