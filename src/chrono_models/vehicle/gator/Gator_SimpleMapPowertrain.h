...
#ifndef GATOR_SIMPLEMAP_POWERTRAIN_H
#define GATOR_SIMPLEMAP_POWERTRAIN_H
...
class CH_MODELS_API Gator_SimpleMapPowertrain : public ChSimpleMapPowertrain {
  public:
    Gator_SimpleMapPowertrain(const std::string& name);
