...
Gator_SimpleMapPowertrain::Gator_SimpleMapPowertrain(const std::string& name) : ChSimpleMapPowertrain(name) {}

double Gator_SimpleMapPowertrain::GetMaxEngineSpeed() {
    return 2700 * rpm2rads;
}

void Gator_SimpleMapPowertrain::SetEngineTorqueMaps(ChFunction_Recorder& map0, ChFunction_Recorder& mapF) {
