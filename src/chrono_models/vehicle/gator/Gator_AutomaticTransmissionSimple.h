...
#ifndef GATOR_AUTOMATICTRANSMISSIONSIMPLE_H
#define GATOR_AUTOMATICTRANSMISSIONSIMPLE_H
...
class CH_MODELS_API Gator_AutomaticTransmissionSimple : public ChAutomaticTransmissionSimpleMap {
  public:
    Gator_AutomaticTransmissionSimple(const std::string& name);
