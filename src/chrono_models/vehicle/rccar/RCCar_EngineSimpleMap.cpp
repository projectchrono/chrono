...
RCCar_EngineSimpleMap::RCCar_EngineSimpleMap(const std::string& name)
...
double RCCar_EngineSimpleMap::GetMaxEngineSpeed() {
    return m_Kv_rating * m_supply_voltage * m_voltage_ratio * rpm2rads;
}

void RCCar_EngineSimpleMap::SetEngineTorqueMaps(ChFunction_Recorder& map0, ChFunction_Recorder& mapF) {
