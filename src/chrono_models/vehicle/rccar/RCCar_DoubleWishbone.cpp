...
const double RCCar_DoubleWishboneFront::m_springCoefficient = 8000;
const double RCCar_DoubleWishboneFront::m_dampingCoefficient = 450;
const double RCCar_DoubleWishboneFront::m_springRestLength = .1363;
...
const double RCCar_DoubleWishboneRear::m_springCoefficient = 8000;  // TODO
const double RCCar_DoubleWishboneRear::m_dampingCoefficient = 450;  // TODO
const double RCCar_DoubleWishboneRear::m_springRestLength = .1363;  // TODO
...
double RCCar_ShockForce::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
    /*
    // On midstroke curve
