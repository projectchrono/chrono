...
const ChVector3d M113_TrackShoeSinglePin::m_shoe_inertia(0.22, 0.04, 0.25);
...
const ChVector3d M113_TrackShoeSinglePin::m_pin_center(0.045, 0, 0.0375);
...
M113_TrackShoeSinglePin::M113_TrackShoeSinglePin(const std::string& name) : ChTrackShoeSinglePin(name) {
    ...
    m_geometry.vis_model_file = vehicle::GetDataFile("M113/meshes/TrackShoeSinglePin.obj");
}
