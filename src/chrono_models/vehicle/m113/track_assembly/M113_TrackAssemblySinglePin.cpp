...
// Static variables
// -----------------------------------------------------------------------------
const ChVector3d M113_TrackAssemblySinglePin::m_sprocket_loc(0, 0, 0);
const ChVector3d M113_TrackAssemblySinglePin::m_idler_loc(-3.95, 0, -0.12);
const ChVector3d M113_TrackAssemblySinglePin::m_susp_locs_L[5] = {
...
const ChVector3d M113_TrackAssemblySinglePin::m_susp_locs_R[5] = {
...
// -----------------------------------------------------------------------------
const ChVector3d M113_TrackAssemblySinglePin::GetSprocketLocation() const {
    return m_sprocket_loc;
}

const ChVector3d M113_TrackAssemblySinglePin::GetIdlerLocation() const {
    return m_idler_loc;
}

const ChVector3d M113_TrackAssemblySinglePin::GetRoadWhelAssemblyLocation(int which) const {
