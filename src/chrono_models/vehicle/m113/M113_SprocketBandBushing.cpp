...
// Static variables
// -----------------------------------------------------------------------------
const double M113_SprocketBandBushing::m_gear_mass = 27.68;
const ChVector<> M113_SprocketBandBushing::m_gear_inertia(0.646, 0.883, 0.646);
const double M113_SprocketBandBushing::m_axle_inertia = 0.02;
...
const double M113_SprocketBandBushing::m_gear_guide_wheel_width = 0.181;
const double M113_SprocketBandBushing::m_gear_guide_wheel_gap = 0.051;
...
void M113_SprocketBandBushing::AddVisualizationAssets(VisualizationType vis) {
    if (vis == VisualizationType::MESH) {
        ...
        ChSprocketBandBushing::AddVisualizationAssets(vis);
