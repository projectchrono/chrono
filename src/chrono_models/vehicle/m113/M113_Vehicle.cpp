...
M113_Vehicle::M113_Vehicle(bool fixed,
    ...
    Create(fixed, shoe_type, shoe_topology, element_type, driveline_type, brake_type, use_track_bushings,
...
void M113_Vehicle::Create(bool fixed,
    ...
    switch (shoe_type) {
        ...
        case TrackShoeType::BAND_ANCF:
            m_tracks[0] = chrono_types::make_shared<M113_TrackAssemblyBandANCF>(LEFT, brake_type, element_type,
                                                                                use_suspension_bushings);
            m_tracks[1] = chrono_types::make_shared<M113_TrackAssemblyBandANCF>(RIGHT, brake_type, element_type,
                                                                                use_suspension_bushings);
            break;
    }
