...
const double M113_TrackShoeRigidCB::m_shoe_length = 0.0984;  // 3.875''
const double M113_TrackShoeRigidCB::m_shoe_width = 0.2781;   // 10.95''
const double M113_TrackShoeRigidCB::m_shoe_height = 0.06;

const double M113_TrackShoeRigidCB::m_connector_mass = 2.0;                  //// TODO
const ChVector<> M113_TrackShoeRigidCB::m_connector_inertia(0.1, 0.1, 0.1);  //// TODO
const double M113_TrackShoeRigidCB::m_connector_radius = 0.02;               // 0.88''
const double M113_TrackShoeRigidCB::m_connector_length = 0.054;              // 2.125''
const double M113_TrackShoeRigidCB::m_connector_width = 0.02;

const ChVector<> M113_TrackShoeRigidCB::m_pad_box_dims(0.11, 0.19, 0.06);
const ChVector<> M113_TrackShoeRigidCB::m_pad_box_loc(0, 0, 0);
const ChVector<> M113_TrackShoeRigidCB::m_guide_box_dims(0.0284, 0.0114, 0.075);
const ChVector<> M113_TrackShoeRigidCB::m_guide_box_loc(0.045, 0, 0.0375);
