...
#ifndef M113_SIMPLEMAP_POWERTRAIN_H
#define M113_SIMPLEMAP_POWERTRAIN_H
...
/// Simple M113 powertrain subsystem (based on engine speed-torque maps).
class CH_MODELS_API M113_SimpleMapPowertrain : public ChSimpleMapPowertrain {
  public:
    M113_SimpleMapPowertrain(const std::string& name);
