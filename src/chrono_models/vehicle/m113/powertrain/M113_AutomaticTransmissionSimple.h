...
#ifndef M113_AUTOMATIC_TRANSMISSION_SIMPLE_H
#define M113_AUTOMATIC_TRANSMISSION_SIMPLE_H
...
class CH_MODELS_API M113_AutomaticTransmissionSimple : public ChAutomaticTransmissionSimpleMap {
  public:
    M113_AutomaticTransmissionSimple(const std::string& name);
    ~M113_AutomaticTransmissionSimple() {}
