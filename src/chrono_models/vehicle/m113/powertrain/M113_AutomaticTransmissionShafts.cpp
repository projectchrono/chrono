...
void M113_AutomaticTransmissionShafts::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunctionRecorder>& map) {
    map->AddPoint(0.00, 7);
    map->AddPoint(0.25, 7);
    map->AddPoint(0.50, 7);
    map->AddPoint(0.75, 8);
...
void M113_AutomaticTransmissionShafts::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunctionRecorder>& map) {
