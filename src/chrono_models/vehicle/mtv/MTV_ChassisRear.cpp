...
MTV_ChassisRear::MTV_ChassisRear(const std::string& name, CollisionType chassis_collision_type)
    ...
    m_geometry.vis_model_file = GetVehicleDataFile("mtv/meshes/m1083_rear.obj");
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            utils::ChBodyGeometry::ConvexHullsShape hull(GetVehicleDataFile("mtv/meshes/m1083_rear.obj"), 0);
            m_geometry.coll_hulls.push_back(hull);
            break;
        }
        case CollisionType::MESH: {
            utils::ChBodyGeometry::TrimeshShape trimesh(VNULL, QUNIT, GetVehicleDataFile("mtv/meshes/m1083_rear.obj"),
                                                        1.0, 0.005, 0);
