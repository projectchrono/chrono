...
// =============================================================================
//
// Front FMTV suspension subsystems.
//
...
const double FMTV_ToebarLeafspringAxle::m_tierodMass = 5.0;
const double FMTV_ToebarLeafspringAxle::m_draglinkMass = 5.0;

const double FMTV_ToebarLeafspringAxle::m_axleTubeRadius = 0.06;
const double FMTV_ToebarLeafspringAxle::m_spindleRadius = 0.10;
const double FMTV_ToebarLeafspringAxle::m_spindleWidth = 0.06;
const double FMTV_ToebarLeafspringAxle::m_knuckleRadius = 0.06;
...
const double FMTV_ToebarLeafspringAxle::m_springRestLength = m_springDesignLength + 0.062122551;
const double FMTV_ToebarLeafspringAxle::m_springMinLength = m_springDesignLength - 0.08;
const double FMTV_ToebarLeafspringAxle::m_springMaxLength = m_springDesignLength + 0.08;
const double FMTV_ToebarLeafspringAxle::m_damperCoefficient = 48240.82294;
const double FMTV_ToebarLeafspringAxle::m_damperDegressivityCompression = 3.0;
const double FMTV_ToebarLeafspringAxle::m_damperDegressivityExpansion = 1.0;
const double FMTV_ToebarLeafspringAxle::m_axleShaftInertia = 0.4;

// ---------------------------------------------------------------------------------------
// FMTV spring functor class - implements a linear spring + bump stop + rebound stop
// ---------------------------------------------------------------------------------------
class FMTV_SpringForceFront : public ChLinkTSDA::ForceFunctor {
  public:
    FMTV_SpringForceFront(double spring_constant, double min_length, double max_length);
...
double FMTV_SpringForceFront::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
    double force = 0;
...
// -----------------------------------------------------------------------------
// FMTV shock functor class - implements a nonlinear damper
// -----------------------------------------------------------------------------
...
double FMTV_ShockForceFront::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
...
FMTV_ToebarLeafspringAxle::FMTV_ToebarLeafspringAxle(const std::string& name) : ChToeBarLeafspringAxle(name) {
    m_springForceCB =
        chrono_types::make_shared<FMTV_SpringForceFront>(m_springCoefficient, m_springMinLength, m_springMaxLength);

    m_shockForceCB = chrono_types::make_shared<FMTV_ShockForceFront>(
