...
#ifndef MTV_SOLID3LINK_AXLE_1_H
#define MTV_SOLID3LINK_AXLE_1_H
...
class CH_MODELS_API MTV_Solid3LinkAxle1 : public ChSolidThreeLinkAxle {
  public:
    MTV_Solid3LinkAxle1(const std::string& name);
    ~MTV_Solid3LinkAxle1() {}
