...
// =============================================================================
//
// LMTV front leafspring axle.
//
// =============================================================================

#ifndef LMTV_TOEBARLEAFSPRING_AXLE_H
#define LMTV_TOEBARLEAFSPRING_AXLE_H
...
class CH_MODELS_API LMTV_ToebarLeafspringAxle : public ChToeBarLeafspringAxle {
  public:
    LMTV_ToebarLeafspringAxle(const std::string& name);
    ~LMTV_ToebarLeafspringAxle();
