...
MTV_SpringForceRear::MTV_SpringForceRear(double spring_constant, double min_length, double max_length)
...
double MTV_SpringForceRear::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
    double force = 0;
...
MTV_ShockForceRear::MTV_ShockForceRear(double compression_slope,
...
double MTV_ShockForceRear::evaluate(double time, double rest_length, double length, double vel, ChLinkTSDA* link) {
