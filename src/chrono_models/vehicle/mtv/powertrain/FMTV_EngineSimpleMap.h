...
#ifndef FMTV_ENGINE_SIMPLEMAP_H
#define FMTV_ENGINE_SIMPLEMAP_H
...
class CH_MODELS_API FMTV_EngineSimpleMap : public ChEngineSimpleMap {
  public:
    FMTV_EngineSimpleMap(const std::string& name);
