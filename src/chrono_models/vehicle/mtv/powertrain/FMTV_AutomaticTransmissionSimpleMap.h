...
#ifndef FMTV_AUTOMATIC_TRANSMISSION_SIMPLEMAP_H
#define FMTV_AUTOMATIC_TRANSMISSION_SIMPLEMAP_H
...
class CH_MODELS_API FMTV_AutomaticTransmissionSimpleMap : public ChAutomaticTransmissionSimpleMap {
  public:
    FMTV_AutomaticTransmissionSimpleMap(const std::string& name);
    ~FMTV_AutomaticTransmissionSimpleMap() {}
