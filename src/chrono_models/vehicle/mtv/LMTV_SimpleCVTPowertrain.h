...
#ifndef LMTV_SIMPLECVTPOWERTRAIN_H
#define LMTV_SIMPLECVTPOWERTRAIN_H
...
class CH_MODELS_API LMTV_SimpleCVTPowertrain : public ChSimpleCVTPowertrain {
  public:
    LMTV_SimpleCVTPowertrain(const std::string& name);

    ~LMTV_SimpleCVTPowertrain() {}
