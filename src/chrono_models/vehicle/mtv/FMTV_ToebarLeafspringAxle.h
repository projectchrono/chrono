...
// =============================================================================
//
// FMTV front toebar leafspring axle.
//
// =============================================================================

#ifndef FMTV_TOEBARLEAFSPRING_AXLE_H
#define FMTV_TOEBARLEAFSPRING_AXLE_H
...
/// Toebar leafspring front axle subsystem for the FMTV vehicles.
class CH_MODELS_API FMTV_ToebarLeafspringAxle : public ChToeBarLeafspringAxle {
  public:
    FMTV_ToebarLeafspringAxle(const std::string& name);
    ~FMTV_ToebarLeafspringAxle() {}
