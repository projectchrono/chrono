...
#ifndef LMTV_DRIVELINE_4WD_H
#define LMTV_DRIVELINE_4WD_H
...
/// Shafts-based 4-WD driveline for the MTV 2.5t vehicle.
class CH_MODELS_API LMTV_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    LMTV_Driveline4WD(const std::string& name);
    ~LMTV_Driveline4WD() {}
