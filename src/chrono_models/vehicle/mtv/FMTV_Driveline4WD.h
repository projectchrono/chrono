...
#ifndef FMTV_DRIVELINE_4WD_H
#define FMTV_DRIVELINE_4WD_H
...
/// Shafts-based 4-WD driveline for the FMTV vehicles.
class CH_MODELS_API FMTV_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    FMTV_Driveline4WD(const std::string& name);
    ~FMTV_Driveline4WD() {}
