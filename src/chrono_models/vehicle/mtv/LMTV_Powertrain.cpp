...
// Static variables
// -----------------------------------------------------------------------------
const double LMTV_Powertrain::m_motorblock_inertia = 10.5;
const double LMTV_Powertrain::m_crankshaft_inertia = 1.1;
const double LMTV_Powertrain::m_ingear_shaft_inertia = 0.3;

const double LMTV_Powertrain::m_upshift_RPM = 2400;
const double LMTV_Powertrain::m_downshift_RPM = 1200;

// -----------------------------------------------------------------------------
// Constructor of the LMTV_Powertrain.
// the direction of the motor block is along the X axis, while the directions of
// the axles is along the Y axis (relative to the chassis coordinate frame),
// -----------------------------------------------------------------------------
LMTV_Powertrain::LMTV_Powertrain(const std::string& name) : ChShaftsPowertrain(name, ChVector<>(1, 0, 0)) {
...
// -----------------------------------------------------------------------------
void LMTV_Powertrain::SetGearRatios(std::vector<double>& gear_ratios) {
...
//
// -----------------------------------------------------------------------------
void LMTV_Powertrain::SetEngineTorqueMap(std::shared_ptr<ChFunction_Recorder>& map) {
...
void LMTV_Powertrain::SetEngineLossesMap(std::shared_ptr<ChFunction_Recorder>& map) {
    double rpm_to_radsec = CH_C_2PI / 60.;
...
void LMTV_Powertrain::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunction_Recorder>& map) {
    map->AddPoint(0.0, 15);
...
void LMTV_Powertrain::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunction_Recorder>& map) {
