...
Cherokee_Chassis::Cherokee_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            ChVehicleGeometry::ConvexHullsShape hull("hmmwv/Cherokee_Chassis_simple.obj", 0);
            m_geometry.m_coll_hulls.push_back(hull);
            break;
        }
        case CollisionType::MESH: {
            ChVehicleGeometry::TrimeshShape trimesh(ChVector3d(), "hmmwv/Cherokee_Chassis_simple.obj", 0.005, 0);
