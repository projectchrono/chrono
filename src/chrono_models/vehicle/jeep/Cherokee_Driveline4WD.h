...
#ifndef CHRONO_CHEROKEE_DRIVELINE4WD_H
#define CHRONO_CHEROKEE_DRIVELINE4WD_H
...
/// Shafts-based 4-WD driveline for the Jeep Cherokee vehicle.
class CH_MODELS_API Cherokee_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    Cherokee_Driveline4WD(const std::string& name);
    ~Cherokee_Driveline4WD() {}
...
#endif  // CHRONO_CHEROKEE_DRIVELINE4WD_H
