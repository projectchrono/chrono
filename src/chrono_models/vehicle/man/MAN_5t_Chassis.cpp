...
MAN_5t_Chassis::MAN_5t_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    m_geometry.vis_model_file = vehicle::GetDataFile("MAN_Kat1/meshes/MAN_5t_chassis.obj");
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            utils::ChBodyGeometry::ConvexHullsShape hull(vehicle::GetDataFile("MAN_Kat1/meshes/MAN_5t_chassis_col.obj"),
                                                         0);
        ...
        case CollisionType::MESH: {
            utils::ChBodyGeometry::TrimeshShape trimesh(
                VNULL, QUNIT, vehicle::GetDataFile("MAN_Kat1/meshes/MAN_5t_chassis_col.obj"), 1.0, 0.005, 0);
