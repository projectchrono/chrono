...
const double MAN_5t_Driveline4WD::m_central_differential_ratio = -1;
const double MAN_5t_Driveline4WD::m_front_differential_ratio = -1;
const double MAN_5t_Driveline4WD::m_rear_differential_ratio = -1;
const double MAN_5t_Driveline4WD::m_front_conicalgear_ratio = -1.0 / 3.947 / 1.706 / 1.02;
const double MAN_5t_Driveline4WD::m_rear_conicalgear_ratio = -1.0 / 3.947 / 1.706 / 1.02;
