...
#ifndef MAN_7T_ENGINE_SIMPLEMAP_H
#define MAN_7T_ENGINE_SIMPLEMAP_H
...
class CH_MODELS_API MAN_7t_EngineSimpleMap : public ChEngineSimpleMap {
  public:
    MAN_7t_EngineSimpleMap(const std::string& name);
