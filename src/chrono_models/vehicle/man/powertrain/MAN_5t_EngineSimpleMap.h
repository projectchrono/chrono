...
#ifndef MAN_5T_ENGINE_SIMPLEMAP_H
#define MAN_5T_ENGINE_SIMPLEMAP_H
...
class CH_MODELS_API MAN_5t_EngineSimpleMap : public ChEngineSimpleMap {
  public:
    MAN_5t_EngineSimpleMap(const std::string& name);
