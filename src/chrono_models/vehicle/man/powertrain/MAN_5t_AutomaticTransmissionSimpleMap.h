...
#ifndef MAN_5T_AUTOMATIC_TRANSMISSION_SIMPLE_MAP_H
#define MAN_5T_AUTOMATIC_TRANSMISSION_SIMPLE_MAP_H
...
class CH_MODELS_API MAN_5t_AutomaticTransmissionSimpleMap : public ChAutomaticTransmissionSimpleMap {
  public:
    MAN_5t_AutomaticTransmissionSimpleMap(const std::string& name);
