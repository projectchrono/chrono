...
MAN_10t_Chassis::MAN_10t_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    m_geometry.m_vis_mesh_file = "MAN_Kat1/meshes/MAN_10t_chassis.obj";
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            ChVehicleGeometry::ConvexHullsShape hull("MAN_Kat1/meshes/MAN_10t_chassis_col.obj", 0);
            m_geometry.m_coll_hulls.push_back(hull);
            break;
        }
        case CollisionType::MESH: {
            ChVehicleGeometry::TrimeshShape trimesh(ChVector3d(), "MAN_Kat1/meshes/MAN_10t_chassis_col.obj", 0.005, 0);
