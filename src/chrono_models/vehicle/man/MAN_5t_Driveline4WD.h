...
#ifndef MAN5T_DRIVELINE_4WD_H
#define MAN5T_DRIVELINE_4WD_H
...
class CH_MODELS_API MAN_5t_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    MAN_5t_Driveline4WD(const std::string& name);
    ~MAN_5t_Driveline4WD() {}
