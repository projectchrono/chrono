...
// Static variables
// -----------------------------------------------------------------------------
const double MAN_7t_SimpleCVTPowertrain::m_max_torque = 890.0 * 43.0;
const double MAN_7t_SimpleCVTPowertrain::m_max_power = 256000;
const double MAN_7t_SimpleCVTPowertrain::m_max_speed = 300;
const double MAN_7t_SimpleCVTPowertrain::m_fwd_gear_ratio = 1.0;
const double MAN_7t_SimpleCVTPowertrain::m_rev_gear_ratio = -1.0;

// -----------------------------------------------------------------------------
MAN_7t_SimpleCVTPowertrain::MAN_7t_SimpleCVTPowertrain(const std::string& name)
    : ChSimpleCVTPowertrain(name) {}

void MAN_7t_SimpleCVTPowertrain::SetGearRatios(std::vector<double>& fwd, double& rev) {
