...
// =============================================================================
//
// MAN 7t (rear) solid three link axle. Spring is less stiff compared to 5t axle
//
// =============================================================================

#ifndef MAN_7T_SOLID3LINK_AXLE_H
#define MAN_7T_SOLID3LINK_AXLE_H
...
class CH_MODELS_API MAN_7t_Solid3LinkAxle : public ChSolidThreeLinkAxle {
  public:
    MAN_7t_Solid3LinkAxle(const std::string& name);
    ~MAN_7t_Solid3LinkAxle();
