...
// =============================================================================
//
// MAN 10t (front2) steered and driven solid three link axle.
//
// =============================================================================
...
const double MAN_10t_Front2Axle::m_axleTubeMass = 405.0;
const double MAN_10t_Front2Axle::m_spindleMass = 14.705 * 4.1;
...
const double MAN_10t_Front2Axle::m_spindleWidth = 0.06;

const ChVector3d MAN_10t_Front2Axle::m_axleTubeInertia(21.23, 8.12, 21.31);
const ChVector3d MAN_10t_Front2Axle::m_spindleInertia(0.04117 * 6.56, 0.07352 * 6.56, 0.04117 * 6.56);
const ChVector3d MAN_10t_Front2Axle::m_bellcrankInertia(0.05, 0.29, 0.30);
const ChVector3d MAN_10t_Front2Axle::m_knuckleInertia(2.40, 3.97, 2.45);
const ChVector3d MAN_10t_Front2Axle::m_draglinkInertia(0.29, 0.67, 0.95);
const ChVector3d MAN_10t_Front2Axle::m_triangleInertia(0.2, 0.2, 0.2);
const ChVector3d MAN_10t_Front2Axle::m_linkInertia(0.05, 0.1, 0.1);
const ChVector3d MAN_10t_Front2Axle::m_tierodInertia(0.05, 0.05, 0.5);
...
const double MAN_10t_Front2Axle::m_springCoefficient2 = 495208.0;  // quadratic
const double MAN_10t_Front2Axle::m_springRestLength = 0.649;
const double MAN_10t_Front2Axle::m_springMinLength = 0.335;
const double MAN_10t_Front2Axle::m_springMaxLength = m_springDesignLength + 0.15;
const double MAN_10t_Front2Axle::m_damperCoefExpansion = 98727.9;
const double MAN_10t_Front2Axle::m_damperDegresExpansion = 4.77954;
const double MAN_10t_Front2Axle::m_damperCoefCompression = 52526.6;
const double MAN_10t_Front2Axle::m_damperDegresCompression = 3.0;
const double MAN_10t_Front2Axle::m_axleShaftInertia = 0.4 * 6.56;

const double MAN_10t_Front2Axle::m_twin_tire_dist = 0.0;
...
// ---------------------------------------------------------------------------------------
class MAN_10t_SpringForceFront2 : public ChLinkTSDA::ForceFunctor {
  public:
    MAN_10t_SpringForceFront2(double spring_constant1,
...
const ChVector3d MAN_10t_Front2Axle::getLocation(PointId which) {
    switch (which) {
        case SPRING_A:
        ...
        case KNUCKLE_U:
            return ChVector3d(0.000, 0.845 - 2 * 0.004374433, 0.10);
        case KNUCKLE_T:
            // return ChVector3d(-0.236, 0.800, 0.153); 5t/7t front axle
            // return ChVector3d(-0.238119607, 0.813061735, 0.153);  // 10 front 1 axle
            return ChVector3d(-0.235882642, 0.799388826, 0.153);  // 10 front 2 axle
        case KNUCKLE_CM:
