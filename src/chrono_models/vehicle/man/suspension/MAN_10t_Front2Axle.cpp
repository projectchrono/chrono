...
const ChVector<> MAN_10t_Front2Axle::m_axleTubeInertia(21.23, 8.12, 21.31);
const ChVector<> MAN_10t_Front2Axle::m_spindleInertia(0.04117 * 6.56, 0.07352 * 6.56, 0.04117 * 6.56);
