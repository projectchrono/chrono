...
const ChVector3d MAN_5t_Solid3LinkAxle::m_axleTubeInertia(329.00, 16.46, 330.00);
const ChVector3d MAN_5t_Solid3LinkAxle::m_spindleInertia(0.04117 * 6.56, 0.07352 * 6.56, 0.04117 * 6.56);
const ChVector3d MAN_5t_Solid3LinkAxle::m_triangleInertia(0.2, 0.2, 0.2);
const ChVector3d MAN_5t_Solid3LinkAxle::m_linkInertia(0.05, 0.1, 0.1);
...
double MAN_5t_SpringForceRear::evaluate(double time,
                                        double rest_length,
                                        double length,
                                        double vel,
...
const ChVector3d MAN_5t_Solid3LinkAxle::getLocation(PointId which) {
    switch (which) {
        case SPRING_A:
