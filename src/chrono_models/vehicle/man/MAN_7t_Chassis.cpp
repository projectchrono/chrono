...
// const ChVector3d MAN_7t_Chassis::m_body_inertiaXX(222.8, 944.1, 1053.5);
const ChVector3d MAN_7t_Chassis::m_body_inertiaXX(4023, 33309, 34373);
const ChVector3d MAN_7t_Chassis::m_body_inertiaXY(0, 0, 0);
const ChVector3d MAN_7t_Chassis::m_body_COM_loc(-1.948, 0, 0.744);
const ChCoordsys<> MAN_7t_Chassis::m_driverCsys(ChVector3d(0.0, 0.5, 1.2), ChQuaternion<>(1, 0, 0, 0));
...
MAN_7t_Chassis::MAN_7t_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    m_geometry.vis_model_file = GetVehicleDataFile("MAN_Kat1/meshes/MAN_7t_chassis.obj");
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            utils::ChBodyGeometry::ConvexHullsShape hull(GetVehicleDataFile("MAN_Kat1/meshes/MAN_7t_chassis_col.obj"),
                                                         0);
        ...
        case CollisionType::MESH: {
            utils::ChBodyGeometry::TrimeshShape trimesh(
                VNULL, QUNIT, GetVehicleDataFile("MAN_Kat1/meshes/MAN_7t_chassis_col.obj"), 1.0, 0.005, 0);
