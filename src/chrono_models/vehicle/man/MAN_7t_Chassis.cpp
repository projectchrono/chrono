...
// Static variables
// -----------------------------------------------------------------------------
const double MAN_7t_Chassis::m_mass = 7085 + 1200;
// const ChVector<> MAN_7t_Chassis::m_inertiaXX(222.8, 944.1, 1053.5);
const ChVector<> MAN_7t_Chassis::m_inertiaXX(4023, 33309, 34373);
const ChVector<> MAN_7t_Chassis::m_inertiaXY(0, 0, 0);
const ChVector<> MAN_7t_Chassis::m_COM_loc(-1.948, 0, 0.744);
...
MAN_7t_Chassis::MAN_7t_Chassis(const std::string& name, bool fixed, ChassisCollisionType chassis_collision_type)
    ...
    switch (chassis_collision_type) {
        ...
        case ChassisCollisionType::MESH: {
            ChRigidChassisGeometry::ConvexHullsShape hull("MAN_Kat1/meshes/MAN_7t_chassis_col.obj", 0);
