...
#ifndef MAN_10T_FRONT2_AXLE_H
#define MAN_10T_FRONT2_AXLE_H
...
class CH_MODELS_API MAN_10t_Front2Axle : public ChSolidBellcrankThreeLinkAxle {
  public:
    MAN_10t_Front2Axle(const std::string& name);
    ~MAN_10t_Front2Axle();
