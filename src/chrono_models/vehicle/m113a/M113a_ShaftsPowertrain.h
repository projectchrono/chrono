...
#ifndef M113a_SHAFTS_POWERTRAIN_H
#define M113a_SHAFTS_POWERTRAIN_H
...
class CH_MODELS_API M113a_ShaftsPowertrain : public ChShaftsPowertrain {
  public:
    M113a_ShaftsPowertrain(const std::string& name);
