...
void M113a_TrackShoeSinglePin::CreateCylContactMaterial(ChContactMethod contact_method) {
...
void M113a_TrackShoeSinglePin::CreateShoeContactMaterials(ChContactMethod contact_method) {
