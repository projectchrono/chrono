...
const double FEDA_Driveline4WD::m_central_differential_ratio = -1;
const double FEDA_Driveline4WD::m_front_differential_ratio = -1;
const double FEDA_Driveline4WD::m_rear_differential_ratio = -1;
const double FEDA_Driveline4WD::m_front_conicalgear_ratio = -1.0 / 4.88;
const double FEDA_Driveline4WD::m_rear_conicalgear_ratio = -1.0 / 4.88;
