...
#ifndef FEDA_POWERTRAIN_H
#define FEDA_POWERTRAIN_H
...
/// Shafts-based powertrain model for the FEDA vehicle.
class CH_MODELS_API FEDA_Powertrain : public ChShaftsPowertrain {
  public:
    FEDA_Powertrain(const std::string& name);
