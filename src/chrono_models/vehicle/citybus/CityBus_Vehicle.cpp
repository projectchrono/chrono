...
void CityBus_Vehicle::Create(bool fixed, ChassisCollisionType chassis_collision_type) {
    ...
    m_axles[0]->m_wheels_left[0] = chrono_types::make_shared<CityBus_WheelLeft>("Wheel_FL");
    m_axles[0]->m_wheels_right[0] = chrono_types::make_shared<CityBus_WheelLeft>("Wheel_FR");
    m_axles[1]->m_wheels_left.resize(1);
    m_axles[1]->m_wheels_right.resize(1);
    m_axles[1]->m_wheels_left[0] = chrono_types::make_shared<CityBus_WheelLeft>("Wheel_RL");
    m_axles[1]->m_wheels_right[0] = chrono_types::make_shared<CityBus_WheelLeft>("Wheel_RR");
