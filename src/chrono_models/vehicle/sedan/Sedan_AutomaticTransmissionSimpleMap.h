...
#ifndef SEDAN_AUTOMATICTRANSMISSIONSIMPLEMAP_H
#define SEDAN_AUTOMATICTRANSMISSIONSIMPLEMAP_H
...
class CH_MODELS_API Sedan_AutomaticTransmissionSimpleMap : public ChAutomaticTransmissionSimpleMap {
  public:
    Sedan_AutomaticTransmissionSimpleMap(const std::string& name);
