...
#ifndef SEDAN_SIMPLEMAP_POWERTRAIN_H
#define SEDAN_SIMPLEMAP_POWERTRAIN_H
...
class CH_MODELS_API Sedan_SimpleMapPowertrain : public ChSimpleMapPowertrain {
  public:
    Sedan_SimpleMapPowertrain(const std::string& name);
