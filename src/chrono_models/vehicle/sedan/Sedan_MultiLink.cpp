...
const ChVector3d Sedan_MultiLink::m_spindleInertia(0.000478, 0.000478, 0.000496);
const ChVector3d Sedan_MultiLink::m_upperArmInertia(0.0237, 0.0294, 0.00612);
const ChVector3d Sedan_MultiLink::m_lateralInertia(0.0543, 0.0541, 0.000279);
const ChVector3d Sedan_MultiLink::m_trailingLinkInertia(0.0762, 0.527, 0.567);
const ChVector3d Sedan_MultiLink::m_uprightInertia(0.0250, 0.00653, 0.0284);
...
const ChVector3d Sedan_MultiLink::getLocation(PointId which) {
    switch (which) {
        case SPINDLE:
            return ChVector3d(0.000, 0.8, 0.000);
        case UPRIGHT:
            return ChVector3d(0.000, 0.76, 0.000);
        case UA_F:
            return ChVector3d(0.060, 0.397, 0.082);
        case UA_B:
            return ChVector3d(-0.157, 0.358, 0.062);
        case UA_U:
            return ChVector3d(0.056, 0.714, 0.151);
        case UA_CM:
            return ChVector3d(-0.014, 0.490, 0.098);
        case LAT_C:
            return ChVector3d(0.036, 0.188, -0.133);
        case LAT_U:
            return ChVector3d(0.029, 0.692, -0.093);
        case LAT_CM:
            return ChVector3d(0.033, 0.440, -0.113);
        case TL_C:
            return ChVector3d(0.723, 0.449, -0.072);
        case TL_U:
            return ChVector3d(-0.000, 0.714, -0.156);
        case TL_CM:
            return ChVector3d(0.279, 0.543, -0.132);
        case SHOCK_C:
            return ChVector3d(0.171, 0.478, 0.315);
        case SHOCK_L:
            return ChVector3d(0.181, 0.519, -0.162);
        case SPRING_C:
            return ChVector3d(0.181, 0.491, 0.110);
        case SPRING_L:
            return ChVector3d(0.181, 0.419, -0.164);
        case TIEROD_C:
            return ChVector3d(-0.257, 0.170, -0.116);
        case TIEROD_U:
            return ChVector3d(-0.144, 0.712, -0.056);
        default:
...
const ChVector3d Sedan_MultiLink::getDirection(DirectionId which) {
    switch (which) {
