...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Sedan_Pac02Tire::Sedan_Pac02Tire(const std::string& name) : ChPac02Tire(name), m_use_vert_map(false) {}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Sedan_Pac02Tire::SetPac02Params() {
...
double Sedan_Pac02Tire::GetNormalStiffnessForce(double depth) const {
    if (m_use_vert_map)
...
void Sedan_Pac02Tire::RemoveVisualizationAssets() {
    ...
    // Make sure we only remove the assets added by Sedan_Pac02Tire::AddVisualizationAssets.
