...
#ifndef SEDANL_VEHICLE_H
#define SEDANL_VEHICLE_H
...
namespace vehicle
{
    namespace sedan
    {
        ...
        class CH_MODELS_API SedanL_Vehicle : public ChWheeledVehicle
        {
        public:
            SedanL_Vehicle(const bool fixed = false,
                ChMaterialSurface::ContactMethod contact_method = ChMaterialSurface::NSC,
                ChassisCollisionType chassis_collision_type = ChassisCollisionType::NONE);

            SedanL_Vehicle(ChSystem* system,
