...
/// Double wishbone suspension model for a sedan vehicle (front).
class CH_MODELS_API Sedan_DoubleWishboneFront : public ChDoubleWishbone {
  public:
    // Constructor takes as argument the name of the subsystem instance.
    Sedan_DoubleWishboneFront(const std::string& name);

    // Destructor
    ~Sedan_DoubleWishboneFront();
...
/// Double wishbone suspension model for a sedan vehicle (rear).
// class CH_MODELS_API Sedan_DoubleWishboneRear : public ChDoubleWishbone {
//   public:
//     // Constructor takes as argument the name of the subsystem instance.
//     Sedan_DoubleWishboneRear(const std::string& name);
//
//     // Destructor
//     ~Sedan_DoubleWishboneRear();
//
//     // Implementation of virtual methods imposed by the base class ChDoubleWishbone
//
//     virtual const ChVector<> getLocation(PointId which) override;
