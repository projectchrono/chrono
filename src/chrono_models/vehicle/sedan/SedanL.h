...
namespace vehicle
{
    namespace sedan
    {
        ...
        class CH_MODELS_API SedanL
        {
        public:
            SedanL();
            SedanL(ChSystem* system);
            ...
            ChPowertrain& GetPowertrain() const
            {
                return *m_powertrain;
            }
            ChTire* GetTire(WheelID which) const
            {
                return m_tires[which.id()];
            }
