...
#ifndef Duro_AUTOMATIC_TRANSMISSION_SHAFTS_H
#define Duro_AUTOMATIC_TRANSMISSION_SHAFTS_H
...
class CH_MODELS_API Duro_AutomaticTransmissionShafts : public ChAutomaticTransmissionShafts {
  public:
    Duro_AutomaticTransmissionShafts(const std::string& name);
    ~Duro_AutomaticTransmissionShafts() {}
