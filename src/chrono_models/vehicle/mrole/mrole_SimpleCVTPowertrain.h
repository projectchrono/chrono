...
#ifndef MROLE_SIMPLECVTPOWERTRAIN_H
#define MROLE_SIMPLECVTPOWERTRAIN_H
...
class CH_MODELS_API mrole_SimpleCVTPowertrain : public ChSimpleCVTPowertrain {
  public:
    mrole_SimpleCVTPowertrain(const std::string& name);

    ~mrole_SimpleCVTPowertrain() {}
