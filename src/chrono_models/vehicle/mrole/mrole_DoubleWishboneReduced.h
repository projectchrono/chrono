...
#ifndef MROLE_DOUBLEWISHBONE_REDUCED_H
#define MROLE_DOUBLEWISHBONE_REDUCED_H
...
class CH_MODELS_API mrole_DoubleWishboneReducedFront : public ChDoubleWishboneReduced {
  public:
...
/// Reduced double wishbone rear suspension for the mrole vehicle.
/// The control arms are modeled using distance constraints.
class CH_MODELS_API mrole_DoubleWishboneReducedRear : public ChDoubleWishboneReduced {
  public:
