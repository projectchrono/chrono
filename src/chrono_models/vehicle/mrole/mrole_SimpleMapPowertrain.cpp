...
mrole_SimpleMapPowertrain::mrole_SimpleMapPowertrain(const std::string& name) : ChSimpleMapPowertrain(name) {}

double mrole_SimpleMapPowertrain::GetMaxEngineSpeed() {
    return 2700 * rpm2rads;
}

void mrole_SimpleMapPowertrain::SetEngineTorqueMaps(ChFunction_Recorder& map0, ChFunction_Recorder& mapF) {
...
void mrole_SimpleMapPowertrain::SetGearRatios(std::vector<double>& fwd, double& rev) {
    rev = -0.2;
...
void mrole_SimpleMapPowertrain::SetShiftPoints(std::vector<std::pair<double, double>>& shift_bands) {
