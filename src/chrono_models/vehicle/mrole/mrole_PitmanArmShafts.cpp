...
#include "chrono_models/vehicle/mrole/mrole_PitmanArmShafts.h"
...
const double mrole_PitmanArmShafts::m_steeringLinkMass = 3.6814844109;
const double mrole_PitmanArmShafts::m_pitmanArmMass = 1.605;

const double mrole_PitmanArmShafts::m_steeringLinkRadius = 0.03;
const double mrole_PitmanArmShafts::m_pitmanArmRadius = 0.02;

//// NOTE: maxAngle (at steering wheel) and gear ratio set such that max angle at revolute = 30
const double mrole_PitmanArmShafts::m_maxAngle = 780.0 * (CH_C_PI / 180);
const double mrole_PitmanArmShafts::m_gearRatio = 780.0 / 30.0;
//// NOTE: steering compliance 2000 N.mm/deg (too low?)
const double mrole_PitmanArmShafts::m_steeringCompliance = 2 * CH_C_RAD_TO_DEG;
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
mrole_PitmanArmShafts::mrole_PitmanArmShafts(const std::string& name, bool rigid_connection)
