...
#ifndef U401_DRIVELINE_4WD_H
#define U401_DRIVELINE_4WD_H
...
class CH_MODELS_API U401_Driveline4WD : public ChShaftsDriveline4WD {
   public:
    U401_Driveline4WD(const std::string& name);
    ~U401_Driveline4WD() {}
