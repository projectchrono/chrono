...
// =============================================================================
//
// GCLASS 4WD driveline model based on ChShaft objects.
//
// =============================================================================

#ifndef GCLASS_DRIVELINE_4WD_H
#define GCLASS_DRIVELINE_4WD_H
...
class CH_MODELS_API G500_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    G500_Driveline4WD(const std::string& name);
    ~G500_Driveline4WD() {}
