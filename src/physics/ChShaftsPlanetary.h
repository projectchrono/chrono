...
public:
	...
	virtual int Initialize(ChSharedShaftPtr& mshaft1, ///< first  shaft to join (carrier wheel -usually the output)
						   ChSharedShaftPtr& mshaft2, ///< second shaft to join (wheel -usually the input)
						   ChSharedShaftPtr& mshaft3  ///< third  shaft to join (wheel -other input, or fixed)
						   );
