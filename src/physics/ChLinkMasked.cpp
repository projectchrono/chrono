...
void ChLinkMasked::IntLoadResidual_CqL(
...
void ChLinkMasked::IntLoadConstraint_C(
...
void ChLinkMasked::IntLoadConstraint_Ct(
					const unsigned int off_L,	 ///< offset in Qc residual
