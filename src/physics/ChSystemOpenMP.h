...
class ChApi ChSystemOpenMP: public ChSystem {
    ...
    public:
        ...
        void LCPprepare(bool load_jacobians, bool load_v, double F_factor, double Ct_factor, double C_factor, double recovery_clamp, bool do_clamp, ChLcpSystemDescriptor& mdescriptor);
