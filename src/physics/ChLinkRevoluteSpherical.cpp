...
void ChLinkRevoluteSpherical::IntLoadConstraint_C(
					...
					)
{
	...
	double cnstr_dist_violation = do_clamp ?
		ChMin(ChMax(c * (m_cur_dist - m_dist), -recovery_clamp), recovery_clamp) :
		c * (m_cur_dist - m_dist);

	double cnstr_dot_violation = do_clamp ?
		ChMin(ChMax(c * m_cur_dot, -recovery_clamp), recovery_clamp) :
		c * m_cur_dot;
...
void ChLinkRevoluteSpherical::IntToLCP(
...
void ChLinkRevoluteSpherical::IntFromLCP(
