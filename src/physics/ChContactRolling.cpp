...
void ChContactRolling::Reset(
    ...
    ChContact::Reset(mmodA, mmodB,
                     ...
                     vN,               ///< pass coll.normal, respect to A
                     mdistance,        ///< pass the distance (negative for penetration)
                     mreaction_cache,  ///< pass the pointer to array of N,U,V reactions: a cache in contact manifold.
                     /// If not available=0.
                     mmaterial  ///< pass the reference to the material with friction, stiffness, etc.
                     );
...
void ChContactRolling::ContIntLoadResidual_CqL(const unsigned int off_L,    ///< offset in L multipliers
...
void ChContactRolling::ContIntLoadConstraint_C(const unsigned int off_L,  ///< offset in Qc residual
...
void ChContactRolling::ContIntToLCP(const unsigned int off_L,  ///< offset in L, Qc
...
void ChContactRolling::ContIntFromLCP(const unsigned int off_L,  ///< offset in L
                                      ChVectorDynamic<>& L) {
    // base behaviour too
