...
//
// =============================================================================
// Authors: Felipe Gutierrez, Colain Kelly
// =============================================================================
...
class BaseTest {
  public:
    ...
    BaseTest(const std::string& testName, const std::string& testProjectName)
        : m_name(testName), m_projectName(testProjectName), m_passed(false) {
        m_path = "../RESULTS/";
    ...
    void addMetric(const std::string& metricName, int metricValue) { m_jsonMetrics.AddMember(metricName, metricValue); }
  ...
  private:
    std::ofstream m_jsonfile;   ///< Json file to write at the end
    ...
    void finalizeJson() {
        ...
        //    m_jsonfile.open(m_path + m_name + ".json");
        //    m_jsonfile << m_jsonTest.GetObject();
        //    m_jsonfile.close();
