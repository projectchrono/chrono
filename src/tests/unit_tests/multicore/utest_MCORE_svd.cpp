...
int main(int argc, char* argv[]) {
    ...
    // Print(U, "U");
    printf("U\n");
    Assert_near(U, Mat33f(0.6612191451724509505538663, 0.6742202427583622315054868, 0.3289624694585512321154397,
              ...
              1e-7f);
    printf("V\n");
    Assert_near(V, Mat33f(0.6556436385585946435838878, 0.5847646613644273960730402, 0.4776836924545294627009184,
                       -0.3055753507677172464696014, -0.3730222352637652116769118, 0.8760582840211093014204380,
                       0.6904745644995428088819267, -0.7203504028028100414360324, -0.0658799890785948943916495),
              1e-7f);
    printf("SV\n");
    Assert_near(SV, real3(1.8168134288659023578560436, 0.8389195906890580811676728, -0.1815083883753765836566174), 1e-7);
