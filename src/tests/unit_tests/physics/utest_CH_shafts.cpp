...
TEST_P(ChShaftTest, shaft_body) {
    ...
    auto shaftC = chrono::make_shared<ChShaft>();
    ...
    auto shaft_torsionAC = chrono::make_shared<ChShaftsTorsionSpring>();
    ...
    auto shaftbody_connection = chrono::make_shared<ChShaftsBody>();
...
TEST_P(ChShaftTest, clutch) {
    ...
    auto clutchAB = chrono::make_shared<ChShaftsClutch>();
...
TEST_P(ChShaftTest, shaft_shaft_shaft) {
    ...
    auto planetaryBAC = chrono::make_shared<ChShaftsPlanetary>();
    ...
    auto shaftD = chrono::make_shared<ChShaft>();
    ...
    auto clutchBD = chrono::make_shared<ChShaftsClutch>();
