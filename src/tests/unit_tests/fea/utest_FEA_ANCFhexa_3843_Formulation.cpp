...
bool ANCFBrickTest::AxialDisplacementCheck(int msglvl) {
    ...
    bool passed_angles = (abs(Tip_Angles.x() * CH_RAD_TO_DEG) < 0.01) &&
                         (abs(Tip_Angles.y() * CH_RAD_TO_DEG) < 0.01) &&
...
bool ANCFBrickTest::CantileverTipLoadCheck(int msglvl) {
    // =============================================================================
...
bool ANCFBrickTest::CantileverGravityCheck(int msglvl) {
    // =============================================================================
