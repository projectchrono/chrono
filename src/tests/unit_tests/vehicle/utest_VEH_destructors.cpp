...
TEST(ChronoVehicle, destructors_chassis) {
    ...
    {
        chrono_types::make_shared<ChassisConnectorArticulated>(GetVehicleDataFile("articulated_chassis/ACV_Connector.json"));
    }
    {
        chrono_types::make_shared<ChassisConnectorHitch>(GetVehicleDataFile("ultra_tow/UT_Hitch.json"));
    }
    {
        chrono_types::make_shared<ChassisConnectorTorsion>(GetVehicleDataFile("mtv/chassis/MTV_ChassisConnector.json"));
    }
}
...
TEST(ChronoVehicle, destructors_powertrain) {
    ...
    {
        chrono_types::make_shared<AutomaticTransmissionShafts>(GetVehicleDataFile("hmmwv/powertrain/HMMWV_AutomaticTransmissionShafts.json"));
    }
    {
        chrono_types::make_shared<AutomaticTransmissionSimpleMap>(GetVehicleDataFile("hmmwv/powertrain/HMMWV_AutomaticTransmissionSimpleMap.json"));
    }
    {
        chrono_types::make_shared<ManualTransmissionShafts>(GetVehicleDataFile("audi/json/audi_ManualTransmissionShafts.json"));
    }
}

TEST(ChronoVehicle, destructors_wheeled) {
    // Anti-roll bar templates
    ...
    {
        chrono_types::make_shared<SimpleDrivelineXWD>(GetVehicleDataFile("MAN_Kat1/driveline/MAN_5t_DrivelineSimpleXWD.json"));
    }
    ...
    {
        chrono_types::make_shared<DoubleWishbone>(GetVehicleDataFile("hmmwv/suspension/HMMWV_DoubleWishboneFront.json"));
    }
    {
        chrono_types::make_shared<DoubleWishboneReduced>(GetVehicleDataFile("hmmwv/suspension/HMMWV_DoubleWishboneReducedFront.json"));
    }
    {
        chrono_types::make_shared<GenericWheeledSuspension>(GetVehicleDataFile("hmmwv/suspension/HMMWV_DoubleWishboneFront_replica.json"));
    }
    {
        chrono_types::make_shared<HendricksonPRIMAXX>(GetVehicleDataFile("generic/suspension/HendricksonPRIMAXX.json"));
    }
    {
        chrono_types::make_shared<LeafspringAxle>(GetVehicleDataFile("uaz/suspension/UAZBUS_RearLeafspringAxle.json"));
    }
    {
    ...
    {
        chrono_types::make_shared<SAELeafspringAxle>(GetVehicleDataFile("uaz/suspension/UAZBUS_RearSAELeafspringAxle.json"));
    }
    {
        chrono_types::make_shared<SAEToeBarLeafspringAxle>(GetVehicleDataFile("uaz/suspension/UAZBUS_FrontSAELeafspringAxle.json"));
    }
    {
    ...
    {
        chrono_types::make_shared<SolidBellcrankThreeLinkAxle>(GetVehicleDataFile("MAN_Kat1/suspension/MAN_5t_FrontSolidThreeLinkAxle.json"));
    }
    {
        chrono_types::make_shared<SolidThreeLinkAxle>(GetVehicleDataFile("MAN_Kat1/suspension/MAN_5t_RearSolidThreeLinkAxle.json"));
    }
    {
    ...
    {
        chrono_types::make_shared<ToeBarLeafspringAxle>(GetVehicleDataFile("uaz/suspension/UAZBUS_FrontLeafspringAxle.json"));
    }
    {
        chrono_types::make_shared<ToeBarPushPipeAxle>(GetVehicleDataFile("uaz/suspension/UAZBUS_FrontPushPipeAxle.json"));
    }
    {
        chrono_types::make_shared<ToeBarRigidPanhardAxle>(GetVehicleDataFile("gclass/suspension/G500_FrontAxle.json"));
    }
    ...
    {
        auto veh = chrono_types::make_shared<WheeledVehicle>(GetVehicleDataFile("generic/vehicle/Vehicle_DoubleWishbones.json"));
        chrono_types::make_shared<WheeledTrailer>(veh->GetSystem(), GetVehicleDataFile("ultra_tow/UT_Trailer.json"), false);
    }
}
