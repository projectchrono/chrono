...
void ChLcpSystemDescriptor::ConvertToMatrixForm(ChEigenMatrix* Z,
	ChMatrix<>* rhs,
	ChEigenMatrix* Cq,
	ChEigenMatrix* M,
	ChEigenMatrix* E,
...
// OBSOLETE: with Eigen CSR3 Matrix
void ChLcpSystemDescriptor::BuildMatrices(ChEigenMatrix* Cq,
											ChEigenMatrix* M,
											bool only_bilaterals,
											bool skip_contacts_uv) {
	this->ConvertToMatrixForm(0, 0, Cq, M, 0, 0, 0, 0, only_bilaterals, skip_contacts_uv);
}
