...
ChMulPathFollowerACCDriver::ChMulPathFollowerACCDriver(
    ChVehicle& vehicle,
...
void ChMulPathFollowerACCDriver::Create() {
...
void ChMulPathFollowerACCDriver::Reset() {
    m_steeringPID.Reset(m_vehicle);
    m_speedPID.Reset(m_vehicle);
}

void ChMulPathFollowerACCDriver::Advance(double step) {
...
void ChMulPathFollowerACCDriver::ExportPathPovray(const std::string& out_dir) {
