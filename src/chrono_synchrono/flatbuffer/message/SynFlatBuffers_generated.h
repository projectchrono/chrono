...
inline const Color (&EnumValuesColor())[3] {
    static const Color values[] = {Color_Green, Color_Yellow, Color_Red};
    return values;
}

inline const char* const* EnumNamesColor() {
    static const char* const names[4] = {"Green", "Yellow", "Red", nullptr};
    return names;
}

inline const char* EnumNameColor(Color e) {
    if (flatbuffers::IsOutRange(e, Color_Green, Color_Red))
        return "";
...
inline const Type (&EnumValuesType())[9] {
    static const Type values[] = {Type_NONE,
...
inline const char* EnumNameType(Type e) {
    if (flatbuffers::IsOutRange(e, Type_NONE, Type_Copter_Description))
        return "";
    const size_t index = static_cast<size_t>(e);
...
template <>
struct TypeTraits<SynFlatBuffers::Agent::WheeledVehicle::State> {
    static const Type enum_value = Type_WheeledVehicle_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::WheeledVehicle::Description> {
    static const Type enum_value = Type_WheeledVehicle_Description;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::TrackedVehicle::State> {
    static const Type enum_value = Type_TrackedVehicle_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::TrackedVehicle::Description> {
    static const Type enum_value = Type_TrackedVehicle_Description;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::Environment::State> {
    static const Type enum_value = Type_Environment_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::Environment::Description> {
    static const Type enum_value = Type_Environment_Description;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::Copter::State> {
    static const Type enum_value = Type_Copter_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::Copter::Description> {
...
enum Type : uint8_t { Type_NONE = 0, Type_SCM_State = 1, Type_MIN = Type_NONE, Type_MAX = Type_SCM_State };

inline const Type (&EnumValuesType())[2] {
    static const Type values[] = {Type_NONE, Type_SCM_State};
    return values;
}

inline const char* const* EnumNamesType() {
    static const char* const names[3] = {"NONE", "SCM_State", nullptr};
    return names;
}

inline const char* EnumNameType(Type e) {
    if (flatbuffers::IsOutRange(e, Type_NONE, Type_SCM_State))
        return "";
    const size_t index = static_cast<size_t>(e);
    return EnumNamesType()[index];
}
...
template <>
struct TypeTraits<SynFlatBuffers::Terrain::SCM::State> {
...
inline const Type (&EnumValuesType())[8] {
    static const Type values[] = {Type_NONE,      Type_Agent_State,   Type_Agent_Description, Type_SPAT_State,
                                  Type_MAP_State, Type_Terrain_State, Type_Approach_State,    Type_Simulation_State};
    return values;
}

inline const char* const* EnumNamesType() {
    static const char* const names[9] = {"NONE",           "Agent_State",      "Agent_Description",
                                         "SPAT_State",     "MAP_State",        "Terrain_State",
                                         "Approach_State", "Simulation_State", nullptr};
    return names;
}

inline const char* EnumNameType(Type e) {
    if (flatbuffers::IsOutRange(e, Type_NONE, Type_Simulation_State))
        return "";
    const size_t index = static_cast<size_t>(e);
    return EnumNamesType()[index];
}
...
template <>
struct TypeTraits<SynFlatBuffers::Agent::State> {
    static const Type enum_value = Type_Agent_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Agent::Description> {
    static const Type enum_value = Type_Agent_Description;
};

template <>
struct TypeTraits<SynFlatBuffers::SPAT::State> {
    static const Type enum_value = Type_SPAT_State;
};

template <>
struct TypeTraits<SynFlatBuffers::MAP::State> {
    static const Type enum_value = Type_MAP_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Terrain::State> {
    static const Type enum_value = Type_Terrain_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Approach::State> {
    static const Type enum_value = Type_Approach_State;
};

template <>
struct TypeTraits<SynFlatBuffers::Simulation::State> {
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) NodeLevel FLATBUFFERS_FINAL_CLASS {
  ...
  public:
    ...
    double level() const { return flatbuffers::EndianScalar(level_); }
};
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) AgentKey FLATBUFFERS_FINAL_CLASS {
  ...
  public:
    AgentKey() : node_id_(0), agent_id_(0) {}
    AgentKey(int32_t _node_id, int32_t _agent_id)
        : node_id_(flatbuffers::EndianScalar(_node_id)), agent_id_(flatbuffers::EndianScalar(_agent_id)) {}
    int32_t node_id() const { return flatbuffers::EndianScalar(node_id_); }
    int32_t agent_id() const { return flatbuffers::EndianScalar(agent_id_); }
};
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIME = 4, VT_LANES = 6 };
    double time() const { return GetField<double>(VT_TIME, 0.0); }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_LANES) && verifier.VerifyVector(lanes()) &&
               verifier.VerifyVectorOfTables(lanes()) && verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    void add_time(double time) { fbb_.AddElement<double>(State::VT_TIME, time, 0.0); }
    ...
    explicit StateBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::SPAT::CreateState(_fbb, time, lanes__);
}
...
struct Lane FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t intersection() const { return GetField<int32_t>(VT_INTERSECTION, 0); }
    int32_t approach() const { return GetField<int32_t>(VT_APPROACH, 0); }
    int32_t lane() const { return GetField<int32_t>(VT_LANE, 0); }
    SynFlatBuffers::SPAT::Color color() const {
        return static_cast<SynFlatBuffers::SPAT::Color>(GetField<int8_t>(VT_COLOR, 0));
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_INTERSECTION) &&
               VerifyField<int32_t>(verifier, VT_APPROACH) && VerifyField<int32_t>(verifier, VT_LANE) &&
               VerifyField<int8_t>(verifier, VT_COLOR) && verifier.EndTable();
    }
};
...
struct LaneBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_intersection(int32_t intersection) { fbb_.AddElement<int32_t>(Lane::VT_INTERSECTION, intersection, 0); }
    void add_approach(int32_t approach) { fbb_.AddElement<int32_t>(Lane::VT_APPROACH, approach, 0); }
    void add_lane(int32_t lane) { fbb_.AddElement<int32_t>(Lane::VT_LANE, lane, 0); }
    void add_color(SynFlatBuffers::SPAT::Color color) {
        fbb_.AddElement<int8_t>(Lane::VT_COLOR, static_cast<int8_t>(color), 0);
    }
    explicit LaneBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<Lane> CreateLane(flatbuffers::FlatBufferBuilder& _fbb,
...
struct Vector FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_X = 4, VT_Y = 6, VT_Z = 8 };
    double x() const { return GetField<double>(VT_X, 0.0); }
    double y() const { return GetField<double>(VT_Y, 0.0); }
    double z() const { return GetField<double>(VT_Z, 0.0); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_X) &&
               VerifyField<double>(verifier, VT_Y) && VerifyField<double>(verifier, VT_Z) && verifier.EndTable();
    }
};
...
struct VectorBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_x(double x) { fbb_.AddElement<double>(Vector::VT_X, x, 0.0); }
    void add_y(double y) { fbb_.AddElement<double>(Vector::VT_Y, y, 0.0); }
    void add_z(double z) { fbb_.AddElement<double>(Vector::VT_Z, z, 0.0); }
    explicit VectorBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<Vector> CreateVector(flatbuffers::FlatBufferBuilder& _fbb,
                                                double x = 0.0,
                                                double y = 0.0,
                                                double z = 0.0) {
...
struct Quaternion FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_E0 = 4, VT_E1 = 6, VT_E2 = 8, VT_E3 = 10 };
    double e0() const { return GetField<double>(VT_E0, 0.0); }
    double e1() const { return GetField<double>(VT_E1, 0.0); }
    double e2() const { return GetField<double>(VT_E2, 0.0); }
    double e3() const { return GetField<double>(VT_E3, 0.0); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_E0) &&
               VerifyField<double>(verifier, VT_E1) && VerifyField<double>(verifier, VT_E2) &&
               VerifyField<double>(verifier, VT_E3) && verifier.EndTable();
    }
};
...
struct QuaternionBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_e0(double e0) { fbb_.AddElement<double>(Quaternion::VT_E0, e0, 0.0); }
    void add_e1(double e1) { fbb_.AddElement<double>(Quaternion::VT_E1, e1, 0.0); }
    void add_e2(double e2) { fbb_.AddElement<double>(Quaternion::VT_E2, e2, 0.0); }
    void add_e3(double e3) { fbb_.AddElement<double>(Quaternion::VT_E3, e3, 0.0); }
    explicit QuaternionBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct Pose FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const SynFlatBuffers::Vector* pos() const { return GetPointer<const SynFlatBuffers::Vector*>(VT_POS); }
    const SynFlatBuffers::Quaternion* rot() const { return GetPointer<const SynFlatBuffers::Quaternion*>(VT_ROT); }
    const SynFlatBuffers::Vector* pos_dt() const { return GetPointer<const SynFlatBuffers::Vector*>(VT_POS_DT); }
    const SynFlatBuffers::Quaternion* rot_dt() const {
        return GetPointer<const SynFlatBuffers::Quaternion*>(VT_ROT_DT);
    }
    const SynFlatBuffers::Vector* pos_dtdt() const { return GetPointer<const SynFlatBuffers::Vector*>(VT_POS_DTDT); }
    const SynFlatBuffers::Quaternion* rot_dtdt() const {
        return GetPointer<const SynFlatBuffers::Quaternion*>(VT_ROT_DTDT);
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_POS) && verifier.VerifyTable(pos()) &&
               VerifyOffset(verifier, VT_ROT) && verifier.VerifyTable(rot()) && VerifyOffset(verifier, VT_POS_DT) &&
               verifier.VerifyTable(pos_dt()) && VerifyOffset(verifier, VT_ROT_DT) && verifier.VerifyTable(rot_dt()) &&
               VerifyOffset(verifier, VT_POS_DTDT) && verifier.VerifyTable(pos_dtdt()) &&
               VerifyOffset(verifier, VT_ROT_DTDT) && verifier.VerifyTable(rot_dtdt()) && verifier.EndTable();
    }
};
...
struct PoseBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_pos(flatbuffers::Offset<SynFlatBuffers::Vector> pos) { fbb_.AddOffset(Pose::VT_POS, pos); }
    void add_rot(flatbuffers::Offset<SynFlatBuffers::Quaternion> rot) { fbb_.AddOffset(Pose::VT_ROT, rot); }
    void add_pos_dt(flatbuffers::Offset<SynFlatBuffers::Vector> pos_dt) { fbb_.AddOffset(Pose::VT_POS_DT, pos_dt); }
    void add_rot_dt(flatbuffers::Offset<SynFlatBuffers::Quaternion> rot_dt) { fbb_.AddOffset(Pose::VT_ROT_DT, rot_dt); }
    ...
    explicit PoseBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<Pose> CreatePose(flatbuffers::FlatBufferBuilder& _fbb,
...
struct StateBuilder {
    ...
    void add_time(double time) { fbb_.AddElement<double>(State::VT_TIME, time, 0.0); }
    void add_lanes(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Approach::Lane>>> lanes) {
        fbb_.AddOffset(State::VT_LANES, lanes);
    }
    explicit StateBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
    flatbuffers::Offset<State> Finish() {
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::Approach::CreateState(_fbb, time, lanes__);
}

struct Lane FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef LaneBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_WIDTH = 4, VT_CONTROLPOINTS = 6 };
    double width() const { return GetField<double>(VT_WIDTH, 0.0); }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_WIDTH) &&
               VerifyOffset(verifier, VT_CONTROLPOINTS) && verifier.VerifyVector(controlPoints()) &&
               verifier.VerifyVectorOfTables(controlPoints()) && verifier.EndTable();
    }
};
...
struct LaneBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_width(double width) { fbb_.AddElement<double>(Lane::VT_WIDTH, width, 0.0); }
    void add_controlPoints(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Vector>>> controlPoints) {
...
inline flatbuffers::Offset<Lane> CreateLaneDirect(
    ...
    auto controlPoints__ =
        controlPoints ? _fbb.CreateVector<flatbuffers::Offset<SynFlatBuffers::Vector>>(*controlPoints) : 0;
    return SynFlatBuffers::Approach::CreateLane(_fbb, width, controlPoints__);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIME = 4, VT_INTERSECTIONS = 6 };
    double time() const { return GetField<double>(VT_TIME, 0.0); }
    const flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::MAP::intersection>>* intersections() const {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::MAP::intersection>>*>(
            VT_INTERSECTIONS);
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_INTERSECTIONS) && verifier.VerifyVector(intersections()) &&
               verifier.VerifyVectorOfTables(intersections()) && verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    void add_intersections(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::MAP::intersection>>>
            intersections) {
...
inline flatbuffers::Offset<State> CreateState(
    flatbuffers::FlatBufferBuilder& _fbb,
    double time = 0.0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::MAP::intersection>>> intersections =
        0) {
    StateBuilder builder_(_fbb);
    builder_.add_time(time);
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    auto intersections__ =
        intersections ? _fbb.CreateVector<flatbuffers::Offset<SynFlatBuffers::MAP::intersection>>(*intersections) : 0;
    return SynFlatBuffers::MAP::CreateState(_fbb, time, intersections__);
}

struct intersection FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef intersectionBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_APPROACHES = 4 };
    const flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Approach::State>>* approaches() const {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Approach::State>>*>(
            VT_APPROACHES);
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_APPROACHES) &&
               verifier.VerifyVector(approaches()) && verifier.VerifyVectorOfTables(approaches()) &&
               verifier.EndTable();
    }
};
...
struct intersectionBuilder {
    ...
    flatbuffers::uoffset_t start_;
    void add_approaches(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Approach::State>>> approaches) {
        fbb_.AddOffset(intersection::VT_APPROACHES, approaches);
    }
    explicit intersectionBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<intersection> CreateintersectionDirect(
    ...
    auto approaches__ =
        approaches ? _fbb.CreateVector<flatbuffers::Offset<SynFlatBuffers::Approach::State>>(*approaches) : 0;
    return SynFlatBuffers::MAP::Createintersection(_fbb, approaches__);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIME = 4, VT_CHASSIS = 6, VT_WHEELS = 8 };
    double time() const { return GetField<double>(VT_TIME, 0.0); }
    const SynFlatBuffers::Pose* chassis() const { return GetPointer<const SynFlatBuffers::Pose*>(VT_CHASSIS); }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_CHASSIS) && verifier.VerifyTable(chassis()) &&
               VerifyOffset(verifier, VT_WHEELS) && verifier.VerifyVector(wheels()) &&
               verifier.VerifyVectorOfTables(wheels()) && verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    flatbuffers::uoffset_t start_;
    void add_time(double time) { fbb_.AddElement<double>(State::VT_TIME, time, 0.0); }
    void add_chassis(flatbuffers::Offset<SynFlatBuffers::Pose> chassis) { fbb_.AddOffset(State::VT_CHASSIS, chassis); }
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::Agent::WheeledVehicle::CreateState(_fbb, time, chassis, wheels__);
}
...
struct Description FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t num_wheels() const { return GetField<int32_t>(VT_NUM_WHEELS, 0); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CHASSIS_VIS_FILE) &&
               verifier.VerifyString(chassis_vis_file()) && VerifyOffset(verifier, VT_WHEEL_VIS_FILE) &&
               verifier.VerifyString(wheel_vis_file()) && VerifyOffset(verifier, VT_TIRE_VIS_FILE) &&
               verifier.VerifyString(tire_vis_file()) && VerifyField<int32_t>(verifier, VT_NUM_WHEELS) &&
               verifier.EndTable();
    }
};
...
struct DescriptionBuilder {
    ...
    void add_num_wheels(int32_t num_wheels) { fbb_.AddElement<int32_t>(Description::VT_NUM_WHEELS, num_wheels, 0); }
    explicit DescriptionBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<Description> CreateDescription(flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<Description> CreateDescriptionDirect(flatbuffers::FlatBufferBuilder& _fbb,
    ...
    return SynFlatBuffers::Agent::WheeledVehicle::CreateDescription(_fbb, chassis_vis_file__, wheel_vis_file__,
                                                                    tire_vis_file__, num_wheels);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_CHASSIS) && verifier.VerifyTable(chassis()) &&
               VerifyOffset(verifier, VT_TRACK_SHOES) && verifier.VerifyVector(track_shoes()) &&
               verifier.VerifyVectorOfTables(track_shoes()) && VerifyOffset(verifier, VT_SPROCKETS) &&
               verifier.VerifyVector(sprockets()) && verifier.VerifyVectorOfTables(sprockets()) &&
               VerifyOffset(verifier, VT_IDLERS) && verifier.VerifyVector(idlers()) &&
               verifier.VerifyVectorOfTables(idlers()) && VerifyOffset(verifier, VT_ROAD_WHEELS) &&
               verifier.VerifyVector(road_wheels()) && verifier.VerifyVectorOfTables(road_wheels()) &&
               verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    void add_time(double time) { fbb_.AddElement<double>(State::VT_TIME, time, 0.0); }
    void add_chassis(flatbuffers::Offset<SynFlatBuffers::Pose> chassis) { fbb_.AddOffset(State::VT_CHASSIS, chassis); }
    void add_track_shoes(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Pose>>> track_shoes) {
    ...
    void add_road_wheels(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Pose>>> road_wheels) {
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::Agent::TrackedVehicle::CreateState(_fbb, time, chassis, track_shoes__, sprockets__, idlers__,
                                                              road_wheels__);
}
...
struct Description FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t num_track_shoes() const { return GetField<int32_t>(VT_NUM_TRACK_SHOES, 0); }
    int32_t num_sprockets() const { return GetField<int32_t>(VT_NUM_SPROCKETS, 0); }
    int32_t num_idlers() const { return GetField<int32_t>(VT_NUM_IDLERS, 0); }
    int32_t num_road_wheels() const { return GetField<int32_t>(VT_NUM_ROAD_WHEELS, 0); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CHASSIS_VIS_FILE) &&
               verifier.VerifyString(chassis_vis_file()) && VerifyOffset(verifier, VT_TRACK_SHOE_VIS_FILE) &&
               verifier.VerifyString(track_shoe_vis_file()) && VerifyOffset(verifier, VT_LEFT_SPROCKET_VIS_FILE) &&
               verifier.VerifyString(left_sprocket_vis_file()) && VerifyOffset(verifier, VT_RIGHT_SPROCKET_VIS_FILE) &&
               verifier.VerifyString(right_sprocket_vis_file()) && VerifyOffset(verifier, VT_LEFT_IDLER_VIS_FILE) &&
               verifier.VerifyString(left_idler_vis_file()) && VerifyOffset(verifier, VT_RIGHT_IDLER_VIS_FILE) &&
               verifier.VerifyString(right_idler_vis_file()) && VerifyOffset(verifier, VT_LEFT_ROAD_WHEEL_VIS_FILE) &&
               ...
               VerifyField<int32_t>(verifier, VT_NUM_TRACK_SHOES) && VerifyField<int32_t>(verifier, VT_NUM_SPROCKETS) &&
               VerifyField<int32_t>(verifier, VT_NUM_IDLERS) && VerifyField<int32_t>(verifier, VT_NUM_ROAD_WHEELS) &&
               verifier.EndTable();
    }
};
...
struct DescriptionBuilder {
    ...
    void add_num_idlers(int32_t num_idlers) { fbb_.AddElement<int32_t>(Description::VT_NUM_IDLERS, num_idlers, 0); }
...
inline flatbuffers::Offset<Description> CreateDescriptionDirect(flatbuffers::FlatBufferBuilder& _fbb,
    ...
    return SynFlatBuffers::Agent::TrackedVehicle::CreateDescription(
        _fbb, chassis_vis_file__, track_shoe_vis_file__, left_sprocket_vis_file__, right_sprocket_vis_file__,
        left_idler_vis_file__, right_idler_vis_file__, left_road_wheel_vis_file__, right_road_wheel_vis_file__,
        num_track_shoes, num_sprockets, num_idlers, num_road_wheels);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIME = 4, VT_CHASSIS = 6, VT_PROPELLERS = 8 };
    double time() const { return GetField<double>(VT_TIME, 0.0); }
    const SynFlatBuffers::Pose* chassis() const { return GetPointer<const SynFlatBuffers::Pose*>(VT_CHASSIS); }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_CHASSIS) && verifier.VerifyTable(chassis()) &&
               VerifyOffset(verifier, VT_PROPELLERS) && verifier.VerifyVector(propellers()) &&
               verifier.VerifyVectorOfTables(propellers()) && verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    void add_chassis(flatbuffers::Offset<SynFlatBuffers::Pose> chassis) { fbb_.AddOffset(State::VT_CHASSIS, chassis); }
    void add_propellers(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SynFlatBuffers::Pose>>> propellers) {
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::Agent::Copter::CreateState(_fbb, time, chassis, propellers__);
}
...
struct Description FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t num_props() const { return GetField<int32_t>(VT_NUM_PROPS, 0); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CHASSIS_VIS_FILE) &&
               verifier.VerifyString(chassis_vis_file()) && VerifyOffset(verifier, VT_PROPELLER_VIS_FILE) &&
               verifier.VerifyString(propeller_vis_file()) && VerifyField<int32_t>(verifier, VT_NUM_PROPS) &&
               verifier.EndTable();
    }
};
...
struct DescriptionBuilder {
    ...
    void add_num_props(int32_t num_props) { fbb_.AddElement<int32_t>(Description::VT_NUM_PROPS, num_props, 0); }
    explicit DescriptionBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
    flatbuffers::Offset<Description> Finish() {
        const auto end = fbb_.EndTable(start_);
        auto o = flatbuffers::Offset<Description>(end);
...
inline flatbuffers::Offset<Description> CreateDescriptionDirect(flatbuffers::FlatBufferBuilder& _fbb,
    ...
    return SynFlatBuffers::Agent::Copter::CreateDescription(_fbb, chassis_vis_file__, propeller_vis_file__, num_props);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_MAP = 4, VT_SPAT = 6 };
    const SynFlatBuffers::Message* map() const { return GetPointer<const SynFlatBuffers::Message*>(VT_MAP); }
    const SynFlatBuffers::Message* spat() const { return GetPointer<const SynFlatBuffers::Message*>(VT_SPAT); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_MAP) && verifier.VerifyTable(map()) &&
               VerifyOffset(verifier, VT_SPAT) && verifier.VerifyTable(spat()) && verifier.EndTable();
    }
};
...
struct StateBuilder {
    ...
    flatbuffers::FlatBufferBuilder& fbb_;
    flatbuffers::uoffset_t start_;
    void add_map(flatbuffers::Offset<SynFlatBuffers::Message> map) { fbb_.AddOffset(State::VT_MAP, map); }
    void add_spat(flatbuffers::Offset<SynFlatBuffers::Message> spat) { fbb_.AddOffset(State::VT_SPAT, spat); }
    explicit StateBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
    flatbuffers::Offset<State> Finish() {
        const auto end = fbb_.EndTable(start_);
        auto o = flatbuffers::Offset<State>(end);
...
inline flatbuffers::Offset<State> CreateState(flatbuffers::FlatBufferBuilder& _fbb,
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_MESSAGE_TYPE = 4, VT_MESSAGE = 6 };
    ...
    const SynFlatBuffers::Agent::WheeledVehicle::State* message_as_WheeledVehicle_State() const {
        return message_type() == SynFlatBuffers::Agent::Type_WheeledVehicle_State
                   ? static_cast<const SynFlatBuffers::Agent::WheeledVehicle::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::WheeledVehicle::Description* message_as_WheeledVehicle_Description() const {
        return message_type() == SynFlatBuffers::Agent::Type_WheeledVehicle_Description
                   ? static_cast<const SynFlatBuffers::Agent::WheeledVehicle::Description*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::TrackedVehicle::State* message_as_TrackedVehicle_State() const {
        return message_type() == SynFlatBuffers::Agent::Type_TrackedVehicle_State
                   ? static_cast<const SynFlatBuffers::Agent::TrackedVehicle::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::TrackedVehicle::Description* message_as_TrackedVehicle_Description() const {
        return message_type() == SynFlatBuffers::Agent::Type_TrackedVehicle_Description
                   ? static_cast<const SynFlatBuffers::Agent::TrackedVehicle::Description*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Environment::State* message_as_Environment_State() const {
        return message_type() == SynFlatBuffers::Agent::Type_Environment_State
                   ? static_cast<const SynFlatBuffers::Agent::Environment::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Environment::Description* message_as_Environment_Description() const {
        return message_type() == SynFlatBuffers::Agent::Type_Environment_Description
                   ? static_cast<const SynFlatBuffers::Agent::Environment::Description*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Copter::State* message_as_Copter_State() const {
        return message_type() == SynFlatBuffers::Agent::Type_Copter_State
                   ? static_cast<const SynFlatBuffers::Agent::Copter::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Copter::Description* message_as_Copter_Description() const {
        return message_type() == SynFlatBuffers::Agent::Type_Copter_Description
                   ? static_cast<const SynFlatBuffers::Agent::Copter::Description*>(message())
                   : nullptr;
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_MESSAGE_TYPE) &&
               VerifyOffset(verifier, VT_MESSAGE) && VerifyType(verifier, message(), message_type()) &&
               verifier.EndTable();
    }
};

template <>
inline const SynFlatBuffers::Agent::WheeledVehicle::State*
State::message_as<SynFlatBuffers::Agent::WheeledVehicle::State>() const {
    return message_as_WheeledVehicle_State();
}

template <>
inline const SynFlatBuffers::Agent::WheeledVehicle::Description*
State::message_as<SynFlatBuffers::Agent::WheeledVehicle::Description>() const {
    return message_as_WheeledVehicle_Description();
}

template <>
inline const SynFlatBuffers::Agent::TrackedVehicle::State*
State::message_as<SynFlatBuffers::Agent::TrackedVehicle::State>() const {
    return message_as_TrackedVehicle_State();
}

template <>
inline const SynFlatBuffers::Agent::TrackedVehicle::Description*
State::message_as<SynFlatBuffers::Agent::TrackedVehicle::Description>() const {
    return message_as_TrackedVehicle_Description();
}

template <>
inline const SynFlatBuffers::Agent::Environment::State* State::message_as<SynFlatBuffers::Agent::Environment::State>()
    const {
    return message_as_Environment_State();
}

template <>
inline const SynFlatBuffers::Agent::Environment::Description*
State::message_as<SynFlatBuffers::Agent::Environment::Description>() const {
    return message_as_Environment_Description();
}

template <>
inline const SynFlatBuffers::Agent::Copter::State* State::message_as<SynFlatBuffers::Agent::Copter::State>() const {
    return message_as_Copter_State();
}

template <>
inline const SynFlatBuffers::Agent::Copter::Description* State::message_as<SynFlatBuffers::Agent::Copter::Description>()
    const {
...
struct StateBuilder {
    ...
    void add_message(flatbuffers::Offset<void> message) { fbb_.AddOffset(State::VT_MESSAGE, message); }
    explicit StateBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
    flatbuffers::Offset<State> Finish() {
        const auto end = fbb_.EndTable(start_);
        auto o = flatbuffers::Offset<State>(end);
...
struct Description FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const void* description() const { return GetPointer<const void*>(VT_DESCRIPTION); }
    template <typename T>
    const T* description_as() const;
    const SynFlatBuffers::Agent::WheeledVehicle::State* description_as_WheeledVehicle_State() const {
        return description_type() == SynFlatBuffers::Agent::Type_WheeledVehicle_State
                   ? static_cast<const SynFlatBuffers::Agent::WheeledVehicle::State*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::WheeledVehicle::Description* description_as_WheeledVehicle_Description() const {
        return description_type() == SynFlatBuffers::Agent::Type_WheeledVehicle_Description
                   ? static_cast<const SynFlatBuffers::Agent::WheeledVehicle::Description*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::TrackedVehicle::State* description_as_TrackedVehicle_State() const {
        return description_type() == SynFlatBuffers::Agent::Type_TrackedVehicle_State
                   ? static_cast<const SynFlatBuffers::Agent::TrackedVehicle::State*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::TrackedVehicle::Description* description_as_TrackedVehicle_Description() const {
        return description_type() == SynFlatBuffers::Agent::Type_TrackedVehicle_Description
                   ? static_cast<const SynFlatBuffers::Agent::TrackedVehicle::Description*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Environment::State* description_as_Environment_State() const {
        return description_type() == SynFlatBuffers::Agent::Type_Environment_State
                   ? static_cast<const SynFlatBuffers::Agent::Environment::State*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Environment::Description* description_as_Environment_Description() const {
        return description_type() == SynFlatBuffers::Agent::Type_Environment_Description
                   ? static_cast<const SynFlatBuffers::Agent::Environment::Description*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Copter::State* description_as_Copter_State() const {
        return description_type() == SynFlatBuffers::Agent::Type_Copter_State
                   ? static_cast<const SynFlatBuffers::Agent::Copter::State*>(description())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Copter::Description* description_as_Copter_Description() const {
        return description_type() == SynFlatBuffers::Agent::Type_Copter_Description
                   ? static_cast<const SynFlatBuffers::Agent::Copter::Description*>(description())
                   : nullptr;
    }
    const flatbuffers::String* json() const { return GetPointer<const flatbuffers::String*>(VT_JSON); }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_DESCRIPTION_TYPE) &&
               VerifyOffset(verifier, VT_DESCRIPTION) && VerifyType(verifier, description(), description_type()) &&
               VerifyOffset(verifier, VT_JSON) && verifier.VerifyString(json()) && verifier.EndTable();
    }
};

template <>
inline const SynFlatBuffers::Agent::WheeledVehicle::State*
Description::description_as<SynFlatBuffers::Agent::WheeledVehicle::State>() const {
    return description_as_WheeledVehicle_State();
}

template <>
inline const SynFlatBuffers::Agent::WheeledVehicle::Description*
Description::description_as<SynFlatBuffers::Agent::WheeledVehicle::Description>() const {
    return description_as_WheeledVehicle_Description();
}

template <>
inline const SynFlatBuffers::Agent::TrackedVehicle::State*
Description::description_as<SynFlatBuffers::Agent::TrackedVehicle::State>() const {
    return description_as_TrackedVehicle_State();
}

template <>
inline const SynFlatBuffers::Agent::TrackedVehicle::Description*
Description::description_as<SynFlatBuffers::Agent::TrackedVehicle::Description>() const {
    return description_as_TrackedVehicle_Description();
}

template <>
inline const SynFlatBuffers::Agent::Environment::State*
Description::description_as<SynFlatBuffers::Agent::Environment::State>() const {
    return description_as_Environment_State();
}

template <>
inline const SynFlatBuffers::Agent::Environment::Description*
Description::description_as<SynFlatBuffers::Agent::Environment::Description>() const {
    return description_as_Environment_Description();
}

template <>
inline const SynFlatBuffers::Agent::Copter::State* Description::description_as<SynFlatBuffers::Agent::Copter::State>()
    const {
    return description_as_Copter_State();
}

template <>
inline const SynFlatBuffers::Agent::Copter::Description*
Description::description_as<SynFlatBuffers::Agent::Copter::Description>() const {
...
struct DescriptionBuilder {
    ...
    void add_json(flatbuffers::Offset<flatbuffers::String> json) { fbb_.AddOffset(Description::VT_JSON, json); }
    explicit DescriptionBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
    flatbuffers::Offset<Description> Finish() {
        const auto end = fbb_.EndTable(start_);
        auto o = flatbuffers::Offset<Description>(end);
...
inline flatbuffers::Offset<Description> CreateDescriptionDirect(
    ...
    return SynFlatBuffers::Agent::CreateDescription(_fbb, description_type, description, json__);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIME = 4, VT_NODES = 6 };
    double time() const { return GetField<double>(VT_TIME, 0.0); }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_TIME) &&
               VerifyOffset(verifier, VT_NODES) && verifier.VerifyVector(nodes()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<State> CreateStateDirect(
    ...
    return SynFlatBuffers::Terrain::SCM::CreateState(_fbb, time, nodes__);
}
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const SynFlatBuffers::Terrain::SCM::State* message_as_SCM_State() const {
        return message_type() == SynFlatBuffers::Terrain::Type_SCM_State
                   ? static_cast<const SynFlatBuffers::Terrain::SCM::State*>(message())
                   : nullptr;
    }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_MESSAGE_TYPE) &&
...
template <>
inline const SynFlatBuffers::Terrain::SCM::State* State::message_as<SynFlatBuffers::Terrain::SCM::State>() const {
...
struct State FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    typedef StateBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_QUIT_SIM = 4 };
    bool quit_sim() const { return GetField<uint8_t>(VT_QUIT_SIM, 0) != 0; }
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_QUIT_SIM) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<State> CreateState(flatbuffers::FlatBufferBuilder& _fbb, bool quit_sim = false) {
    StateBuilder builder_(_fbb);
...
struct Buffer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_BUFFER) && verifier.VerifyVector(buffer()) &&
               verifier.VerifyVectorOfTables(buffer()) && verifier.EndTable();
    }
};
...
struct BufferBuilder {
    ...
    explicit BufferBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<Buffer> CreateBufferDirect(
    ...
    return SynFlatBuffers::CreateBuffer(_fbb, buffer__);
}
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const SynFlatBuffers::Agent::State* message_as_Agent_State() const {
        return message_type() == SynFlatBuffers::Type_Agent_State
                   ? static_cast<const SynFlatBuffers::Agent::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Agent::Description* message_as_Agent_Description() const {
        return message_type() == SynFlatBuffers::Type_Agent_Description
                   ? static_cast<const SynFlatBuffers::Agent::Description*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::SPAT::State* message_as_SPAT_State() const {
        return message_type() == SynFlatBuffers::Type_SPAT_State
                   ? static_cast<const SynFlatBuffers::SPAT::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::MAP::State* message_as_MAP_State() const {
        return message_type() == SynFlatBuffers::Type_MAP_State
                   ? static_cast<const SynFlatBuffers::MAP::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Terrain::State* message_as_Terrain_State() const {
        return message_type() == SynFlatBuffers::Type_Terrain_State
                   ? static_cast<const SynFlatBuffers::Terrain::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Approach::State* message_as_Approach_State() const {
        return message_type() == SynFlatBuffers::Type_Approach_State
                   ? static_cast<const SynFlatBuffers::Approach::State*>(message())
                   : nullptr;
    }
    const SynFlatBuffers::Simulation::State* message_as_Simulation_State() const {
        return message_type() == SynFlatBuffers::Type_Simulation_State
                   ? static_cast<const SynFlatBuffers::Simulation::State*>(message())
                   : nullptr;
    }
    ...
    bool Verify(flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_MESSAGE_TYPE) &&
               ...
               VerifyField<SynFlatBuffers::AgentKey>(verifier, VT_DESTINATION_KEY) && verifier.EndTable();
    }
};

template <>
inline const SynFlatBuffers::Agent::State* Message::message_as<SynFlatBuffers::Agent::State>() const {
    return message_as_Agent_State();
}

template <>
inline const SynFlatBuffers::Agent::Description* Message::message_as<SynFlatBuffers::Agent::Description>() const {
    return message_as_Agent_Description();
}

template <>
inline const SynFlatBuffers::SPAT::State* Message::message_as<SynFlatBuffers::SPAT::State>() const {
    return message_as_SPAT_State();
}

template <>
inline const SynFlatBuffers::MAP::State* Message::message_as<SynFlatBuffers::MAP::State>() const {
    return message_as_MAP_State();
}

template <>
inline const SynFlatBuffers::Terrain::State* Message::message_as<SynFlatBuffers::Terrain::State>() const {
    return message_as_Terrain_State();
}

template <>
inline const SynFlatBuffers::Approach::State* Message::message_as<SynFlatBuffers::Approach::State>() const {
    return message_as_Approach_State();
}

template <>
inline const SynFlatBuffers::Simulation::State* Message::message_as<SynFlatBuffers::Simulation::State>() const {
...
struct MessageBuilder {
    ...
    explicit MessageBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
namespace SPAT {}  // namespace SPAT

namespace Approach {}  // namespace Approach

namespace MAP {}  // namespace MAP

namespace Agent {
namespace WheeledVehicle {}  // namespace WheeledVehicle

namespace TrackedVehicle {}  // namespace TrackedVehicle

namespace Copter {}  // namespace Copter
...
inline bool VerifyBufferBuffer(flatbuffers::Verifier& verifier) {
    return verifier.VerifyBuffer<SynFlatBuffers::Buffer>(nullptr);
}

inline bool VerifySizePrefixedBufferBuffer(flatbuffers::Verifier& verifier) {
    return verifier.VerifySizePrefixedBuffer<SynFlatBuffers::Buffer>(nullptr);
}

inline void FinishBufferBuffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<SynFlatBuffers::Buffer> root) {
    fbb.Finish(root);
}

inline void FinishSizePrefixedBufferBuffer(flatbuffers::FlatBufferBuilder& fbb,
