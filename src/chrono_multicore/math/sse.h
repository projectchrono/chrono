...
#if defined(CHRONO_HAS_AVX) && defined(CHRONO_MULTICORE_USE_SIMD) && defined(CHRONO_MULTICORE_USE_DOUBLE)
#define USE_AVX
#undef USE_SSE
#elif defined(CHRONO_HAS_SSE) && defined(CHRONO_MULTICORE_USE_SIMD) && !defined(CHRONO_MULTICORE_USE_DOUBLE)
#undef USE_AVX
#define USE_SSE
#else
#undef USE_AVX
