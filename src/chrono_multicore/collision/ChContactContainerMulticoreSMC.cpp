...
ChContactContainerMulticoreSMC_mc::ChContactContainerMulticoreSMC_mc(ChMulticoreDataManager* dc)
    : ChContactContainerMulticore_mc(dc) {}

ChContactContainerMulticoreSMC_mc::ChContactContainerMulticoreSMC_mc(const ChContactContainerMulticoreSMC_mc& other)
    : ChContactContainerMulticore_mc(other) {
    //// TODO
}

void ChContactContainerMulticoreSMC_mc::BeginAddContact() {
...
void ChContactContainerMulticoreSMC_mc::EndAddContact() {
    ChContactContainerMulticore_mc::EndAddContact();
    //// Anything else here?!?
}

void ChContactContainerMulticoreSMC_mc::AddContact(const collision::ChCollisionInfo& cinfo,
                                               std::shared_ptr<ChMaterialSurface> mat1,
                                               std::shared_ptr<ChMaterialSurface> mat2) {
    assert(cinfo.modelA->GetContactable());
    assert(cinfo.modelB->GetContactable());
...
void ChContactContainerMulticoreSMC_mc::AddContact(int index, int b1, int s1, int b2, int s2) {
    auto& blist = *data_manager->body_list;  // list of bodies in system
