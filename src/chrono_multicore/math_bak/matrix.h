...
CUDA_HOST_DEVICE CH_MULTICORE_API OPERATOR_EQUALSALT_PROTO(*, real, Mat33) CUDA_HOST_DEVICE CH_MULTICORE_API
    OPERATOR_EQUALSALT_PROTO(*, Mat33, Mat33) CUDA_HOST_DEVICE CH_MULTICORE_API
    OPERATOR_EQUALSALT_PROTO(+, Mat33, Mat33) CUDA_HOST_DEVICE CH_MULTICORE_API OPERATOR_EQUALSALT_PROTO(-, Mat33, Mat33)
...
CUDA_HOST_DEVICE CH_MULTICORE_API Mat33 MultTranspose(const Mat33& M, const Mat33& N);  // M * N^T
CUDA_HOST_DEVICE CH_MULTICORE_API Mat33 TransposeMult(const Mat33& M, const Mat33& N);  // M^T * N
CUDA_HOST_DEVICE CH_MULTICORE_API real Trace(const Mat33& m);
CUDA_HOST_DEVICE CH_MULTICORE_API Mat33 OuterProduct(const real3& a,
...
CUDA_HOST_DEVICE CH_MULTICORE_API real Norm(const Mat33& A);    // normalized double dot product of a matrix
CUDA_HOST_DEVICE CH_MULTICORE_API real NormSq(const Mat33& A);  // normalized double dot product of a matrix
...
//// ========================================================================================
//
struct CH_MULTICORE_API DiagMat33 {
...
struct CH_MULTICORE_API SymMat33 {
...
struct CH_MULTICORE_API SymMat22 {
