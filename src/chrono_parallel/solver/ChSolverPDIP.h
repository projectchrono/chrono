...
class CH_PARALLEL_API ChSolverPDIP : public ChSolverParallel {
  public:
    ...
    void Solve() {
        ...
        SubMatrixType D_t_T = blaze::submatrix(D_T, num_contacts, 0, 2 * num_contacts, num_dof);
        ...
        SubMatrixType D_t = blaze::submatrix(D, 0, num_contacts, num_dof, 2 * num_contacts);
        SubMatrixType D_b = blaze::submatrix(D, 0, num_unilaterals, num_dof, num_bilaterals);
        ...
        SubMatrixType M_invD_t = blaze::submatrix(M_invD, 0, num_contacts, num_dof, 2 * num_contacts);
        SubMatrixType M_invD_b = blaze::submatrix(M_invD, 0, num_unilaterals, num_dof, num_bilaterals);
