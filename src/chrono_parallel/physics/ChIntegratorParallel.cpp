...
void ChIntegratorParallel::IntegrateSemiImplicit(real step, device_container& gpu_data_) {
    ...
    host_Integrate_Timestep_Semi_Implicit(gpu_data->device_active_data.data(), gpu_data->device_acc_data.data(),
                                          gpu_data->device_rot_data.data(), gpu_data->device_vel_data.data(),
                                          gpu_data->device_omg_data.data(), gpu_data->device_pos_data.data(),
