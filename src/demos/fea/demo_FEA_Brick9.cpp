...
int main(int argc, char* argv[]) {
    ...
    mystepper->SetAbsTolerances(1e-6, 1e-2);
    ...
    while (application.GetDevice()->run()) {
        ...
        application.DrawAll();
        application.DoStep();
        force = 300 * std::sin(timecount * timestep * CH_C_PI) / 4;
        nodetip1->SetForce(ChVector<>(force, 0.0, 0.0));
        nodetip2->SetForce(ChVector<>(force, 0.0, 0.0));
        nodetip3->SetForce(ChVector<>(force, 0.0, 0.0));
        nodetip4->SetForce(ChVector<>(force, 0.0, 0.0));
        ...
        if (!application.GetPaused()) {
            ...
            fprintf(outputfile, "%15.7e  ", nodetip1->GetPos().z);
            fprintf(outputfile, "\n  ");
            GetLog() << my_system.GetChTime() << " " << nodetip1->GetPos().x << " " << nodetip1->GetPos().y << " "
                     << nodetip1->GetPos().z << "\n";
        }
    }
...
//	for (int i = 0; i < TotalNumElements; i++)
//	{
//		auto node = std::make_shared<ChNodeFEAcurv>(ChVector<>(0.0, 0.0, 0.0), ChVector<>(0.0, 0.0, 0.0), ChVector<>(0.0,
//0.0, 0.0));
//		node->SetMass(0);
//		my_mesh->AddNode(node);
//	}
...
//		GetLog() << "t = " << my_system.GetChTime() << "\nX: " << nodetip->GetPos().x << " Y: " << nodetip->GetPos().y <<
//" Z: " << nodetip->GetPos().z << "\n";
//		fprintf(outputfile, "%15.7e  ", my_system.GetChTime());
//		fprintf(outputfile, "%15.7e  ", nodetip->GetPos().x);
//		fprintf(outputfile, "%15.7e  ", nodetip->GetPos().y);
...
//		//==Start analysis==//
//		my_system.DoStepDynamics(timestep);
//		GetLog() << "t = " << my_system.GetChTime() << "\nX: " << nodetip1->GetPos().x << " Y: " << nodetip1->GetPos().y
//<< " Z: " << nodetip1->GetPos().z << "\n";
//		GetLog() << "t = " << my_system.GetChTime() << "\nX: " << nodetip2->GetPos().x << " Y: " << nodetip2->GetPos().y
//<< " Z: " << nodetip2->GetPos().z << "\n";
//		GetLog() << "t = " << my_system.GetChTime() << "\nX: " << nodetip3->GetPos().x << " Y: " << nodetip3->GetPos().y
//<< " Z: " << nodetip3->GetPos().z << "\n";
//		GetLog() << "t = " << my_system.GetChTime() << "\nX: " << nodetip4->GetPos().x << " Y: " << nodetip4->GetPos().y
//<< " Z: " << nodetip4->GetPos().z << "\n";
//		fprintf(outputfile, "%15.7e  ", my_system.GetChTime());
//		fprintf(outputfile, "%15.7e  ", nodetip1->GetPos().x);
//		//fprintf(outputfile, "%15.7e  ", nodetip1->GetPos().y);
