...
//       uses the Chrono PardisoProject module
//
// =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    ChIrrApp application(&my_system, L"Cables FEM (PardisoProject)", core::dimension2d<u32>(800, 600), false, true);
    ...
    pardisoproject_solver->UseSparsityPatternLearner(false);
    pardisoproject_solver->LockSparsityPattern(false);
    my_system.SetSolver(pardisoproject_solver);
