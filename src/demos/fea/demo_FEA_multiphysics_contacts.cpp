...
int main(int argc, char* argv[]) {
    ...
    contact_surface->AddFacesFromBoundary(elastic_model, sphere_swept_thickness);

    auto mesh = chrono_types::make_shared<ChMesh>();
    sys.Add(mesh);
    mesh->AddContactSurface(contact_surface); // workaround, the AddContactSurface mthd should be available in ChFEModel future 
