...
void test_2() {
    ...
    // two 3D nodes:
    auto melementA = chrono::make_shared<ChElementBar>();
    melementA->SetNodes(mnodeA, mnodeB);
...
void test_4() {
    ...
    auto mnodeA = chrono::make_shared<ChNodeFEAxyz>(ChVector<>(0, 0, 0));
    auto mnodeB = chrono::make_shared<ChNodeFEAxyz>(ChVector<>(0, 1, 0));
    auto mnodeC = chrono::make_shared<ChNodeFEAxyz>(ChVector<>(0, 2, 0));
    ...
    auto melementB = chrono::make_shared<ChElementBar>();
