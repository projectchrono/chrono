...
const double SemiTrailer_wheel::m_mass = 30.0;
const chrono::ChVector<> SemiTrailer_wheel::m_inertia(.6, .63, .6);

const double SemiTrailer_wheel::m_radius = 0.28575;
const double SemiTrailer_wheel::m_width = 0.29845;

const std::string SemiTrailer_wheel::m_meshFile = "longhaul/meshes/SemiTrailer_rim.obj";

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
SemiTrailer_wheel::SemiTrailer_wheel(const std::string& name) : ChWheel(name) {}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void SemiTrailer_wheel::AddVisualizationAssets(chrono::vehicle::VisualizationType vis) {
...
void SemiTrailer_wheel::RemoveVisualizationAssets() {
