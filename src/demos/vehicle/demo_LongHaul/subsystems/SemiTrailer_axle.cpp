...
const double SemiTrailer_axle::m_axleTubeMass = 500.0;
const double SemiTrailer_axle::m_spindleMass = 14.705;

const double SemiTrailer_axle::m_axleTubeRadius = 0.08;
const double SemiTrailer_axle::m_spindleRadius = 0.10;
const double SemiTrailer_axle::m_spindleWidth = 0.06;

const ChVector<> SemiTrailer_axle::m_axleTubeInertia(178.4760417, 1.6, 178.4760417);
const ChVector<> SemiTrailer_axle::m_spindleInertia(0.04117, 0.07352, 0.04117);

const double SemiTrailer_axle::m_springDesignLength = 0.2;
const double SemiTrailer_axle::m_springCoefficient = 710611.5169;
const double SemiTrailer_axle::m_springRestLength = m_springDesignLength + 0.062122551;
const double SemiTrailer_axle::m_springMinLength = m_springDesignLength - 0.08;
const double SemiTrailer_axle::m_springMaxLength = m_springDesignLength + 0.08;
const double SemiTrailer_axle::m_damperCoefficient = 113097.3355;
const double SemiTrailer_axle::m_damperDegressivityCompression = 3.0;
const double SemiTrailer_axle::m_damperDegressivityExpansion = 1.0;
const double SemiTrailer_axle::m_axleShaftInertia = 0.4;

// ---------------------------------------------------------------------------------------
// SemiTractor spring functor class - implements a linear spring + bump stop + rebound stop
// ---------------------------------------------------------------------------------------
class SemiTrailer_SpringForceRear : public ChLinkTSDA::ForceFunctor {
  public:
    SemiTrailer_SpringForceRear(double spring_constant, double min_length, double max_length);
...
SemiTrailer_SpringForceRear::SemiTrailer_SpringForceRear(double spring_constant, double min_length, double max_length)
...
double SemiTrailer_SpringForceRear::operator()(double time,
                                               double rest_length,
                                               double length,
                                               double vel,
                                               ChLinkTSDA* link) {
...
// -----------------------------------------------------------------------------
class SemiTrailer_ShockForceRear : public ChLinkTSDA::ForceFunctor {
  public:
    SemiTrailer_ShockForceRear(double compression_slope,
...
SemiTrailer_ShockForceRear::SemiTrailer_ShockForceRear(double compression_slope,
                                                       double compression_degressivity,
                                                       double expansion_slope,
                                                       double expansion_degressivity)
...
double SemiTrailer_ShockForceRear::operator()(double time,
                                              double rest_length,
                                              double length,
                                              double vel,
                                              ChLinkTSDA* link) {
...
SemiTrailer_axle::SemiTrailer_axle(const std::string& name) : ChLeafspringAxle(name) {
    /*
    ...
    */
    m_springForceCB = new SemiTrailer_SpringForceRear(m_springCoefficient, m_springMinLength, m_springMaxLength);

    m_shockForceCB = new SemiTrailer_ShockForceRear(m_damperCoefficient, m_damperDegressivityCompression,
...
// Destructors
// -----------------------------------------------------------------------------
SemiTrailer_axle::~SemiTrailer_axle() {
    delete m_springForceCB;
    delete m_shockForceCB;
}

const ChVector<> SemiTrailer_axle::getLocation(PointId which) {
    switch (which) {
        case SPRING_A:
