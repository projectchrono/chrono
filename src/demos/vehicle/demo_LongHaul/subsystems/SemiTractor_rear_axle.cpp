...
const double SemiTractor_rear_axle::m_axleTubeMass = 717.0;
const double SemiTractor_rear_axle::m_spindleMass = 14.705;

const double SemiTractor_rear_axle::m_axleTubeRadius = 0.06;
const double SemiTractor_rear_axle::m_spindleRadius = 0.10;
const double SemiTractor_rear_axle::m_spindleWidth = 0.06;

const ChVector<> SemiTractor_rear_axle::m_axleTubeInertia(240.8417938, 1.2906, 240.8417938);
const ChVector<> SemiTractor_rear_axle::m_spindleInertia(0.04117, 0.07352, 0.04117);

const double SemiTractor_rear_axle::m_springDesignLength = 0.2;
const double SemiTractor_rear_axle::m_springCoefficient = 1026438.858;
const double SemiTractor_rear_axle::m_springRestLength = m_springDesignLength + 0.062122551;
const double SemiTractor_rear_axle::m_springMinLength = m_springDesignLength - 0.08;
const double SemiTractor_rear_axle::m_springMaxLength = m_springDesignLength + 0.08;
const double SemiTractor_rear_axle::m_damperCoefficient = 163362.818;
const double SemiTractor_rear_axle::m_damperDegressivityCompression = 3.0;
const double SemiTractor_rear_axle::m_damperDegressivityExpansion = 1.0;
const double SemiTractor_rear_axle::m_axleShaftInertia = 0.4;

const double SemiTractor_rear_axle::m_twin_tire_dist = 12.0 * in2m * 1.1;

// ---------------------------------------------------------------------------------------
// SemiTractor spring functor class - implements a linear spring + bump stop + rebound stop
// ---------------------------------------------------------------------------------------
class SemiTractor_SpringForceRear : public ChLinkTSDA::ForceFunctor {
  public:
    SemiTractor_SpringForceRear(double spring_constant, double min_length, double max_length);
...
SemiTractor_SpringForceRear::SemiTractor_SpringForceRear(double spring_constant, double min_length, double max_length)
...
double SemiTractor_SpringForceRear::operator()(double time,
                                               double rest_length,
                                               double length,
                                               double vel,
                                               ChLinkTSDA* link) {
...
// -----------------------------------------------------------------------------
class SemiTractor_ShockForceRear : public ChLinkTSDA::ForceFunctor {
  public:
    SemiTractor_ShockForceRear(double compression_slope,
...
SemiTractor_ShockForceRear::SemiTractor_ShockForceRear(double compression_slope,
                                                       double compression_degressivity,
                                                       double expansion_slope,
                                                       double expansion_degressivity)
...
double SemiTractor_ShockForceRear::operator()(double time,
                                              double rest_length,
                                              double length,
                                              double vel,
                                              ChLinkTSDA* link) {
