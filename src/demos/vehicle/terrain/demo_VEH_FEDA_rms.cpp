...
int main(int argc, char* argv[]) {
    ...
    double xofs = -100.0;
    init_csys.pos += 0.5 * ChWorldFrame::Vertical()+ChVector<>(xofs,0,0);
    ...
    chrono::utils::ChRunningAverage velAvg(1000);
    double vel = 0;
    // -------------------------------
