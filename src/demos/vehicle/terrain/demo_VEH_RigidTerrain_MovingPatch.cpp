...
int main(int argc, char* argv[]) {
    ...
    while (vis_sys->Run()) {
        ...
        // Add/remove terrain patch
        auto veh_pos = hmmwv.GetVehicle().GetPos();
        if (veh_pos.x() > x_switch) {
            terrain.RemovePatch(patches[last_patch]);
            //vis_sys->UnbindItem(patches[last_patch]->GetGroundBody());
            //coll_sys->UnbindItem(patches[last_patch]->GetGroundBody());
            ...
            //terrain.Initialize();
            //vis_sys->BindItem(patches[last_patch]->GetGroundBody());
            //coll_sys->BindItem(patches[last_patch]->GetGroundBody());
