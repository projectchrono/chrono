...
int main(int argc, char* argv[]) {
    ...
    auto patch1 = terrain.AddPatch(patch1_mat, ChCoordsys<>(ChVector<>(-16, 0, -0.5), QUNIT), ChVector<>(32, 20, 1));
    ...
    auto patch2 = terrain.AddPatch(patch2_mat, ChCoordsys<>(ChVector<>(16, 0, -0.5), QUNIT), ChVector<>(32, 30, 1.3));
