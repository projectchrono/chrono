...
class HMMWV_DoubleWishboneReducedFront : public chrono::vehicle::ChDoubleWishboneReduced {
  public:
...
class HMMWV_DoubleWishboneReducedRear : public chrono::vehicle::ChDoubleWishboneReduced {
  public:
