...
int main(int argc, char** argv) {
    ...
    if (rank == MBS_NODE_RANK) {
        ...
        auto vehicle = new ChVehicleCosimWheeledVehicleNode(GetVehicleDataFile(vehicle_specfile), GetVehicleDataFile(engine_specfile), GetVehicleDataFile(transmission_specfile));
    ...
    if (rank == TERRAIN_NODE_RANK) {
        ...
        auto terrain = new ChVehicleCosimTerrainNodeGranularSPH(GetVehicleDataFile(terrain_specfile));
        ...
        switch (tire_type) {
            ...
            case ChVehicleCosimTireNode::TireType::FLEXIBLE: {
                ...
                if (render_tire[tire_index]) {
                    ...
                    visFEA->SetColormapRange(0.0, 12.0);
