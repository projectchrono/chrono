...
//
// =============================================================================
// Authors: Rainer Gericke, Radu Serban, Aaron Young
// =============================================================================
//
// Main driver function for a Sedan vehicle specified through JSON files.
// Example of double wishbone Axles.
//
...
std::string vehicle_file("sedan/vehicle/Sedan_Vehicle.json");
...
std::string simple_map_powertrain_file("sedan/powertrain/Sedan_SimpleMapPowertrain.json");

// JSON files tire models
std::string pac02_tire_file("sedan/tire/Sedan_Pac02Tire.json");
std::string rigid_tire_file("sedan/tire/Sedan_RigidTire.json");
std::string tmeasy_tire_file("sedan/tire/Sedan_TMeasyTire.json");
...
const std::string out_dir = GetChronoOutputPath() + "Sedan_JSON";
...
int main(int argc, char* argv[]) {
    ...
    switch (tire_model) {
        case TireModelType::TMEASY: {
            auto tireFL = chrono_types::make_shared<TMeasyTire>(vehicle::GetDataFile(tmeasy_tire_file));
            auto tireFR = chrono_types::make_shared<TMeasyTire>(vehicle::GetDataFile(tmeasy_tire_file));
            auto tireRL = chrono_types::make_shared<TMeasyTire>(vehicle::GetDataFile(tmeasy_tire_file));
            auto tireRR = chrono_types::make_shared<TMeasyTire>(vehicle::GetDataFile(tmeasy_tire_file));
        ...
        case TireModelType::PAC02: {
            auto tireFL = chrono_types::make_shared<Pac02Tire>(vehicle::GetDataFile(pac02_tire_file));
            auto tireFR = chrono_types::make_shared<Pac02Tire>(vehicle::GetDataFile(pac02_tire_file));
            auto tireRL = chrono_types::make_shared<Pac02Tire>(vehicle::GetDataFile(pac02_tire_file));
            auto tireRR = chrono_types::make_shared<Pac02Tire>(vehicle::GetDataFile(pac02_tire_file));
            vehicle.InitializeTire(tireFL, vehicle.GetAxle(0)->m_wheels[0], VisualizationType::MESH);
            vehicle.InitializeTire(tireFR, vehicle.GetAxle(0)->m_wheels[1], VisualizationType::MESH);
            vehicle.InitializeTire(tireRL, vehicle.GetAxle(1)->m_wheels[0], VisualizationType::MESH);
            vehicle.InitializeTire(tireRR, vehicle.GetAxle(1)->m_wheels[1], VisualizationType::MESH);
        ...
        case TireModelType::RIGID: {
            auto tireFL = chrono_types::make_shared<RigidTire>(vehicle::GetDataFile(rigid_tire_file));
            auto tireFR = chrono_types::make_shared<RigidTire>(vehicle::GetDataFile(rigid_tire_file));
            auto tireRL = chrono_types::make_shared<RigidTire>(vehicle::GetDataFile(rigid_tire_file));
            auto tireRR = chrono_types::make_shared<RigidTire>(vehicle::GetDataFile(rigid_tire_file));
            vehicle.InitializeTire(tireFL, vehicle.GetAxle(0)->m_wheels[0], VisualizationType::MESH);
            vehicle.InitializeTire(tireFR, vehicle.GetAxle(0)->m_wheels[1], VisualizationType::MESH);
            vehicle.InitializeTire(tireRL, vehicle.GetAxle(1)->m_wheels[0], VisualizationType::MESH);
            vehicle.InitializeTire(tireRR, vehicle.GetAxle(1)->m_wheels[1], VisualizationType::MESH);
    ...
    ChWheeledVehicleIrrApp app(&vehicle, L"Sedan (JSON) Vehicle Demo");
