...
int main(int argc, char* argv[]) {
    ...
    auto patch1 = terrain.AddPatch(patch1_mat, ChCoordsys<>(ChVector<>(0, -25, -5), QUNIT), ChVector<>(100, 50, 10));
    auto patch2 = terrain.AddPatch(patch2_mat, ChCoordsys<>(ChVector<>(0, 25, -5), QUNIT), ChVector<>(100, 50, 10));
