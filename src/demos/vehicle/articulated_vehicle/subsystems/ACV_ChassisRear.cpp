...
// Static variables
// -----------------------------------------------------------------------------
const double ACV_ChassisRear::m_mass = 2000.0;
const ChVector<> ACV_ChassisRear::m_inertiaXX(100, 400, 500);
const ChVector<> ACV_ChassisRear::m_inertiaXY(0, 0, 0);
const ChVector<> ACV_ChassisRear::m_COM_loc(0, 0, 0.4);
