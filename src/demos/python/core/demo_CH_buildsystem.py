...
bodyA.GetCollisionModel().AddShape(chrono.ChCollisionShapeBox(material,10,1,10))
...
bodyB.GetCollisionModel().AddShape(chrono.ChCollisionShapeBox(material,1,1,1))
