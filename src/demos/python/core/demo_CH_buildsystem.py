...
markerB.SetMotionAxisX(my_funct)
...
bodyC.SetFrame_COG_to_REF(chrono.ChFramed(chrono.ChVector3d(68.9923703887577,-60.1266363930238,70.1327223302498),chrono.ChQuaterniond(1,0,0,0)))
