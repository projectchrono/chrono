...
int main(int argc, char* argv[]) {
    ...
    my_perimaterial->max_stretch_fracture =
        0.1;  // 0.001 beyond this, fracture happens (bonds still in place, but become unilateral)
    my_perimaterial->max_stretch_break =
        0.3;  // 0.003 beyond this, bull break happens (bonds removed, collision surface generated)
