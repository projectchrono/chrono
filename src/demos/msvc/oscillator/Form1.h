...
ref class Form1 : public System::Windows::Forms::Form {
  ...
  protected:
    ...
    //
  private:
    System::Windows::Forms::NumericUpDown ^ numeric_mass;

  protected:
  private:
    System::Windows::Forms::Label ^ label_mass;
  ...
  private:
    System::Windows::Forms::NumericUpDown ^ numeric_K;
  ...
  private:
    System::Windows::Forms::NumericUpDown ^ numeric_R;

  private:
    System::Windows::Forms::Label ^ label_r;

  private:
    System::Windows::Forms::NumericUpDown ^ numeric_X0;

  private:
    System::Windows::Forms::Label ^ label_x0;

  private:
    System::Windows::Forms::Label ^ label_v0;

  private:
    System::Windows::Forms::NumericUpDown ^ numeric_V0;

  private:
    System::Windows::Forms::NumericUpDown ^ numeric_d0;

  private:
    System::Windows::Forms::Label ^ label1;

  private:
    System::Windows::Forms::ToolTip ^ toolTip_mass;

  private:
    System::Windows::Forms::NumericUpDown ^ numeric_realstep;

  private:
    System::Windows::Forms::Label ^ label_realstep;

  private:
    System::Windows::Forms::Label ^ label_dt;

  private:
    System::Windows::Forms::NumericUpDown ^ numeric_dt;

  private:
    System::Windows::Forms::CheckBox ^ checkBox_realtime;

  private:
    System::Windows::Forms::GroupBox ^ group_step;

  private:
    System::Windows::Forms::GroupBox ^ group_spring;

  private:
    System::Windows::Forms::GroupBox ^ group_boundary;
...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void) {
        ...
        this->toolTip_mass->SetToolTip(
            this->numeric_K,
            L"This is the stiffness of the spring, expressed\r\nin Newtons per meter of elongatio"
        ...
        this->toolTip_mass->SetToolTip(
            this->numeric_X0,
            L"This is the initial horizontal position, expressed in meters [m],  \r\nof the movin"
        ...
        this->toolTip_mass->SetToolTip(
            this->numeric_V0,
            L"This is the initial horizontal speed, expressed in meters/second [m/s],  \r\nof the"
        ...
        this->toolTip_mass->SetToolTip(
            this->numeric_d0,
            L"This is the length of the undeformed spring\r\n(i.e. the length of the spring witho"
        ...
        this->checkBox_realtime->CheckedChanged +=
            gcnew System::EventHandler(this, &Form1::checkBox_realtime_CheckedChanged);
        //
        // label_realstep
        //
...
#pragma endregion
    ...
    void redraw_3d_window() {
        ...
        ChIrrTools::drawSpring(this->aIrrDevice->getVideoDriver(), 0.1, this->oscillator->my_spring->GetEndPoint1Abs(),
                               this->oscillator->my_spring->GetEndPoint2Abs());
  ...
  private:
    System::Void numeric_mass_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
        this->oscillator->my_body->GetBody()->SetMass(Decimal::ToDouble(this->numeric_mass->Value));
    }

  private:
    System::Void numeric_K_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
        this->oscillator->my_spring->Set_SpringK(Decimal::ToDouble(this->numeric_K->Value));
    }

  private:
    System::Void numeric_R_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
        this->oscillator->my_spring->Set_SpringR(Decimal::ToDouble(this->numeric_R->Value));
    }

  private:
    System::Void numeric_X0_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
  ...
  private:
    System::Void numeric_v0_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
        this->oscillator->V0 = Decimal::ToDouble(this->numeric_V0->Value);
    }

  private:
    System::Void numeric_d0_ValueChanged(System::Object ^ sender, System::EventArgs ^ e) {
        this->oscillator->my_spring->Set_SpringRestLength(Decimal::ToDouble(this->numeric_d0->Value));
    }

  private:
    System::Void checkBox_realtime_CheckedChanged(System::Object ^ sender, System::EventArgs ^ e) {
