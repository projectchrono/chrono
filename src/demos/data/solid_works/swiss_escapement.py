...
# Visualization shape 
body_2_2_shape = chrono.ChObjShapeFileShared() 
body_2_2_shape.SetFilename(shapes_dir +'body_2_2.obj') 
body_2_2_level = chrono.ChAssetLevelShared() 
...
body_4.SetBodyFixed(1)

# Visualization shape 
body_4_1_shape = chrono.ChObjShapeFileShared() 
body_4_1_shape.SetFilename(shapes_dir +'body_4_1.obj') 
body_4_1_level = chrono.ChAssetLevelShared() 
...
link_1 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(0,-0.0296181804404151,0)
dA = chrono.ChVectorD(0,-1,0)
cB = chrono.ChVectorD(0,-0.03,0)
dB = chrono.ChVectorD(0,1,0)
link_1.SetFlipped(1)
link_1.Initialize(body_1,body_4,0,cA,cB,dA,dB)
link_1.SetName("Concentrico1")
exported_items.append(link_1)

link_2 = chrono.ChLinkMateGenericShared()
link_2.SetConstrainedCoords(0, 1, 1, 0, 0, 0)
cA = chrono.ChVectorD(0,-0.0296181804404151,0)
cB = chrono.ChVectorD(0,-0.03,0)
dA = chrono.ChVectorD(0,-1,0)
dB = chrono.ChVectorD(0,1,0)
link_2.Initialize(body_1,body_4,0,cA,cB,dA,dB)
...
link_3 = chrono.ChLinkMateXdistanceShared()
...
link_3.Initialize(body_1,body_4,0,cA,cB,dB)
link_3.SetDistance(0.026)
link_3.SetName("Distanza2")
exported_items.append(link_3)

link_4 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(0,0.000381819559584939,0)
dA = chrono.ChVectorD(0,-1,0)
cB = chrono.ChVectorD(0.03,-0.0256181804404151,0.0274036523869519)
dB = chrono.ChVectorD(0,1,-1.05833389757388e-16)
link_4.SetFlipped(1)
link_4.Initialize(body_1,body_4,0,cA,cB,dA,dB)
...
link_5 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(1.2490009027033e-16,3.5777905607493e-05,-0.219053185080869)
dA = chrono.ChVectorD(0,-1,0)
cB = chrono.ChVectorD(0,-0.03,-0.21905318508087)
dB = chrono.ChVectorD(0,1,0)
link_5.SetFlipped(1)
link_5.Initialize(body_3,body_4,0,cA,cB,dA,dB)
link_5.SetName("Concentrico2")
exported_items.append(link_5)

link_6 = chrono.ChLinkMateGenericShared()
link_6.SetConstrainedCoords(0, 1, 1, 0, 0, 0)
cA = chrono.ChVectorD(1.2490009027033e-16,3.5777905607493e-05,-0.219053185080869)
cB = chrono.ChVectorD(0,-0.03,-0.21905318508087)
dA = chrono.ChVectorD(0,-1,0)
dB = chrono.ChVectorD(0,1,0)
link_6.Initialize(body_3,body_4,0,cA,cB,dA,dB)
...
link_7 = chrono.ChLinkMateXdistanceShared()
...
dA = chrono.ChVectorD(0,-1,0)
dB = chrono.ChVectorD(0,-1,0)
link_7.Initialize(body_4,body_3,0,cA,cB,dB)
link_7.SetDistance(0)
link_7.SetName("Distanza3")
exported_items.append(link_7)

link_8 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(0.03,-0.0256181804404151,-0.250816354295145)
dA = chrono.ChVectorD(0,-1,0)
cB = chrono.ChVectorD(-6.22881045830321e-05,-0.0256181804404151,-0.21783989029871)
dB = chrono.ChVectorD(0,-1,0)
link_8.Initialize(body_4,body_3,0,cA,cB,dA,dB)
...
link_9 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(1.38777878078145e-17,-1.0842021724855e-19,-0.105)
dA = chrono.ChVectorD(0,-1,0)
cB = chrono.ChVectorD(0,-0.0256181804404151,-0.105)
dB = chrono.ChVectorD(0,-1,0)
link_9.Initialize(body_4,body_2,0,cB,cA,dB,dA)
link_9.SetName("Concentrico3")
exported_items.append(link_9)

link_10 = chrono.ChLinkMateGenericShared()
link_10.SetConstrainedCoords(0, 1, 1, 0, 0, 0)
cA = chrono.ChVectorD(1.38777878078145e-17,-1.0842021724855e-19,-0.105)
cB = chrono.ChVectorD(0,-0.0256181804404151,-0.105)
dA = chrono.ChVectorD(0,-1,0)
dB = chrono.ChVectorD(0,-1,0)
link_10.Initialize(body_4,body_2,0,cB,cA,dB,dA)
...
link_11 = chrono.ChLinkMateXdistanceShared()
...
dA = chrono.ChVectorD(0,1,0)
dB = chrono.ChVectorD(0,-1,0)
link_11.Initialize(body_4,body_2,0,cA,cB,dB)
link_11.SetDistance(0.012)
link_11.SetName("Distanza4")
exported_items.append(link_11)

link_12 = chrono.ChLinkMateParallelShared()
cA = chrono.ChVectorD(0.03,-0.0127328264314352,-0.0874722553494342)
dA = chrono.ChVectorD(0,1,0)
cB = chrono.ChVectorD(-0.013703234694226,-0.000732826431435213,-0.0789732577077453)
dB = chrono.ChVectorD(0,-1,0)
link_12.SetFlipped(1)
link_12.Initialize(body_4,body_2,0,cA,cB,dA,dB)
