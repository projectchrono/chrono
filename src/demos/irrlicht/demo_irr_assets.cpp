...
int main(int argc, char* argv[])
{
	...
	mfloor->AddAsset(mfloorcolor);
			...
			// ==Asset== IMPORTANT! Add a ChIrrNodeAsset so that Irrlicht will be able
			// to 'show' all the assets that we added to the body! (this will
			// also require that you use ChIrrAssetConverter, see below).
	...
	mbody->AddAsset(mcamera);
			...
			// ==Asset== IMPORTANT! Add a ChIrrNodeAsset so that Irrlicht will be able
			// to 'show' all the assets that we added to the body! (this will
			// also require that you use ChIrrAssetConverter as shown below.
