...
int main(int argc, char* argv[]) {
    ...
    ChIrrAppInterface application(&mphysicalSystem, L"Conservation of Momentum Test", core::dimension2d<u32>(800, 600),
                                  false);

    // Easy shortcuts to add camera, lights, logo and sky in Irrlicht scene:
    ChIrrWizard::add_typical_Logo(application.GetDevice());
    ChIrrWizard::add_typical_Sky(application.GetDevice());
    ChIrrWizard::add_typical_Lights(application.GetDevice(), core::vector3df(30.f, 200.f, 90.f),
                                    core::vector3df(30.f, 80.f, -60.f), 590, 400);
    ...
    */
    ...
    ChBodySceneNode* poly = (ChBodySceneNode*)addChBodySceneNode_easyGenericMesh(
        &mphysicalSystem, application.GetSceneManager(), mmass, ChVector<>(0, 0, 0), Q_from_AngAxis(0, VECT_X),
    ...
    /*
    ChBodySceneNode* poly2 = (ChBodySceneNode*)addChBodySceneNode_easyGenericMesh(&mphysicalSystem,
    ...
    */
    ...
    while (application.GetDevice()->run() /*&& mphysicalSystem.GetChTime()<=10*/) {
        ...
        */
        ...
        ChIrrTools::drawGrid(application.GetVideoDriver(), 1, 1, 50, 50,
                             ChCoordsys<>(ChVector<>(0, 0, 0), Q_from_AngX(0)), video::SColor(255, 80, 100, 100), true);
