...
class MySimpleCar {
  public:
    ...
    MySimpleCar(ChSystem& my_system,           ///< the chrono::engine physical system
        ...
        // --- The car body ---
        chassis = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(1, 0.5, 3, 1.0, true, true));
        ...
        spindleRF = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(0.1, 0.4, 0.4, 1.0, false, true));
        ...
        wheelRF = ChSharedPtr<ChBodyEasyCylinder>(new ChBodyEasyCylinder(0.45, 0.3, 1.0, true, true));
        ...
        // ..the car right-front spindle
        spindleLF = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(0.1, 0.4, 0.4, 1.0, false, true));
        ...
        wheelLF = ChSharedPtr<ChBodyEasyCylinder>(new ChBodyEasyCylinder(0.45, 0.3, 1.0, true, true));
        ...
        spindleRB = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(0.1, 0.4, 0.4, 1.0, false, true));
        ...
        wheelRB = ChSharedPtr<ChBodyEasyCylinder>(new ChBodyEasyCylinder(0.45, 0.3, 1.0, true, true));
        ...
        // ..the car right-back spindle
        spindleLB = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(0.1, 0.4, 0.4, 1.0, false, true));
        ...
        wheelLB = ChSharedPtr<ChBodyEasyCylinder>(new ChBodyEasyCylinder(0.45, 0.3, 1.0, true, true));
...
int main(int argc, char* argv[]) {
    ...
    auto my_ground = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(60, 2, 60, 1.0, true, true));
    ...
    for (int i = 0; i < 6; i++) {
        auto my_obstacle = ChSharedPtr<ChBodyEasyBox>(new ChBodyEasyBox(1, 0.1, 0.5, 60.0, true, true));
