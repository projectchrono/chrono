...
int main(int argc, char* argv[]) {
    ...
    rotation1.Q_from_AngAxis(-CH_C_PI / 2, ChVector3d(1, 0, 0));  // 1: rotate 90� on X axis
    ChQuaternion<> rotation2;
    rotation2.Q_from_AngAxis(CH_C_PI, ChVector3d(0, 1, 0));  // 2: rotate 180� on vertical Y axis
