...
int main(int argc, char* argv[]) {
    ...
    if (true) {
        ...
        while (mystepper.GetTime() < 4) {
            ...
            GetLog() << " T = " << mystepper.GetTime() << "  x=" << mystepper.get_Y()(0)
    ...
    if (true) {
        ...
        while (mystepper1.GetTime() < 4) {
            ...
            GetLog() << "T = " << mystepper1.GetTime() << "  x=" << mystepper1.get_Y()(0)
                     << "  v=" << mystepper1.get_Y()(1) << "\n";
    ...
    if (true) {
        ...
        while (mystepper1.GetTime() < 4) {
            ...
            GetLog() << "T = " << mystepper1.GetTime() << "  x=" << mystepper1.get_X()(0)
                     << "  v=" << mystepper1.get_V()(0) << "\n";
