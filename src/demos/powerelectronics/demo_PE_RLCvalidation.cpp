...
int main(int argc, char* argv[]) {
    ...
    // =============================================================
    // ======== Mechanical domain ========
    double f_ToSample_mechanic = 1.0e3;//0.5e4; // [Hz]
    ...
    //std::string Netlist_location = "C:/workspace-WISC/Validation/RL_Circuit/Project_build/data/Circuit/MotorControl/Circuit_Netlist1.cir";
    
    std::string Netlist_location = "../data/powerelectronics/Circuit/RLCvalidation/Circuit_Netlist1.cir";   
    ...
    double t_simulation_STOP = 3.0;//400.0e-3; //[s]
