...
std::shared_ptr<fea::ChMesh> Create_MB_FE(ChSystemSMC& sysMBS, ChSystemFsi& sysFSI, bool verbose) {
    ...
    ////ChVector3d center_plate(-0.25, 0.0, plate_lenght_z / 2 + 1 * initSpace0);
    ...
    sysFSI.AddFEAmeshBCE(mesh, NodeNeighborElement_mesh, std::vector<std::vector<int>>(), _2D_elementsNodes_mesh,
