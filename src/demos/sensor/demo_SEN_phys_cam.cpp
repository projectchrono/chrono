...
bool use_diffuse = false;  // whether cameras consider diffuse reflection. If false, then only considers specular reflection
...
int main(int argc, char* argv[]) {
	...
	// Render the antialiased image
	if (vis)
		phys_cam->PushFilter(chrono_types::make_shared<ChFilterVisualize>(image_width, image_height, "Physics-based Camera Sensor"));
