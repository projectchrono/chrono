...
int main(int argc, char* argv[]) {
    ...
    tf_handler->AddSensor(cam, ground_body->GetName());
    tf_handler->AddSensor(lidar, ground_body->GetName());
    tf_handler->AddSensor(lidar_2d, ground_body->GetName());
    tf_handler->AddSensor(acc, ground_body->GetName());
    tf_handler->AddSensor(gyro, ground_body->GetName());
    tf_handler->AddSensor(mag, ground_body->GetName());
    tf_handler->AddSensor(gps, ground_body->GetName());
