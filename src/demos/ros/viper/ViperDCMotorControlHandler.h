#ifndef VIPER_DC_MOTOR_CONTROL_HANDLER
#define VIPER_DC_MOTOR_CONTROL_HANDLER
...
class ViperDCMotorControlHandler : public ChROSHandler {
  public:
    ViperDCMotorControlHandler(uint64_t frequency, std::shared_ptr<chrono::viper::ViperDCMotorControl> driver);
