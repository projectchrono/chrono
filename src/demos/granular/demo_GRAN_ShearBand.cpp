...
int main(int argc, char* argv[]) {
    ...
    ChVector<float> hdims((float)params.box_X / 2.f - 1.2, (float)params.box_Y / 2.f - 1.2,
                          (float)params.box_Z / 10.f - 1.2);
    ChVector<float> center(0.f, 0.f, (float)(-params.box_Z / 2.f + params.box_Z / 10.f));
