...
int main(int argc, char* argv[]) {
    ...
    if (false) {
        ...
        auto my_shaftA = chrono::make_shared<ChShaft>();
        ...
        // to the ChSystemNSC.
        auto my_shaftB = chrono::make_shared<ChShaft>();
        ...
        auto my_shaft_gearAB = chrono::make_shared<ChShaftsGear>();
    ...
    if (false) {
        ...
        auto my_shaft_clutchAB = chrono::make_shared<ChShaftsClutch>();
    ...
    if (false) {
        ...
        auto my_shaftC = chrono::make_shared<ChShaft>();
        ...
        auto my_shaft_planetaryBAC = chrono::make_shared<ChShaftsPlanetary>();
        ...
        auto my_shaftD = chrono::make_shared<ChShaft>();
        ...
        auto my_shaft_clutchBD = chrono::make_shared<ChShaftsClutch>();
    ...
    if (false) {
        ...
        auto my_bodyB = chrono::make_shared<ChBody>();
        ...
        auto my_shaft_torsionAC = chrono::make_shared<ChShaftsTorsionSpring>();
        ...
        auto my_shaftbody_connection = chrono::make_shared<ChShaftsBody>();
    ...
    if (true) {
        ...
        auto my_torqueconverter = chrono::make_shared<ChShaftsTorqueConverter>();
        my_torqueconverter->Initialize(my_shaftA, my_shaftB, my_shaftC);
        my_system.Add(my_torqueconverter);

        auto mK = chrono::make_shared<ChFunction_Recorder>();
        mK->AddPoint(0.0, 15);
        mK->AddPoint(0.25, 15);
        mK->AddPoint(0.50, 15);
        mK->AddPoint(0.75, 16);
        ...
        auto mT = chrono::make_shared<ChFunction_Recorder>();
        ...
        /*
        auto my_motor = chrono::make_shared<ChShaftsMotor>();
        ...
        */
        ...
        /*
        auto my_motor = chrono::make_shared<ChShaftsTorque>();
        my_motor->Initialize(my_shaftA, my_shaftD);
        ...
        */
        ...
        auto my_motor = chrono::make_shared<ChShaftsThermalEngine>();
        my_motor->Initialize(my_shaftA, my_shaftD);
        my_system.Add(my_motor);

        auto mTw = chrono::make_shared<ChFunction_Recorder>();
