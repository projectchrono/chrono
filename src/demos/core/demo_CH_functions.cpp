...
int main(int argc, char* argv[]) {
    ...
    auto f_constacc1 = chrono::make_shared<ChFunction_ConstAcc>();
    ...
    auto f_const = chrono::make_shared<ChFunction_Const>();
    f_sequence.InsertFunct(f_const, 0.4, 1, true, false, false, -1);

    auto f_constacc2 = chrono::make_shared<ChFunction_ConstAcc>();
    ...
    auto f_part1 = chrono::make_shared<ChFunction_Ramp>();
    f_part1->Set_ang(.50);
    auto f_part2 = chrono::make_shared<ChFunction_Const>();
    f_part2->Set_yconst(1.0);
    auto f_part3 = chrono::make_shared<ChFunction_Ramp>();
    f_part3->Set_ang(-.50);

    auto f_seq = chrono::make_shared<ChFunction_Sequence>();
    f_seq->InsertFunct(f_part1, 1.0, 1, true);
    f_seq->InsertFunct(f_part2, 1.0, 1., true);
    f_seq->InsertFunct(f_part3, 1.0, 1., true);

    auto f_rep_seq = chrono::make_shared<ChFunction_Repeat>();
