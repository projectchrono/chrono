...
int main(int argc, char* argv[]) {
...

    {
        ...
        auto my_body_A = chrono::make_shared<ChBody>();
        auto my_body_B = chrono::make_shared<ChBody>();
        auto my_body_C = chrono::make_shared<ChBody>();

        // Create some markers..
        // Markers are 'auxiliary coordinate systems' to be added
        // to rigid bodies.
        // Again, note that they are managed by shared pointers.
        auto my_marker_a1 = chrono::make_shared<ChMarker>();
        auto my_marker_a2 = chrono::make_shared<ChMarker>();
        auto my_marker_b1 = chrono::make_shared<ChMarker>();
        auto my_marker_b2 = chrono::make_shared<ChMarker>();

        // You can create some forces too...
        auto my_force_a1 = chrono::make_shared<ChForce>();
        auto my_force_a2 = chrono::make_shared<ChForce>();
...

    {
        ...
        auto my_marker_b = chrono::make_shared<ChMarker>();
        auto my_marker_c = chrono::make_shared<ChMarker>();
        ...
        auto my_link_BC = chrono::make_shared<ChLinkLockRevolute>();
        ...
        auto my_link_CA = chrono::make_shared<ChLinkLockPointLine>();
        ...
        auto my_motor_AB = chrono::make_shared<ChLinkMotorRotationSpeed>();
        my_motor_AB->SetName("MOTOR truss-crank");
        my_motor_AB->Initialize(my_body_A, my_body_B, ChFrame<>(ChVector<>(0, 0, 0)));
        my_motor_AB->SetSpeedFunction(chrono::make_shared<ChFunction_Const>(CH_C_PI));
