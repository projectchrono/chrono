...
void MakeAndRunDemo_SlewingBeam(bool do_modal_reduction, ChMatrixDynamic<>& mdeflection) {
    ...
    if (USE_HERTING)
        modal_assembly->modal_reduction_type = chrono::modal::ChModalAssembly::ReductionType::HERTING;
    else
        modal_assembly->modal_reduction_type = chrono::modal::ChModalAssembly::ReductionType::CRAIG_BAMPTON;
