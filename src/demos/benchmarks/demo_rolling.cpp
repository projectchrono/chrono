...
int main(int argc, char* argv[]) {
    ...
    ChBodySceneNode* ground0 = (ChBodySceneNode*)addChBodySceneNode_easyBox(
        &mphysicalSystem, application.GetSceneManager(), groundMass, ChVector<>(0, 0, planeWidth * 0),
        Q_from_AngAxis(0, VECT_Z), ChVector<>(planeLength, planeThickness, planeWidth));
