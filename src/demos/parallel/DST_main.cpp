    ...
    for (int i = 1; i < numParticles; i++) {
        ...
        if (body->GetIdentifier() > 0) {
            ...
            double running_distance =
                sqrt((xx - pos_star.x()) * (xx - pos_star.x()) + (yy - pos_star.y()) * (yy - pos_star.y()) +
...
void InitialPositionLibrary(ChVector<>* pos_1,
                            ChVector<>* pos_2,
                            ChVector<>* pos_3,
                            ChVector<>* pos_4,
                            ChVector<>* pos_5,
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "  done.  Read " << msystem.Get_bodylist()->size() << " bodies." << std::endl;
    ...
    // -----------------------------------------------------
    {
        ...
        BallsIDsStream << tablica[0] << "," << tablica[1] << "," << tablica[2] << "," << tablica[3] << "," << tablica[4]
                       << "," << tablica[5] << "\n";
    }
    ...
    while (msystem.GetChTime() < time_end) {
        if (gl_window.Active()) {
            ...
            if (gl_window.Running()) {
                ...
                // ---------------------------------------------
                top_frame->SetPos(ChVector<>(top_frame->GetPos().x() - shear_vel * time_step, top_frame->GetPos().y(),
                                             top_frame->GetPos().z()));
                ...
                if (msystem.GetChTime() > time_out_step) {
                    ...
                    PosStream << msystem.GetChTime() << "," << ball_1->GetPos().x() << "," << ball_1->GetPos().y()
                              << "," << ball_1->GetPos().z() << "," << ball_2->GetPos().x() << ","
                              << ball_2->GetPos().y() << "," << ball_2->GetPos().z() << "," << ball_3->GetPos().x()
                              << "," << ball_3->GetPos().y() << "," << ball_3->GetPos().z() << ","
                              << ball_4->GetPos().x() << "," << ball_4->GetPos().y() << "," << ball_4->GetPos().z()
                              << "," << ball_5->GetPos().x() << "," << ball_5->GetPos().y() << ","
                              << ball_5->GetPos().z() << "," << ball_6->GetPos().x() << "," << ball_6->GetPos().y()
                              << "," << ball_6->GetPos().z() << ","
                              << "\n";
    ...
    while (msystem.GetChTime() < time_end) {
        ...
        if (msystem.GetChTime() > time_out_step) {
            ...
            PosStream << msystem.GetChTime() << "," << ball_1->GetPos().x() << "," << ball_1->GetPos().y() << ","
                      << ball_1->GetPos().z() << "," << ball_2->GetPos().x() << "," << ball_2->GetPos().y() << ","
                      << ball_2->GetPos().z() << "," << ball_3->GetPos().x() << "," << ball_3->GetPos().y() << ","
                      << ball_3->GetPos().z() << "," << ball_4->GetPos().x() << "," << ball_4->GetPos().y() << ","
                      << ball_4->GetPos().z() << "," << ball_5->GetPos().x() << "," << ball_5->GetPos().y() << ","
                      << ball_5->GetPos().z() << "," << ball_6->GetPos().x() << "," << ball_6->GetPos().y() << ","
                      << ball_6->GetPos().z() << ","
                      << "\n";
