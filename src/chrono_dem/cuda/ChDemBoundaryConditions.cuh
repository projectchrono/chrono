...
using chrono::dem::BC_type;
using chrono::dem::BC_params_t;
using chrono::dem::Sphere_BC_params_t;
using chrono::dem::Z_Cone_BC_params_t;
using chrono::dem::Z_Cylinder_BC_params_t;
using chrono::dem::Plane_BC_params_t;
