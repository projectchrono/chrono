...
template <class T3>
__device__ void convert_pos_UU2SU(T3& pos, ChSystemDem_impl::GranParamsPtr gran_params) {
...
inline __device__ unsigned int triangle_countTouchedSDs(unsigned int triangleID,
                                                        const ChSystemDemMesh_impl::TriangleSoupPtr triangleSoup,
                                                        ChSystemDem_impl::GranParamsPtr gran_params,
                                                        ChSystemDemMesh_impl::MeshParamsPtr tri_params) {
    float3 vA, vB, vC;
...
inline __device__ void triangle_figureOutTouchedSDs(unsigned int triangleID,
                                                    ...
                                                    const ChSystemDem_impl::GranParamsPtr& gran_params,
                                                    const ChSystemDemMesh_impl::MeshParamsPtr& tri_params) {
    float3 vA, vB, vC;
...
__global__ void storeSDsTouchedByEachTriangle(const ChSystemDemMesh_impl::TriangleSoupPtr d_triangleSoup,
