...
#ifndef TOEBAR_DEDIONAXLE_H
#define TOEBAR_DEDIONAXLE_H
...
class CH_VEHICLE_API ToeBarDeDionAxle : public ChToeBarDeDionAxle {
  public:
    ToeBarDeDionAxle(const std::string& filename);
    ToeBarDeDionAxle(const rapidjson::Document& d);
    ~ToeBarDeDionAxle();
