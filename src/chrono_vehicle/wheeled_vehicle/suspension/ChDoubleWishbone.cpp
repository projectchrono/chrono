...
void ChDoubleWishbone::InitializeSide(VehicleSide side,
    ...
    m_LCA[side] = ChSharedPtr<ChBody>(new ChBody(chassis->GetSystem()->GetContactMethod()));
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void ChDoubleWishbone::AddVisualizationControlArm(ChSharedPtr<ChBody> arm,
                                                  const ChVector<> pt_F,
                                                  const ChVector<> pt_B,
                                                  const ChVector<> pt_U,
                                                  double radius) {
...
void ChDoubleWishbone::AddVisualizationUpright(ChSharedPtr<ChBody> upright,
                                               const ChVector<> pt_C,
                                               const ChVector<> pt_U,
                                               const ChVector<> pt_L,
                                               const ChVector<> pt_T,
...
void ChDoubleWishbone::AddVisualizationSpindle(ChSharedPtr<ChBody> spindle, double radius, double width) {
