...
void ChDoubleWishbone::InitializeSide(VehicleSide side,
    ...
    m_UCA[side] = std::make_shared<ChBody>(chassis->GetSystem()->GetContactMethod());
    ...
    m_revoluteUCA[side] = std::make_shared<ChLinkLockRevolute>();
    ...
    m_sphericalUCA[side] = std::make_shared<ChLinkLockSpherical>();
