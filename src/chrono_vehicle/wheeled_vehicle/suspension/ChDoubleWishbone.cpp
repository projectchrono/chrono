...
void ChDoubleWishbone::PopulateComponentList() {
    ...
    m_components.bodies.push_back(m_UCA[0]);
    m_components.bodies.push_back(m_UCA[1]);
    ...
    m_revoluteUCA[0]->IsKinematic() ? m_components.joints.push_back(m_revoluteUCA[0]->GetAsLink()) : m_components.bushings.push_back(m_revoluteUCA[0]->GetAsBushing());
    m_revoluteUCA[1]->IsKinematic() ? m_components.joints.push_back(m_revoluteUCA[1]->GetAsLink()) : m_components.bushings.push_back(m_revoluteUCA[1]->GetAsBushing());
    m_sphericalUCA[0]->IsKinematic() ? m_components.joints.push_back(m_sphericalUCA[0]->GetAsLink()) : m_components.bushings.push_back(m_sphericalUCA[0]->GetAsBushing());
    m_sphericalUCA[1]->IsKinematic() ? m_components.joints.push_back(m_sphericalUCA[1]->GetAsLink()) : m_components.bushings.push_back(m_sphericalUCA[1]->GetAsBushing());
    ...
    m_revoluteLCA[1]->IsKinematic() ? m_components.joints.push_back(m_revoluteLCA[1]->GetAsLink()) : m_components.bushings.push_back(m_revoluteUCA[1]->GetAsBushing());
