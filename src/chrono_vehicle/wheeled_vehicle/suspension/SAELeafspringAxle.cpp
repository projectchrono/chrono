...
void SAELeafspringAxle::Create(const rapidjson::Document& d) {
    ...
    m_latRotSpringCBA = chrono_types::make_shared<utils::LinearSpringDamperTorque>(KrotLatA, KrotLatA * damping_factor, 0);
    m_latRotSpringCBB = chrono_types::make_shared<utils::LinearSpringDamperTorque>(KrotLatB, KrotLatB * damping_factor, 0);
