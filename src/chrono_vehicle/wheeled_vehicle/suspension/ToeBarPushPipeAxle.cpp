...
// -----------------------------------------------------------------------------
ToeBarPushPipeAxle::ToeBarPushPipeAxle(const std::string& filename)
    : ChToeBarPushPipeAxle(""), m_springForceCB(NULL), m_shockForceCB(NULL), m_use_left_knuckle(true) {
    Document d;
...
ToeBarPushPipeAxle::~ToeBarPushPipeAxle() {}

// -----------------------------------------------------------------------------
// Worker function for creating a ToeBarPushPipeAxle suspension using data in the
// specified RapidJSON document.
// -----------------------------------------------------------------------------
void ToeBarPushPipeAxle::Create(const rapidjson::Document& d) {
