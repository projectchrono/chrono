...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void ChMacPhersonStrut::Initialize(ChSharedPtr<ChBodyAuxRef> chassis,
...
void ChMacPhersonStrut::AddVisualizationUpright(ChSharedPtr<ChBody> upright,
                                               const ChVector<> pt_C,
                                               const ChVector<> pt_U,
                                               const ChVector<> pt_L,
                                               const ChVector<> pt_T,
...
void ChMacPhersonStrut::AddVisualizationSpindle(ChSharedPtr<ChBody> spindle, double radius, double width) {
    ChSharedPtr<ChCylinderShape> cyl(new ChCylinderShape);
