...
void ChShaftsDriveline8WD::Initialize(std::shared_ptr<ChChassis> chassis,
    ...
    m_reargroup_shaft->SetInertia(GetToFrontDiffShaftInertia());
    ...
    m_frontgroup_clutch->Initialize(m_front1_shaft, m_front2_shaft);
    ...
    m_reargroup_clutch->Initialize(m_rear1_shaft, m_rear2_shaft);
