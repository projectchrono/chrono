...
namespace vehicle
{
    ...
    // -----------------------------------------------------------------------------
    ChShaftsDriveline2WDL::ChShaftsDriveline2WDL(const std::string& name)
        : ChDriveline(name)
    ...
    // -----------------------------------------------------------------------------
    void ChShaftsDriveline2WDL::Initialize(std::shared_ptr<ChBody> chassis,
        ...
        const std::vector<int>& driven_axles)
    {
        ...
        m_clutch->Initialize(
            suspensions[m_driven_axles[0]]->GetAxle(LEFT), suspensions[m_driven_axles[0]]->GetAxle(RIGHT));
        m_clutch->SetTorqueLimit(0);
    ...
    // -----------------------------------------------------------------------------
    // -----------------------------------------------------------------------------
    double ChShaftsDriveline2WDL::GetWheelTorque(const WheelID& wheel_id) const
    {
