...
// -----------------------------------------------------------------------------
void ChSprocketBandANCF::Initialize(std::shared_ptr<ChBodyAuxRef> chassis,
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void ChSprocketBandANCF::AddVisualizationAssets(VisualizationType vis) {
...
void ChSprocketBandANCF::RemoveVisualizationAssets() {
