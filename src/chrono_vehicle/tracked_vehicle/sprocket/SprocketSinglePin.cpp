...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
SprocketSinglePin::SprocketSinglePin(const std::string& filename) : ChSprocketSinglePin(""), m_vis_type(NONE) {
...
SprocketSinglePin::SprocketSinglePin(const rapidjson::Document& d) : ChSprocketSinglePin(""), m_vis_type(NONE) {
    Create(d);
}
