...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void ChRotationalDamperRWAssembly::Initialize(std::shared_ptr<ChBodyAuxRef> chassis, const ChVector<>& location) {
    ...
    m_spring->RegisterTorqueFunctor(GetSpringTorqueCallback());
