...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
DoubleRoadWheel::DoubleRoadWheel(const std::string& filename) : ChDoubleRoadWheel(""), m_vis_type(NONE) {
...
DoubleRoadWheel::DoubleRoadWheel(const rapidjson::Document& d) : ChDoubleRoadWheel(""), m_vis_type(NONE) {
    Create(d);
}
