...
#ifndef TRACK_ASSEMBLY_BAND_ANCF_H
#define TRACK_ASSEMBLY_BAND_ANCF_H
...
/// Band-ANCF track assembly model constructed from a JSON specification file
class CH_VEHICLE_API TrackAssemblyBandANCF : public ChTrackAssemblyBandANCF {
  public:
    TrackAssemblyBandANCF(const std::string& filename);
