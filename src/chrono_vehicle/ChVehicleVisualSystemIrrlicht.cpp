...
void ChVehicleVisualSystemIrrlicht::renderStats() {
    ...
    renderTextBox(msg, m_HUD_x + 190, m_HUD_y + 150, 170, 15, irr::video::SColor(255, 255, 255, 255));

    // Display estimated RTF values
    snprintf(msg, sizeof(msg), "RTF %3.2f (simulation)", GetSimulationRTF());
    renderTextBox(msg, m_HUD_x + 190, m_HUD_y + 170, 170, 15, irr::video::SColor(255, 255, 255, 255));
    snprintf(msg, sizeof(msg), "RTF %3.2f (step)", GetStepRTF());
    renderTextBox(msg, m_HUD_x + 190, m_HUD_y + 190, 170, 15, irr::video::SColor(255, 255, 255, 255));
