...
CH_VEHICLE_API std::shared_ptr<ChTrackSuspension> ReadRoadWheelAssemblyJSON(const std::string& filename,
                                                                              bool has_shock,
                                                                              bool lock_arm);
...
CH_VEHICLE_API std::shared_ptr<ChTrackWheel> ReadRoadWheelJSON(const std::string& filename);
