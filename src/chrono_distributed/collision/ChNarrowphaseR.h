...
#ifndef CHRONO_DISTRIBUTED_COLLISION_CHNARROWPHASER_H_
#define CHRONO_DISTRIBUTED_COLLISION_CHNARROWPHASER_H_
...
#endif /* CHRONO_DISTRIBUTED_COLLISION_CHNARROWPHASER_H_ */
