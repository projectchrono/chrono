...
#ifndef CHRONO_DISTRIBUTED_COLLISION_CHCOLLISION_H_
#define CHRONO_DISTRIBUTED_COLLISION_CHCOLLISION_H_
...
class ChCAABBGeneratorDistr {
  public:
    ChCAABBGeneratorDistr();
    void GenerateAABB();
    ChParallelDataManager* data_manager;
};

class ChCBroadphaseDistr {
  public:
    ChCBroadphaseDistr();
    void DispatchRigid();
...
#endif /* CHRONO_DISTRIBUTED_COLLISION_CHCOLLISION_H_ */
