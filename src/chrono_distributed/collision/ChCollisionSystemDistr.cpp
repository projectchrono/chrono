...
ChCollisionSystemDistr::ChCollisionSystemDistr(ChParallelDataManager *dc) : data_manager(dc)
{}


void ChCollisionSystemDistr::Add(ChCollisionModel* model)
{
...
void ChCollisionSystemDistr::GetOverlappingAABB(custom_vector<char>& active_id, real3 Amin, real3 Amax) {
    data_manager->aabb_generator->GenerateAABB();
#pragma omp parallel for
...
std::vector<vec2> ChCollisionSystemDistr::GetOverlappingPairs() {
