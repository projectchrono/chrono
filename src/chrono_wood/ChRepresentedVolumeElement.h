...
#include "chrono_wood/ChLinkPoint2Line.h"
#include "chrono_wood/ChLinkNodeNodeRot.h"
#include "chrono_wood/ChLinkNodeRotFace.h"
#include "chrono_wood/ChMeshSurfaceGeneral.h"
...
class ChWoodApi ChRepresentedVolumeElement {
public:
