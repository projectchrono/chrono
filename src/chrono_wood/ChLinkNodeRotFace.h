...
#ifndef CH_LINK_POINT_TRIFACE_WOOD_H
#define CH_LINK_POINT_TRIFACE_WOOD_H
...
class ChWoodApi ChTriangleNodesXYZ : public ChVariableTupleCarrier_3vars<3, 3, 3> {
  public:
...
class ChWoodApi ChLinkNodeRotFace : public ChLinkBase {
  public:
     ChLinkNodeRotFace();
...
class ChWoodApi ChTriangleOfXYZROTnodes : public ChVariableTupleCarrier_3vars<6, 6, 6> {
  public:
...
/// shape function (ex. the face of a tetrahedron or a triangular shell)
/// The node can be offset respect to the face.
class ChWoodApi  ChLinkNodeRotFaceRot : public ChLinkBase {
  public:
