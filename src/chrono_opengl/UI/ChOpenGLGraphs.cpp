...
//
//  std::vector<double> history = ((ChIterativeSolver*)(physics_system->GetLcpSolverSpeed()))->GetViolationHistory();
//  std::vector<double> dlambda = ((ChIterativeSolver*)(physics_system->GetLcpSolverSpeed()))->GetDeltalambdaHistory();
//
