	...
	virtual void ComputeMatrB(int ID, double zeta1, double zeta2, double zeta3, double& JacobianDet) 
				{
					...
					ChMatrixDynamic<> Jinv(3,3);
					Jinv(0,0)=Jacobian(1,1)*Jacobian(2,2)-Jacobian(1,2)*Jacobian(2,1);	Jinv(0,1)=Jacobian(2,1)*Jacobian(0,2)-Jacobian(0,1)*Jacobian(2,2);	Jinv(0,2)=Jacobian(0,1)*Jacobian(1,2)-Jacobian(0,2)*Jacobian(1,1);
					Jinv(1,0)=Jacobian(1,2)*Jacobian(2,0)-Jacobian(1,0)*Jacobian(2,2);	Jinv(1,1)=Jacobian(2,2)*Jacobian(0,0)-Jacobian(2,0)*Jacobian(0,2);	Jinv(1,2)=Jacobian(0,2)*Jacobian(1,0)-Jacobian(1,2)*Jacobian(0,0);
					Jinv(2,0)=Jacobian(1,0)*Jacobian(2,1)-Jacobian(1,1)*Jacobian(2,0);	Jinv(2,1)=Jacobian(0,1)*Jacobian(2,0)-Jacobian(0,0)*Jacobian(2,1);	Jinv(2,2)=Jacobian(0,0)*Jacobian(1,1)-Jacobian(0,1)*Jacobian(1,0);
					Jinv.MatrDivScale(Jdet);
