...
void cbtContactArray::merge_contacts(
	const cbtContactArray& contacts, bool normal_contact_average)
{
	clear();
	...
	cbtAlignedObjectArray<CONTACT_KEY_TOKEN> keycontacts;
...
void cbtContactArray::merge_contacts_unique(const cbtContactArray& contacts)
{
	clear();
	...
	//divide
	cbtScalar divide_average = 1.0f / ((cbtScalar)contacts.size());
