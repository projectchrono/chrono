/*! \file cbtGenericPoolAllocator.h
...
public:
	...
	cbtGenericMemoryPool(size_t element_size, size_t element_count)
	{
...
public:
	cbtGenericMemoryPool *m_pools[BT_DEFAULT_MAX_POOLS];
	size_t m_pool_count;
...
protected:
	// creates a pool
	cbtGenericMemoryPool *push_new_pool();
...
public:
	cbtGenericPoolAllocator(size_t pool_element_size, size_t pool_element_count)
	{
		m_pool_count = 0;
	...
	virtual ~cbtGenericPoolAllocator();
