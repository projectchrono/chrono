...
float cbtGImpactBvh::getAverageTreeCollisionTime()
{
...
int cbtBvhTree::_calc_splitting_axis(
...
bool cbtGImpactBvh::boxQuery(const cbtAABB& box, cbtAlignedObjectArray<int>& collided_results) const
{
	int curIndex = 0;
...
SIMD_FORCE_INLINE bool _node_collision(
	cbtGImpactBvh* boxset0, cbtGImpactBvh* boxset1,
...
void cbtGImpactBvh::find_collision(cbtGImpactBvh* boxset0, const cbtTransform& trans0,
								  cbtGImpactBvh* boxset1, const cbtTransform& trans1,
								  cbtPairSet& collision_pairs)
{
