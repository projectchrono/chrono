...
#include "chrono/collision/ChCollisionShapeConnectedTriangle.h"

namespace chrono {

// Register into the object factory, to enable run-time dynamic creation and persistence
CH_FACTORY_REGISTER(ChCollisionShapeConnectedTriangle)
CH_UPCASTING(ChCollisionShapeConnectedTriangle, ChCollisionShape)

ChCollisionShapeConnectedTriangle::ChCollisionShapeConnectedTriangle() : ChCollisionShape(Type::CONNECTEDTRIANGLE) {}

ChCollisionShapeConnectedTriangle::ChCollisionShapeConnectedTriangle(
    ...
    : ChCollisionShape(Type::CONNECTEDTRIANGLE, material) {
    this->V1 = V1;
    this->V2 = V2;
    this->V3 = V3;
    this->eP1 = eP1;
...
ChAABB ChCollisionShapeConnectedTriangle::GetBoundingBox() const {
    ChAABB aabb;
    aabb += ChAABB(*V1, *V1);
    aabb += ChAABB(*V2, *V2);
    aabb += ChAABB(*V3, *V3);
...
void ChCollisionShapeConnectedTriangle::ArchiveOut(ChArchiveOut& archive_out) {
    // version number
    archive_out.VersionWrite<ChCollisionShapeConnectedTriangle>();
...
void ChCollisionShapeConnectedTriangle::ArchiveIn(ChArchiveIn& archive_in) {
    // version number
    /*int version =*/archive_in.VersionRead<ChCollisionShapeConnectedTriangle>();
