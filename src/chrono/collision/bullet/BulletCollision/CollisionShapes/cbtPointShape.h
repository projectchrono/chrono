...
#ifndef BT_POINT_SHAPE_H
#define BT_POINT_SHAPE_H
...
class cbtPointShape : public cbtSphereShape {
  public:
    cbtPointShape(cbtScalar radius) : cbtSphereShape(radius) { m_shapeType = POINT_SHAPE_PROXYTYPE; }

    virtual const char* getName() const { return "PointShape"; }
};
