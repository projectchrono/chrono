...
///The CONVEX_DISTANCE_MARGIN is a default collision margin for convex collision shapes derived from cbtConvexInternalShape.
...
#define CONVEX_DISTANCE_MARGIN cbtScalar(0.04)  // cbtScalar(0.1)//;//cbtScalar(0.01)
