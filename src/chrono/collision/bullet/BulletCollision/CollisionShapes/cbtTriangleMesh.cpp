...
void cbtTriangleMesh::addTriangleIndices(int index1, int index2, int index3)
{
...
void cbtTriangleMesh::addTriangle(const cbtVector3& vertex0, const cbtVector3& vertex1, const cbtVector3& vertex2, bool removeDuplicateVertices)
{
	m_indexedMeshes[0].m_numTriangles++;
...
int cbtTriangleMesh::getNumTriangles() const
{
	if (m_use32bitIndices)
	{
...
void cbtTriangleMesh::preallocateVertices(int numverts)
{
	if (m_use4componentVertices)
	{
...
void cbtTriangleMesh::preallocateIndices(int numindices)
{
	if (m_use32bitIndices)
	{
