...
///The cbtBoxShape is a box primitive around the origin, its sides axis aligned with length specified by half extents, in local shape coordinates. When used as part of a cbtCollisionObject or cbtRigidBody it will be an oriented box in world space.
ATTRIBUTE_ALIGNED16(class)
cbtBoxShape : public cbtPolyhedralConvexShape
{
...
public:
	...
	cbtBoxShape(const cbtVector3& boxHalfExtents);
