...
#include "cbtConvexPenetrationDepthSolver.h"

///MinkowskiPenetrationDepthSolver implements bruteforce penetration depth estimation.
///Implementation is based on sampling the depth using support mapping, and using GJK step to get the witness points.
class cbtMinkowskiPenetrationDepthSolver : public cbtConvexPenetrationDepthSolver
{
protected:
	static cbtVector3* getPenetrationDirections();

public:
	virtual bool calcPenDepth(cbtSimplexSolverInterface& simplexSolver,
