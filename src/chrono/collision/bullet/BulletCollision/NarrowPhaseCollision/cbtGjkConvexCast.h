...
class cbtGjkConvexCast : public cbtConvexCast
{
...
public:
	cbtGjkConvexCast(const cbtConvexShape* convexA, const cbtConvexShape* convexB, cbtSimplexSolverInterface* simplexSolver);
