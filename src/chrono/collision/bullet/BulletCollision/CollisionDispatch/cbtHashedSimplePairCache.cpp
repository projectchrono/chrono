...
#include "cbtHashedSimplePairCache.h"
...
cbtHashedSimplePairCache::cbtHashedSimplePairCache()
{
...
cbtSimplePair* cbtHashedSimplePairCache::findPair(int indexA, int indexB)
{
#ifdef BT_DEBUG_COLLISION_PAIRS
	gFindSimplePairs++;
#endif
...
void cbtHashedSimplePairCache::growTables()
{
	...
	if (m_hashTable.size() < newCapacity)
	{
		...
		{
			const cbtSimplePair& pair = m_overlappingPairArray[i];
