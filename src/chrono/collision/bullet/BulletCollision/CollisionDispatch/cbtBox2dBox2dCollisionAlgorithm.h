...
class cbtBox2dBox2dCollisionAlgorithm : public cbtActivatingCollisionAlgorithm
{
	bool m_ownManifold;
	cbtPersistentManifold* m_manifoldPtr;

public:
	cbtBox2dBox2dCollisionAlgorithm(const cbtCollisionAlgorithmConstructionInfo& ci)
	...
	cbtBox2dBox2dCollisionAlgorithm(cbtPersistentManifold* mf, const cbtCollisionAlgorithmConstructionInfo& ci, const cbtCollisionObjectWrapper* body0Wrap, const cbtCollisionObjectWrapper* body1Wrap);

	virtual ~cbtBox2dBox2dCollisionAlgorithm();
	...
	struct CreateFunc : public cbtCollisionAlgorithmCreateFunc
	{
		...
		{
			int bbsize = sizeof(cbtBox2dBox2dCollisionAlgorithm);
			void* ptr = ci.m_dispatcher1->allocateCollisionAlgorithm(bbsize);
			return new (ptr) cbtBox2dBox2dCollisionAlgorithm(0, ci, body0Wrap, body1Wrap);
		}
	};
};
