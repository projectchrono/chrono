...
#include "cbtUnionFind.h"

cbtUnionFind::~cbtUnionFind()
{
	Free();
}
...
class cbtUnionFindElementSortPredicate
{
public:
	bool operator()(const cbtElement& lhs, const cbtElement& rhs) const
	{
		return lhs.m_id < rhs.m_id;
	}
};

///this is a special operation, destroying the content of cbtUnionFind.
