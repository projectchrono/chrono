...
///The cbtPoolAllocator class allows to efficiently allocate a large pool of objects, instead of dynamically allocating them separately.
class cbtPoolAllocator
{
	...
	cbtSpinMutex m_mutex;  // only used if BT_THREADSAFE
...
public:
	...
	void freeMemory(void* ptr)
	{
		if (ptr)
		{
			cbtAssert((unsigned char*)ptr >= m_pool && (unsigned char*)ptr < m_pool + m_maxElements * m_elemSize);
