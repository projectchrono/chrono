...
class cbtCriticalSection
{
public:
	cbtCriticalSection() {}
	virtual ~cbtCriticalSection() {}

	virtual void lock() = 0;
	virtual void unlock() = 0;
};

class cbtThreadSupportInterface
{
public:
	virtual ~cbtThreadSupportInterface() {}
	...
	virtual cbtCriticalSection* createCriticalSection() = 0;
	virtual void deleteCriticalSection(cbtCriticalSection* criticalSection) = 0;
	...
	static cbtThreadSupportInterface* create(const ConstructionInfo& info);
};
