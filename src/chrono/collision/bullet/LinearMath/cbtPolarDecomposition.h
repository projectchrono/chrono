...
public:
     ...
     *                        convergence
     */
	cbtPolarDecomposition(cbtScalar tolerance = cbtScalar(0.0001),
     ...
     */
	unsigned int decompose(const cbtMatrix3x3& a, cbtMatrix3x3& u, cbtMatrix3x3& h) const;
 ...
 * cbtPolarDecomposition::DEFAULT_MAX_ITERATIONS, the algorithm has failed to
 * converge.
 *
 * @param a - the original matrix
 * @param u - the resulting orthogonal matrix
