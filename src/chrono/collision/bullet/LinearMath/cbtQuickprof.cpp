...
///The cbtClock is a portable basic clock that measures accurate time in seconds, use for profiling.
cbtClock::cbtClock()
{
	m_data = new cbtClockData;
#ifdef BT_USE_WINDOWS_TIMERS
...
cbtClock::cbtClock(const cbtClock& other)
{
	m_data = new cbtClockData;
	*m_data = *other.m_data;
}

cbtClock& cbtClock::operator=(const cbtClock& other)
{
	*m_data = *other.m_data;
	return *this;
}
...
/// the cbtClock was created.
unsigned long long int cbtClock::getTimeMilliseconds()
{
#ifdef BT_USE_WINDOWS_TIMERS
...
unsigned long long int cbtClock::getTimeMicroseconds()
{
#ifdef BT_USE_WINDOWS_TIMERS
...
/// the Clock was created.
cbtScalar cbtClock::getTimeSeconds()
{
	static const cbtScalar microseconds_to_seconds = cbtScalar(0.000001);
	return cbtScalar(getTimeMicroseconds()) * microseconds_to_seconds;
}

#ifndef BT_NO_PROFILE

static cbtClock gProfileClock;
...
{
	int threadIndex = cbtQuickprofGetCurrentThreadIndex2();
...
void cbtEnterProfileZoneDefault(const char* name)
{
}
void cbtLeaveProfileZoneDefault()
{
}
...
unsigned int cbtQuickprofGetCurrentThreadIndex2()
{
	const unsigned int kNullIndex = ~0U;

#if BT_THREADSAFE
	return cbtGetCurrentThreadIndex();
#else
...
static cbtEnterProfileZoneFunc* bts_enterFunc = cbtEnterProfileZoneDefault;
static cbtLeaveProfileZoneFunc* bts_leaveFunc = cbtLeaveProfileZoneDefault;

void cbtEnterProfileZone(const char* name)
{
	(bts_enterFunc)(name);
}
void cbtLeaveProfileZone()
{
	(bts_leaveFunc)();
}

cbtEnterProfileZoneFunc* cbtGetCurrentEnterProfileZoneFunc()
{
	return bts_enterFunc;
}
cbtLeaveProfileZoneFunc* cbtGetCurrentLeaveProfileZoneFunc()
{
	return bts_leaveFunc;
}

void cbtSetCustomEnterProfileZoneFunc(cbtEnterProfileZoneFunc* enterFunc)
{
	bts_enterFunc = enterFunc;
}
void cbtSetCustomLeaveProfileZoneFunc(cbtLeaveProfileZoneFunc* leaveFunc)
{
