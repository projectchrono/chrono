...
class ChMatrix {
  ...
  public:
    ...
    ChVector<Real> Matr34_x_Quat(const ChQuaternion<RealB>& qua) {
        ...
        return ChVector<Real>(Get34Element(0, 0) * (Real)qua.e0 + Get34Element(0, 1) * (Real)qua.e1 + Get34Element(0, 2) * (Real)qua.e2 + Get34Element(0, 3) * (Real)qua.e3,
                              Get34Element(1, 0) * (Real)qua.e0 + Get34Element(1, 1) * (Real)qua.e1 + Get34Element(1, 2) * (Real)qua.e2 + Get34Element(1, 3) * (Real)qua.e3,
                              Get34Element(2, 0) * (Real)qua.e0 + Get34Element(2, 1) * (Real)qua.e1 + Get34Element(2, 2) * (Real)qua.e2 + Get34Element(2, 3) * (Real)qua.e3);
    }
    ...
    ChQuaternion<Real> Matr34T_x_Vect(const ChVector<RealB>& va) {
        assert((rows == 3) && (columns == 4));
        return ChQuaternion<Real>(Get34Element(0, 0) * (Real)va.x() + Get34Element(1, 0) * (Real)va.y() + Get34Element(2, 0) * (Real)va.z(),
    ...
    ChQuaternion<Real> Matr44_x_Quat(const ChQuaternion<RealB>& qua) {
        ...
        return ChQuaternion<Real>(Get44Element(0, 0) * (Real)qua.e0 + Get44Element(0, 1) * (Real)qua.e1 + Get44Element(0, 2) * (Real)qua.e2 + Get44Element(0, 3) * (Real)qua.e3,
                                  Get44Element(1, 0) * (Real)qua.e0 + Get44Element(1, 1) * (Real)qua.e1 + Get44Element(1, 2) * (Real)qua.e2 + Get44Element(1, 3) * (Real)qua.e3,
                                  Get44Element(2, 0) * (Real)qua.e0 + Get44Element(2, 1) * (Real)qua.e1 + Get44Element(2, 2) * (Real)qua.e2 + Get44Element(2, 3) * (Real)qua.e3,
                                  Get44Element(3, 0) * (Real)qua.e0 + Get44Element(3, 1) * (Real)qua.e1 + Get44Element(3, 2) * (Real)qua.e2 + Get44Element(3, 3) * (Real)qua.e3);
    }
