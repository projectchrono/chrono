...
void ChElementShellANCF_3833::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833::SetDimensions(double lenX, double lenY) {
    m_lenX = lenX;
    m_lenY = lenY;
...
void ChElementShellANCF_3833::SetMidsurfaceOffset(const double offset) {
...
void ChElementShellANCF_3833::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementShellANCF_3833::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementShellANCF_3833::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementShellANCF_3833::PrecomputeInternalForceMatricesWeights() {
    if (m_method == IntFrcMethod::ContInt)
...
void ChElementShellANCF_3833::PrecomputeInternalForceMatricesWeightsContInt() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3833::ComputeInternalForcesContIntNoDamping(ChVectorDynamic<>& Fi) {
    // Calculate the generalize internal force vector using the "Continuous Integration" style of method assuming a
...
void ChElementShellANCF_3833::ComputeInternalJacobianContIntNoDamping(ChMatrixRef& H, double Kfactor) {
    // Calculate the Jacobian of the generalize internal force vector using the "Continuous Integration" style of method
...
void ChElementShellANCF_3833::Calc_Sxi_compact(VectorN& Sxi_compact,
                                               double xi,
                                               double eta,
                                               double zeta,
                                               double thickness,
...
void ChElementShellANCF_3833::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact,
                                                   double xi,
                                                   double eta,
                                                   double zeta,
                                                   double thickness,
...
void ChElementShellANCF_3833::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                    double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
...
void ChElementShellANCF_3833::Calc_J_0xi(ChMatrix33<double>& J_0xi,
                                         double xi,
                                         double eta,
                                         double zeta,
                                         double thickness,
...
double ChElementShellANCF_3833::Calc_det_J_0xi(double xi, double eta, double zeta, double thickness, double zoffset) {
...
ChQuadratureTables* ChElementShellANCF_3833::GetStaticGQTables() {
...
// ============================================================================
// Implementation of ChElementShellANCF_3833::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)

ChElementShellANCF_3833::Layer::Layer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF> material)
