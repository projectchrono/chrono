...
class ChApi ChElementShellReissner4 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    virtual int GetNumCoordsPosLevel() override { return 4 * 6; }
  ...
  public:
    ...
    virtual int GetLoadableNumCoordsPosLevel() override { return 4 * 7; }

    /// Gets the number of DOFs affected by this element (velocity part).
    virtual int GetLoadableNumCoordsVelLevel() override { return 4 * 6; }
