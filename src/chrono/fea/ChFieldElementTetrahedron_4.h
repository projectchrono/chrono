...
#ifndef CHFIELDELEMENTTETRAHEDRON_4_H
#define CHFIELDELEMENTTETRAHEDRON_4_H
...
class ChApi ChFieldElementTetrahedron_4 : public ChFieldElement {
public:
    ChFieldElementTetrahedron_4() {}
    virtual ~ChFieldElementTetrahedron_4() {}
    ...
    virtual void SetNodes(std::shared_ptr<ChNodeFEAmultiXYZ> nodeA,
        std::shared_ptr<ChNodeFEAmultiXYZ> nodeB,
        std::shared_ptr<ChNodeFEAmultiXYZ> nodeC,
        std::shared_ptr<ChNodeFEAmultiXYZ> nodeD);
...
private:
    ...
    std::array<std::shared_ptr<ChNodeFEAmultiXYZ>, 4> nodes;
};
...
//CH_CLASS_VERSION(fea::ChFieldElementTetrahedron_4, 0)
