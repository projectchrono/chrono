...
#ifndef CH_ELEMENT_TETRA_COROT_10_H
#define CH_ELEMENT_TETRA_COROT_10_H
...
class ChApi ChElementTetraCorot_10 : public ChElementTetrahedron,
  ...
  public:
    ...
    virtual unsigned int GetSubBlocks() override { return 10; }
