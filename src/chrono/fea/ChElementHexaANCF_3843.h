...
class ChApi ChElementHexaANCF_3843 : public ChElementANCF,
  ...
  public:
    ...
    virtual int GetNumCoordsPosLevel() override { return 8 * 12; }
  ...
  public:
    ...
    virtual int GetLoadableNumCoordsPosLevel() override { return 8 * 12; }

    /// Gets the number of DOFs affected by this element (velocity part).
    virtual int GetLoadableNumCoordsVelLevel() override { return 8 * 12; }
