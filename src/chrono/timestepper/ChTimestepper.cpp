...
class my_enum_mappers : public ChTimestepper {
  public:
    ...
    CH_ENUM_VAL(EULER_IMPLICIT);
    CH_ENUM_VAL(EULER_IMPLICIT_LINEARIZED);
    CH_ENUM_VAL(EULER_IMPLICIT_PROJECTED);
    CH_ENUM_VAL(TRAPEZOIDAL);
    CH_ENUM_VAL(TRAPEZOIDAL_LINEARIZED);
    CH_ENUM_VAL(HHT);
    CH_ENUM_VAL(HEUN);
    CH_ENUM_VAL(RUNGEKUTTA45);
    CH_ENUM_VAL(EULER_EXPLICIT);
    CH_ENUM_VAL(LEAPFROG);
    CH_ENUM_VAL(NEWMARK);
    CH_ENUM_VAL(CUSTOM);
