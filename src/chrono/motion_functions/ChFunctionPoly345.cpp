...
ChFunctionPoly345::ChFunctionPoly345(double m_h, double m_end) : h(m_h) {
    Set_end(m_end);
}
...
double ChFunctionPoly345::Get_y(double x) const {
    double ret = 0;
    if (x <= 0)
        return 0;
    if (x >= end)
...
double ChFunctionPoly345::Get_y_dx(double x) const {
    double ret = 0;
    if (x <= 0)
        return 0;
    if (x >= end)
...
double ChFunctionPoly345::Get_y_dxdx(double x) const {
    double ret = 0;
    if (x <= 0)
        return 0;
    if (x >= end)
...
double ChFunctionPoly345::Get_y_dxdxdx(double x) const {
    double ret = 0;
    if (x <= 0)
        return 0;
    if (x >= end)
