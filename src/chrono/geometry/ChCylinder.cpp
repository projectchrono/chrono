...
ChGeometry::AABB ChCylinder::GetBoundingBox(double radius, double height) {
    return AABB(ChVector<>(-radius, -radius, -height / 2),  //
                ChVector<>(+radius, +radius, +height / 2));
}

ChGeometry::AABB ChCylinder::GetBoundingBox() const {
