...
class ChApi ChTriangle : public ChGeometry {
  ...
  public:
    ...
    double PointTrianglePlaneDistance(ChVector3d B,           ///< point to be measured
    ...
    /// Static utility function to calculate the (unsigned) area of a triangle.
    static double CalcArea(const ChVector3d& p1, const ChVector3d& p2, const ChVector3d& p3);
