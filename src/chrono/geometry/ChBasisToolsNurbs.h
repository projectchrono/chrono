  ...
  public:
    ...
    static void BasisEvaluateDeriv(
        ...
        for (i = 0; i <= p; i++) {
            ...
            R(i) = N(0, i) * wi / W;
            dRdu(i) = (N(1, i) * W - N(0, i) * dWdu) * fac;
            ddRddu(i) = wi * (N(2, i) / W - 2 * N(1, i) * dWdu / W / W - N(0, i) * ddWddu / W / W +
                              2 * N(0, i) * dWdu * dWdu / W / W / W);
        }
    }
};
    ...
    static void BasisEvaluateDeriv(
        ...
        for (int iv = 0; iv <= p_v; iv++) {
            for (int iu = 0; iu <= p_u; iu++) {
                ...
                d2Rdudu(iu, iv) = wi * (N_u(2, iu) * N_v(0, iv) / W - 2 * N_u(1, iu) * N_v(0, iv) * dWdu / W / W -
                                        N_u(0, iu) * N_v(0, iv) * d2Wdudu / W / W +
                                        2 * N_u(0, iu) * N_v(0, iv) * dWdu * dWdu / W / W / W);
                d2Rdvdv(iu, iv) = wi * (N_u(0, iu) * N_v(2, iv) / W - 2 * N_u(0, iu) * N_v(1, iv) * dWdv / W / W -
                                        N_u(0, iu) * N_v(0, iv) * d2Wdvdv / W / W +
                                        2 * N_u(0, iu) * N_v(0, iv) * dWdv * dWdv / W / W / W);
                d2Rdudv(iu, iv) =
                    wi * (N_u(1, iu) * N_v(1, iv) / W - N_u(1, iu) * N_v(0, iv) * dWdu / W / W -
                          N_u(0, iu) * N_v(1, iv) * dWdv / W / W - N_u(0, iu) * N_v(0, iv) * d2Wdudv / W / W +
                          2 * N_u(0, iu) * N_v(0, iv) * dWdu * dWdv / W / W / W);
            }
        }
    }
};
