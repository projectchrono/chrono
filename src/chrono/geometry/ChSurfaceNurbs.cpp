...
ChSurfaceNurbs::ChSurfaceNurbs(int morder_u,                 ///< order pu: 1= linear, 2=quadratic, etc.
...
void ChSurfaceNurbs::Evaluate(
                ChVector<>& pos, 
                const double parU,
                const double parV) const {
...
void ChSurfaceNurbs::SetupData( int morder_u,                 ///< order pu: 1= linear, 2=quadratic, etc.
                            int morder_v,                 ///< order pv: 1= linear, 2=quadratic, etc.
                            ChMatrixDynamic< ChVector<> >& mpoints, ///< control points, size nuxnv. Required: at least nu >= pu+1, same for v
