...
void ChActuator::Connect(std::shared_ptr<ChBody> body1, std::shared_ptr<ChBody> body2, bool local, ChVector3d loc1, ChVector3d loc2) {
    is_attached = true;
...
void ChActuator::Update(double time, UpdateFlags update_flags) {
