...
ChSystemSMC::ChSystemSMC(bool use_material_properties, unsigned int max_objects, double scene_size)
    ...
    solver_speed = chrono::make_shared<ChSolverSMC>();
    solver_stab = chrono::make_shared<ChSolverSMC>();

    collision_system = chrono::make_shared<collision::ChCollisionSystemBullet>(max_objects, scene_size);
    ...
    contact_container = chrono::make_shared<ChContactContainerSMC>();
