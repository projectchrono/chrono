...
ChHydraulicActuatorBase::ChHydraulicActuatorBase() : pP(7.6e6), pT(0.1e6) {}
...
ChHydraulicActuator3::ChHydraulicActuator3() : hose1V(3.14e-5), hose2V(7.85e-5), hose3V(4.71e-5), Bo(1500e6), Bh(150e6), Bc(31500e6) {}
...
void ChHydraulicActuator3::SetHoseVolumes(double hose_tvalve_piston, double hose_dvalve_rod, double hose_dvalve_tvalve) {
