...
class ChApi ChAssemblyNew : public ChPhysicsItem {
    CH_RTTI(ChAssemblyNew, ChObj);

public:
    ChAssemblyNew();

    /// Destructor
    virtual ~ChAssemblyNew();

    /// Copy from another ChAssemblyNew.
    void Copy(ChAssemblyNew* source);
    ...
    class ChApi IteratorPhysicsItems {
      public:
        IteratorPhysicsItems(ChAssemblyNew* msys);
...
class ChApi ChSystem : public ChAssemblyNew, 
                       public ChIntegrableIIorderEasy {
    CH_RTTI(ChSystem, ChAssemblyNew);
