...
void ChShaftsTorqueConverter::ArchiveOUT(ChArchiveOut& marchive) const
{
    // version number
...
void ChShaftsTorqueConverter::ArchiveIN(ChArchiveIn& marchive) 
{
    ...
    //marchive >> CHNVP_IN(shaft_stator); //***TODO*** serialize with shared ptr
} 
