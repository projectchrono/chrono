...
ChLinkLimit::ChLinkLimit()
    ...
    m_Kmax_modul = chrono::make_shared<ChFunction_Const>(1);
    m_Kmin_modul = chrono::make_shared<ChFunction_Const>(1);
    m_Rmax_modul = chrono::make_shared<ChFunction_Const>(1);
    m_Rmin_modul = chrono::make_shared<ChFunction_Const>(1);
    m_polarMax_funct = chrono::make_shared<ChFunction_Const>(1);
