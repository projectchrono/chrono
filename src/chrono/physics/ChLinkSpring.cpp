...
ChLinkSpring::ChLinkSpring() {
    ...
    mod_f_time = chrono::make_shared<ChFunction_Const>(1);
    mod_k_d = chrono::make_shared<ChFunction_Const>(1);
    mod_k_speed = chrono::make_shared<ChFunction_Const>(1);
    mod_r_d = chrono::make_shared<ChFunction_Const>(1);
    mod_r_speed = chrono::make_shared<ChFunction_Const>(1);
