...
class ChApi ChLcpConstraintTwoBodies : public ChLcpConstraintTwo {
  ...
  public:
    ...
    /// Copy constructor
    ChLcpConstraintTwoBodies(const ChLcpConstraintTwoBodies& other) : ChLcpConstraintTwo(other) {
        Cq_a = other.Cq_a;
        Cq_b = other.Cq_b;
        Eq_a = other.Eq_a;
        Eq_b = other.Eq_b;
    ...
    virtual ChLcpConstraint* new_Duplicate() override {
        return new ChLcpConstraintTwoBodies(*this);
    }
    ...
    void SetVariables(ChLcpVariables* mvariables_a, ChLcpVariables* mvariables_b) override;
