...
class ChApi ChLcpConstraintThreeBBShaft : public ChLcpConstraintThree {
  ...
  public:
    ...
    virtual ChLcpConstraint* new_Duplicate() override { return new ChLcpConstraintThreeBBShaft(*this); };
    ...
    void SetVariables(ChLcpVariables* mvariables_a, ChLcpVariables* mvariables_b, ChLcpVariables* mvariables_c) override;
