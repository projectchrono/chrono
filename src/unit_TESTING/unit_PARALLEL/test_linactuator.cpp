                     ...
                     bool animate)                // if true, animate with OpenGL
{
  ...
  switch (sys_type) {
    case utils::PARALLEL_DEM:
      ground_ptr = new ChBody(new ChCollisionModelParallel, ChMaterialSurfaceBase::DEM);
      break;
    case utils::PARALLEL_DVI:
      ground_ptr = new ChBody(new ChCollisionModelParallel, ChMaterialSurfaceBase::DVI);
      break;
  }
  ...
  switch (sys_type) {
    case utils::PARALLEL_DEM:
      plate_ptr = new ChBody(new ChCollisionModelParallel, ChMaterialSurfaceBase::DEM);
      break;
    case utils::PARALLEL_DVI:
      plate_ptr = new ChBody(new ChCollisionModelParallel, ChMaterialSurfaceBase::DVI);
      break;
  }
