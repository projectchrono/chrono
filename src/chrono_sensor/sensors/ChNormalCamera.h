...
#ifndef CHNORMALCAMERA_H
#define CHNORMALCAMERA_H
...
/// Camera class
class CH_SENSOR_API ChNormalCamera : public ChNormalCameraBase {
  public:
    ...
    ChNormalCamera(std::shared_ptr<chrono::ChBody> parent,  // object to which the sensor is attached
