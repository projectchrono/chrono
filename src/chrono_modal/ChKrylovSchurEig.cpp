...
void ordschur(ChMatrixDynamic<std::complex<double>>& U,
...
void truncateKrylov(ChMatrixDynamic<std::complex<double>>& Q,
...
void expandKrylov(
    ...
    for (int k = sk; k < ek; ++k) {
        ...
        ChVectorDynamic<std::complex<double>> w2 =
            Q.leftCols(k + 1).adjoint() * v;  //  w2 = Q(:, 1 : k)' * v;            // double normalize
