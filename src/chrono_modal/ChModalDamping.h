...
///    R^ = Rcustom  
/// where Rcustom is a square matrix of size (m_num_coords_vel_boundary + n_modes_coords_w)
...
public:
    ...
    /// The Rcustom matrix must be of proper size, i.e. a square matrix of size (m_num_coords_vel_boundary + n_modes_coords_w)
