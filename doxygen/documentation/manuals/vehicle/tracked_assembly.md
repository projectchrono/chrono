...
A Chrono::Vehicle track assembly is a container of vehicle subsystems including a sprocket, an idler with tensioner, optionally a set of rollers, a number of suspension mechanisms, and an arbitrary number of track-shoe mechanisms.
