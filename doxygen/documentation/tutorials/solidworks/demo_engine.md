...
Please follow all steps of the tutorial, once you understand all these steps, you will be able to create a lot of complex mechanisms that can be exported from SolidWorks to Chrono. 
...
Since you enabled the *Save test.py* option, a ```test.py``` program that loads and simulate the engine was automatically generated for you. You can run it directly from SolidWorks for a quick test, do this: 
...
The simulation will be computed with no interactive view: wait a few seconds.
...
- It is suggested that you choose a proper compression codec, in VirtualDub. 
  ...
  We suggest an Mpeg4 / DivX codec. Maybe you need to install a codec pack 
...
where you will learn advanced topics about how to add additional constraints (ex. a motor constraint that imposes the rotation of the crank), how to change the rendering look of the shapes, etc. 
