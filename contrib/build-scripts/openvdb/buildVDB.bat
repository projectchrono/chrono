...
set OPENVDB_DEPENDENCIES_DIR="C:/Packages/openvdb-deps"
...
-DNANOVDB_BUILD_EXAMPLES=ON-DBlosc_INCLUDE_DIR="%OPENVDB_DEPENDENCIES_DIR%/blosc/include" ^
...
@echo off
SET "UTIL_DIR=C:/Packages/openvdb-deps/OpenVDB/include/nanovdb/util"
SET DEST_DIR="C:/Packages/openvdb-deps/OpenVDB/include/nanovdb/util/cuda"
