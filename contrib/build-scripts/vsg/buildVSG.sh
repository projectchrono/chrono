...
#      VulkanSceneGraph (github.com/vsg-dev/VulkanSceneGraph.git): Tag v1.0.8
#      vsgXchange (github.com/vsg-dev/vsgXchange.git):             Tag v1.0.4
#      vsgImGui (github.com/vsg-dev/vsgImGui.git):                 latest
#      vsgExamples (github.com/vsg-dev/vsgExamples.git):           Tag v1.0.6
