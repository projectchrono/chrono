...
@rem      VulkanSceneGraph (github.com/vsg-dev/VulkanSceneGraph.git): Tag v1.0.8
@rem      vsgXchange (github.com/vsg-dev/vsgXchange.git):             Tag v1.0.4
@rem      vsgImGui (github.com/vsg-dev/vsgImGui.git):                 latest
@rem      vsgExamples (github.com/vsg-dev/vsgExamples.git):           Tag v1.0.6
...
@if %DOWNLOAD% EQU ON (
    ...
    git clone -c advice.detachedHead=false --depth 1 --branch v1.0.8 "https://github.com/vsg-dev/VulkanSceneGraph" "download_vsg/vsg"
    rem git clone "https://github.com/vsg-dev/VulkanSceneGraph" "download_vsg/vsg"
    set VSG_SOURCE_DIR="download_vsg/vsg"

    echo "  ... vsgXchange"    
    git clone -c advice.detachedHead=false --depth 1 --branch v1.0.4 "https://github.com/vsg-dev/vsgXchange" "download_vsg/vsgXchange"
    ...
    echo "  ... vsgExamples"
    git clone -c advice.detachedHead=false --depth 1 --branch v1.0.6 "https://github.com/vsg-dev/vsgExamples" "download_vsg/vsgExamples"
