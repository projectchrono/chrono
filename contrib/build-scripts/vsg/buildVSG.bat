...
@rem      VulkanSceneGraph (github.com/vsg-dev/VulkanSceneGraph.git): Tag v1.0.9-rc1
@rem      vsgXchange (github.com/vsg-dev/vsgXchange.git):             Tag v1.0.5-rc1
@rem      vsgImGui (github.com/vsg-dev/vsgImGui.git):                 latest
@rem      vsgExamples (github.com/vsg-dev/vsgExamples.git):           Tag v1.0.7-rc1
