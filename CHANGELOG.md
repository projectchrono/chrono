...
- [Unreleased (development branch)](#unreleased-development-branch)
  - [\[Added\] Support for modeling components with own DAE dynamics](#added-support-for-modeling-components-with-own-dae-dynamics)
...
## [Added] Support for modeling components with own DAE dynamics
