...
body_1.SetPos(chrono.ChVector3d(-0.0654391949504476,-0.0436913616481478,-0.187114016856068))
...
body_1.AddVisualShape(body_1_1_shape, chrono.ChFramed(chrono.ChVector3d(0.0654391949504455,0.043691361648147,-0.187114016856069), chrono.ChQuaterniond(0.667465028254667,-0.66746502825467,-0.233431865984475,-0.233431865984475)))

# Visualization shape 
body_1_2_shape = chrono.ChVisualShapeModelFile() 
body_1_2_shape.SetFilename(shapes_dir +'body_1_2.obj') 
body_1.AddVisualShape(body_1_2_shape, chrono.ChFramed(chrono.ChVector3d(0.0654391949504455,0.053691361648147,-0.187114016856069), chrono.ChQuaterniond(0.667465028254667,-0.66746502825467,-0.233431865984476,-0.233431865984475)))
...
body_1.AddCollisionShape(body1_ct4, chrono.ChFramed(chrono.ChVector3d(-0.0513228993817286,0.0508827840639894,-0.0385937622306218),mr))
pt_vect = chrono.vector_ChVector3d()
pt_vect.push_back(chrono.ChVector3d(0.0414088890638266,0.0416913616481475,-0.0742287544039014))
pt_vect.push_back(chrono.ChVector3d(0.0302575307494064,0.0416913616481475,-0.0786612714928038))
pt_vect.push_back(chrono.ChVector3d(0.0404169313636054,0.0416913616481474,-0.104220364494909))
pt_vect.push_back(chrono.ChVector3d(0.0512527702098685,0.0416913616481474,-0.0989940612628225))
pt_vect.push_back(chrono.ChVector3d(0.0414088890638266,0.0556913616481475,-0.0742287544039015))
pt_vect.push_back(chrono.ChVector3d(0.0302575307494064,0.0556913616481475,-0.0786612714928038))
pt_vect.push_back(chrono.ChVector3d(0.0404169313636054,0.0556913616481474,-0.104220364494909))
pt_vect.push_back(chrono.ChVector3d(0.0512527702098685,0.0556913616481474,-0.0989940612628226))
body1_ct5 = chrono.ChCollisionShapeConvexHull(mat_1, pt_vect)
body_1.AddCollisionShape(body1_ct5)
pt_vect = chrono.vector_ChVector3d()
pt_vect.push_back(chrono.ChVector3d(-0.0253719200835922,0.0416913616481472,-0.150789419140605))
pt_vect.push_back(chrono.ChVector3d(-0.052662581388589,0.0416913616481473,-0.145818628764203))
pt_vect.push_back(chrono.ChVector3d(-0.0548129133033428,0.0416913616481472,-0.157624393146758))
pt_vect.push_back(chrono.ChVector3d(-0.0256253082894385,0.0416913616481472,-0.162940697669095))
pt_vect.push_back(chrono.ChVector3d(-0.0253719200835922,0.0556913616481472,-0.150789419140605))
pt_vect.push_back(chrono.ChVector3d(-0.052662581388589,0.0556913616481473,-0.145818628764203))
pt_vect.push_back(chrono.ChVector3d(-0.0548129133033428,0.0556913616481472,-0.157624393146758))
...
body_3.SetPos(chrono.ChVector3d(-0.00490107217461526,3.57656060958299e-05,-5.48348916194744e-05))
...
cA = chrono.ChVector3d(0.00188591368619475,-0.03,0.000697938817270251)
cB = chrono.ChVector3d(0.03,-0.03,-0.0810582164392656)
dA = chrono.ChVector3d(0,-1,0)
dB = chrono.ChVector3d(0,-1,0)
...
cA = chrono.ChVector3d(-2.71818751627004e-05,-0.0256181804404151,-0.217838596598275)
cB = chrono.ChVector3d(0.03,-0.0256181804404151,-0.250816354295145)
dA = chrono.ChVector3d(0,-1,0)
dB = chrono.ChVector3d(0,-1,0)
...
cA = chrono.ChVector3d(-5.47043328128038e-18,-0.0127328264314352,-0.105)
cB = chrono.ChVector3d(0.03,-0.0127328264314352,-0.0874722553494342)
dA = chrono.ChVector3d(2.8134962801131e-17,-1,2.10255524402378e-15)
dB = chrono.ChVector3d(0,1,0)
